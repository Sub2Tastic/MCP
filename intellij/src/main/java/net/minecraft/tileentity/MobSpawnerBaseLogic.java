...
public abstract class MobSpawnerBaseLogic
{
    ...
    private boolean isActivated()
    {
        ...
        return this.getWorld().func_175636_b((double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 0.5D, (double)blockpos.getZ() + 0.5D, (double)this.activatingRangeFromPlayer);
    }
        ...
        else
        {
            ...
            else
            {
                ...
                for (int i = 0; i < this.spawnCount; ++i)
                {
                    ...
                    int k = world.func_72872_a(entity.getClass(), (new AxisAlignedBB((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), (double)(blockpos.getX() + 1), (double)(blockpos.getY() + 1), (double)(blockpos.getZ() + 1))).grow((double)this.spawnRange)).size();
    ...
    public NBTTagCompound write(NBTTagCompound compound)
    {
        ...
        else
        {
            ...
            compound.func_74782_a("SpawnData", this.spawnData.getNbt().copy());
            ...
            compound.func_74782_a("SpawnPotentials", nbttaglist);
            return compound;
        }
    }
    ...
    public Entity getCachedEntity()
    {
        ...
        {
            this.cachedEntity = AnvilChunkLoader.func_186051_a(this.spawnData.getNbt(), this.getWorld(), false);
