...
public class TileEntityPiston extends TileEntity implements ITickable
{
    ...
    {
        this.field_174932_a = pistonStateIn;
    ...
    public AxisAlignedBB func_184319_a(IBlockAccess p_184319_1_, BlockPos p_184319_2_, float p_184319_3_)
    {
        ...
        return iblockstate.func_185900_c(p_184319_1_, p_184319_2_).offset((double)(p_184319_3_ * (float)this.pistonFacing.getXOffset()), (double)(p_184319_3_ * (float)this.pistonFacing.getYOffset()), (double)(p_184319_3_ * (float)this.pistonFacing.getZOffset()));
    }

    private IBlockState getCollisionRelatedBlockState()
    {
        return !this.isExtending() && this.shouldPistonHeadBeRendered() ? Blocks.PISTON_HEAD.getDefaultState().func_177226_a(BlockPistonExtension.TYPE, this.field_174932_a.getBlock() == Blocks.STICKY_PISTON ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT).func_177226_a(BlockPistonExtension.FACING, this.field_174932_a.get(BlockPistonBase.FACING)) : this.field_174932_a;
    }
    ...
    private void moveCollidedEntities(float p_184322_1_)
    {
        ...
        this.getCollisionRelatedBlockState().func_185908_a(this.world, BlockPos.ZERO, new AxisAlignedBB(BlockPos.ZERO), list, (Entity)null, true);
        ...
        if (!list.isEmpty())
        {
            ...
            if (!list1.isEmpty())
            {
                boolean flag = this.field_174932_a.getBlock() == Blocks.SLIME_BLOCK;
                ...
                for (int i = 0; i < list1.size(); ++i)
                {
                    ...
                    if (entity.getPushReaction() != EnumPushReaction.IGNORE)
                    {
                        if (flag)
                        {
                            ...
                            {
                                case X:
                                    entity.field_70159_w = (double)enumfacing.getXOffset();
                                    break;

                                case Y:
                                    entity.field_70181_x = (double)enumfacing.getYOffset();
                                    break;

                                case Z:
                                    entity.field_70179_y = (double)enumfacing.getZOffset();
                            }
                        }
                        ...
                        {
                            AxisAlignedBB axisalignedbb1 = this.func_190610_a(this.moveByPositionAndProgress(list.get(j)), enumfacing, d0);
                        ...
                        if (d1 > 0.0D)
                        {
                            ...
                            entity.func_70091_d(MoverType.PISTON, d1 * (double)enumfacing.getXOffset(), d1 * (double)enumfacing.getYOffset(), d1 * (double)enumfacing.getZOffset());
    ...
    private double getMovement(AxisAlignedBB p_190612_1_, EnumFacing facing, AxisAlignedBB p_190612_3_)
    {
        ...
        {
            case X:
                return func_190611_b(p_190612_1_, facing, p_190612_3_);

            case Y:
            default:
                return func_190608_c(p_190612_1_, facing, p_190612_3_);

            case Z:
                return func_190604_d(p_190612_1_, facing, p_190612_3_);
        }
    }
    ...
    private void fixEntityWithinPistonBase(Entity p_190605_1_, EnumFacing p_190605_2_, double p_190605_3_)
    {
        ...
        AxisAlignedBB axisalignedbb1 = Block.field_185505_j.offset(this.pos);
        ...
        if (axisalignedbb.intersects(axisalignedbb1))
        {
            ...
            if (Math.abs(d0 - d1) < 0.01D)
            {
                ...
                p_190605_1_.func_70091_d(MoverType.PISTON, d0 * (double)enumfacing.getXOffset(), d0 * (double)enumfacing.getYOffset(), d0 * (double)enumfacing.getZOffset());
                MOVING_ENTITY.set(null);
            }
        }
    }
    ...
    public void clearPistonTileEntity()
    {
        if (this.lastProgress < 1.0F && this.world != null)
        {
            ...
            if (this.world.getBlockState(this.pos).getBlock() == Blocks.field_180384_M)
            {
                this.world.setBlockState(this.pos, this.field_174932_a, 3);
                this.world.neighborChanged(this.pos, this.field_174932_a.getBlock(), this.pos);
            }
        }
    }
    ...
    {
        super.read(compound);
        this.field_174932_a = Block.func_149729_e(compound.getInt("blockId")).func_176203_a(compound.getInt("blockData"));
    ...
    public NBTTagCompound write(NBTTagCompound compound)
    {
        ...
        compound.putInt("blockId", Block.func_149682_b(this.field_174932_a.getBlock()));
        compound.putInt("blockData", this.field_174932_a.getBlock().func_176201_c(this.field_174932_a));
    ...
    public void func_190609_a(World p_190609_1_, BlockPos p_190609_2_, AxisAlignedBB p_190609_3_, List<AxisAlignedBB> p_190609_4_, @Nullable Entity p_190609_5_)
    {
        if (!this.extending && this.shouldHeadBeRendered)
        {
            this.field_174932_a.func_177226_a(BlockPistonBase.EXTENDED, Boolean.valueOf(true)).func_185908_a(p_190609_1_, p_190609_2_, p_190609_3_, p_190609_4_, p_190609_5_, false);
        }
        ...
        if ((double)this.progress >= 1.0D || enumfacing != (this.extending ? this.pistonFacing : this.pistonFacing.getOpposite()))
        {
            ...
            {
                iblockstate = Blocks.PISTON_HEAD.getDefaultState().func_177226_a(BlockPistonExtension.FACING, this.pistonFacing).func_177226_a(BlockPistonExtension.SHORT, Boolean.valueOf(this.extending != 1.0F - this.progress < 0.25F));
            }
            else
            {
            ...
            iblockstate.func_185908_a(p_190609_1_, p_190609_2_, p_190609_3_.offset(-d0, -d1, -d2), p_190609_4_, p_190609_5_, true);
