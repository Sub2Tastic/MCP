...
public abstract class CommandBlockBaseLogic implements ICommandSender
{
    ...
    public NBTTagCompound write(NBTTagCompound compound)
    {
        ...
        this.field_175575_g.func_179670_b(compound);
        return compound;
    }
    ...
    public void read(NBTTagCompound nbt)
    {
        ...
        this.field_175575_g.func_179668_a(nbt);
    }
        ...
        if (!worldIn.isRemote && worldIn.getGameTime() != this.lastExecution)
        {
            ...
            else
            {
                ...
                if (minecraftserver != null && minecraftserver.isAnvilFileSet() && minecraftserver.isCommandBlockEnabled())
                {
                    ...
                    {
                        this.lastOutput = null;
                        this.successCount = minecraftserver.func_71187_D().func_71556_a(this, this.commandStored);
                    }
                    catch (Throwable throwable)
                    {
    ...
    {
        MinecraftServer minecraftserver = this.getServer();
        return minecraftserver == null || !minecraftserver.isAnvilFileSet() || minecraftserver.worlds[0].getGameRules().func_82766_b("commandBlockOutput");
    }

    public void func_174794_a(CommandResultStats.Type p_174794_1_, int p_174794_2_)
    {
        this.field_175575_g.func_184932_a(this.getServer(), this, p_174794_1_, p_174794_2_);
    }
