...
public class ModelBakery
{
    ...
    private static final ModelBlock MODEL_GENERATED = ModelBlock.deserialize(field_188643_q);
    private static final ModelBlock MODEL_ENTITY = ModelBlock.deserialize(field_188643_q);
            ...
            for (final ResourceLocation resourcelocation : blockstatemapper.func_188182_a(block))
            {
                try
                {
                    ...
                    if (modelblockdefinition.hasMultipartData())
                    {
                        ...
                        modelblockdefinition.getMultipartData().func_188138_a(block.getStateContainer());
                    ...
                    for (Entry<IBlockState, ModelResourceLocation> entry : map.entrySet())
                    {
                        ...
                        if (resourcelocation.equals(modelresourcelocation))
                        {
                            try
                            {
                                this.field_177612_i.put(modelresourcelocation, modelblockdefinition.func_188004_c(modelresourcelocation.getVariant()));
                            }
    ...
    {
        this.field_177612_i.put(MODEL_MISSING, new VariantList(Lists.newArrayList(new Variant(new ResourceLocation(MODEL_MISSING.getPath()), ModelRotation.X0_Y0, false, 1))));
        this.func_191401_d();
        this.func_177595_c();
        this.func_188637_e();
        this.func_177590_d();
    ...
    private void func_177569_a(ModelBlockDefinition p_177569_1_, ModelResourceLocation p_177569_2_)
    {
        try
        {
            this.field_177612_i.put(p_177569_2_, p_177569_1_.func_188004_c(p_177569_2_.getVariant()));
        }
        catch (RuntimeException var4)
        {
            if (!p_177569_1_.hasMultipartData())
            {
                LOGGER.warn("Unable to load variant: {} from {}", p_177569_2_.getVariant(), p_177569_2_);
            }
        }
    }
    ...
    private ModelBlockDefinition func_188632_a(ResourceLocation p_188632_1_, ResourceLocation p_188632_2_)
    {
        ...
        try
        {
            for (IResource iresource : this.resourceManager.func_135056_b(p_188632_2_))
            {
    ...
    {
        return new ResourceLocation(p_188631_1_.getNamespace(), "blockstates/" + p_188631_1_.getPath() + ".json");
    }
    ...
    private void func_188638_a(ModelResourceLocation p_188638_1_, VariantList p_188638_2_)
    {
        for (Variant variant : p_188638_2_.getVariantList())
        {
            ...
            if (this.field_177611_h.get(resourcelocation) == null)
            {
                try
                {
                    this.field_177611_h.put(resourcelocation, this.loadModel(resourcelocation));
                }
                catch (Exception exception)
                {
    ...
    private ModelBlock loadModel(ResourceLocation location) throws IOException
    {
        ...
        try
        {
            ...
            if (!"builtin/generated".equals(s))
            {
                ...
                {
                    iresource = this.resourceManager.func_110536_a(this.func_177580_d(location));
    ...
    {
        return new ResourceLocation(p_177580_1_.getNamespace(), "models/" + p_177580_1_.getPath() + ".json");
    }
    ...
    private void func_177590_d()
    {
        ...
        for (Item item : Item.field_150901_e)
        {
            for (String s : this.func_177596_a(item))
            {
                ...
                ResourceLocation resourcelocation1 = Item.field_150901_e.getKey(item);
                ...
                if (item.hasCustomProperties())
                {
                    ...
                    if (modelblock != null)
                    {
                        for (ResourceLocation resourcelocation2 : modelblock.getDependencies())
                        {
    ...
    private void func_188634_a(String p_188634_1_, ResourceLocation p_188634_2_, ResourceLocation p_188634_3_)
    {
        ...
        if (this.field_177611_h.get(p_188634_2_) == null)
        {
            ...
            {
                LOGGER.warn("Unable to load item model: '{}' for item: '{}'", p_188634_2_, p_188634_3_, exception);
            }
        }
    }
    ...
    {
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.STONE), Lists.newArrayList("stone", "granite", "granite_smooth", "diorite", "diorite_smooth", "andesite", "andesite_smooth"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.DIRT), Lists.newArrayList("dirt", "coarse_dirt", "podzol"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150344_f), Lists.newArrayList("oak_planks", "spruce_planks", "birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150345_g), Lists.newArrayList("oak_sapling", "spruce_sapling", "birch_sapling", "jungle_sapling", "acacia_sapling", "dark_oak_sapling"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.SAND), Lists.newArrayList("sand", "red_sand"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150364_r), Lists.newArrayList("oak_log", "spruce_log", "birch_log", "jungle_log"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150362_t), Lists.newArrayList("oak_leaves", "spruce_leaves", "birch_leaves", "jungle_leaves"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.SPONGE), Lists.newArrayList("sponge", "sponge_wet"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.SANDSTONE), Lists.newArrayList("sandstone", "chiseled_sandstone", "smooth_sandstone"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.RED_SANDSTONE), Lists.newArrayList("red_sandstone", "chiseled_red_sandstone", "smooth_red_sandstone"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150329_H), Lists.newArrayList("dead_bush", "tall_grass", "fern"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150330_I), Lists.newArrayList("dead_bush"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150325_L), Lists.newArrayList("black_wool", "red_wool", "green_wool", "brown_wool", "blue_wool", "purple_wool", "cyan_wool", "silver_wool", "gray_wool", "pink_wool", "lime_wool", "yellow_wool", "light_blue_wool", "magenta_wool", "orange_wool", "white_wool"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150327_N), Lists.newArrayList("dandelion"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150328_O), Lists.newArrayList("poppy", "blue_orchid", "allium", "houstonia", "red_tulip", "orange_tulip", "white_tulip", "pink_tulip", "oxeye_daisy"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.STONE_SLAB), Lists.newArrayList("stone_slab", "sandstone_slab", "cobblestone_slab", "brick_slab", "stone_brick_slab", "nether_brick_slab", "quartz_slab"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_180389_cP), Lists.newArrayList("red_sandstone_slab"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150399_cn), Lists.newArrayList("black_stained_glass", "red_stained_glass", "green_stained_glass", "brown_stained_glass", "blue_stained_glass", "purple_stained_glass", "cyan_stained_glass", "silver_stained_glass", "gray_stained_glass", "pink_stained_glass", "lime_stained_glass", "yellow_stained_glass", "light_blue_stained_glass", "magenta_stained_glass", "orange_stained_glass", "white_stained_glass"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150418_aU), Lists.newArrayList("stone_monster_egg", "cobblestone_monster_egg", "stone_brick_monster_egg", "mossy_brick_monster_egg", "cracked_brick_monster_egg", "chiseled_brick_monster_egg"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150417_aV), Lists.newArrayList("stonebrick", "mossy_stonebrick", "cracked_stonebrick", "chiseled_stonebrick"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150376_bx), Lists.newArrayList("oak_slab", "spruce_slab", "birch_slab", "jungle_slab", "acacia_slab", "dark_oak_slab"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.COBBLESTONE_WALL), Lists.newArrayList("cobblestone_wall", "mossy_cobblestone_wall"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.ANVIL), Lists.newArrayList("anvil_intact", "anvil_slightly_damaged", "anvil_very_damaged"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.QUARTZ_BLOCK), Lists.newArrayList("quartz_block", "chiseled_quartz_block", "quartz_column"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150406_ce), Lists.newArrayList("black_stained_hardened_clay", "red_stained_hardened_clay", "green_stained_hardened_clay", "brown_stained_hardened_clay", "blue_stained_hardened_clay", "purple_stained_hardened_clay", "cyan_stained_hardened_clay", "silver_stained_hardened_clay", "gray_stained_hardened_clay", "pink_stained_hardened_clay", "lime_stained_hardened_clay", "yellow_stained_hardened_clay", "light_blue_stained_hardened_clay", "magenta_stained_hardened_clay", "orange_stained_hardened_clay", "white_stained_hardened_clay"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150397_co), Lists.newArrayList("black_stained_glass_pane", "red_stained_glass_pane", "green_stained_glass_pane", "brown_stained_glass_pane", "blue_stained_glass_pane", "purple_stained_glass_pane", "cyan_stained_glass_pane", "silver_stained_glass_pane", "gray_stained_glass_pane", "pink_stained_glass_pane", "lime_stained_glass_pane", "yellow_stained_glass_pane", "light_blue_stained_glass_pane", "magenta_stained_glass_pane", "orange_stained_glass_pane", "white_stained_glass_pane"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150361_u), Lists.newArrayList("acacia_leaves", "dark_oak_leaves"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150363_s), Lists.newArrayList("acacia_log", "dark_oak_log"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.PRISMARINE), Lists.newArrayList("prismarine", "prismarine_bricks", "dark_prismarine"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150404_cg), Lists.newArrayList("black_carpet", "red_carpet", "green_carpet", "brown_carpet", "blue_carpet", "purple_carpet", "cyan_carpet", "silver_carpet", "gray_carpet", "pink_carpet", "lime_carpet", "yellow_carpet", "light_blue_carpet", "magenta_carpet", "orange_carpet", "white_carpet"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_150398_cm), Lists.newArrayList("sunflower", "syringa", "double_grass", "double_fern", "double_rose", "paeonia"));
        this.field_177613_u.put(Items.COAL, Lists.newArrayList("coal", "charcoal"));
        ...
        this.field_177613_u.put(Items.POTION, Lists.newArrayList("bottle_drinkable"));
        ...
        this.field_177613_u.put(Items.SPLASH_POTION, Lists.newArrayList("bottle_splash"));
        this.field_177613_u.put(Items.LINGERING_POTION, Lists.newArrayList("bottle_lingering"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_192443_dR), Lists.newArrayList("black_concrete", "red_concrete", "green_concrete", "brown_concrete", "blue_concrete", "purple_concrete", "cyan_concrete", "silver_concrete", "gray_concrete", "pink_concrete", "lime_concrete", "yellow_concrete", "light_blue_concrete", "magenta_concrete", "orange_concrete", "white_concrete"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.field_192444_dS), Lists.newArrayList("black_concrete_powder", "red_concrete_powder", "green_concrete_powder", "brown_concrete_powder", "blue_concrete_powder", "purple_concrete_powder", "cyan_concrete_powder", "silver_concrete_powder", "gray_concrete_powder", "pink_concrete_powder", "lime_concrete_powder", "yellow_concrete_powder", "light_blue_concrete_powder", "magenta_concrete_powder", "orange_concrete_powder", "white_concrete_powder"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.AIR), Collections.emptyList());
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.OAK_FENCE_GATE), Lists.newArrayList("oak_fence_gate"));
        this.field_177613_u.put(Item.getItemFromBlock(Blocks.OAK_FENCE), Lists.newArrayList("oak_fence"));
        this.field_177613_u.put(Items.field_179570_aq, Lists.newArrayList("oak_door"));
        this.field_177613_u.put(Items.OAK_BOAT, Lists.newArrayList("oak_boat"));
        this.field_177613_u.put(Items.TOTEM_OF_UNDYING, Lists.newArrayList("totem"));
    }
    ...
    private List<String> func_177596_a(Item p_177596_1_)
    {
        ...
        if (list == null)
        {
            list = Collections.<String>singletonList(((ResourceLocation)Item.field_150901_e.getKey(p_177596_1_)).toString());
        }
    ...
    private void func_177588_f()
    {
        ...
        for (Entry<ModelBlockDefinition, Collection<ModelResourceLocation>> entry : this.field_188642_k.entrySet())
        {
            ...
            String s = ((ResourceLocation)Block.field_149771_c.getKey(multipart.func_188135_c().getOwner())).toString();
            ...
            {
                IBakedModel ibakedmodel1 = this.func_188639_a(selector.getVariantList(), "selector of " + s);

                if (ibakedmodel1 != null)
                {
                    multipartbakedmodel$builder.putModel(selector.getPredicate(multipart.func_188135_c()), ibakedmodel1);
                }
            }

            IBakedModel ibakedmodel2 = multipartbakedmodel$builder.build();
    ...
    private IBakedModel func_188639_a(VariantList p_188639_1_, String p_188639_2_)
    {
        ...
        else
        {
            ...
            {
                ModelBlock modelblock = this.field_177611_h.get(variant.getModelLocation());

                if (modelblock != null && modelblock.func_178303_d())
                {
                    if (modelblock.getElements().isEmpty())
                    {
                        LOGGER.warn("Missing elements for: {}", (Object)p_188639_2_);
                    }
                    else
                    {
                        IBakedModel ibakedmodel = this.func_177578_a(modelblock, variant.func_188048_b(), variant.isUvLock());
                ...
                {
                    LOGGER.warn("Missing model for: {}", (Object)p_188639_2_);
                }
            }
            ...
            if (i == 0)
            {
                LOGGER.warn("No weighted models for: {}", (Object)p_188639_2_);
            }
            else if (i == 1)
            {
    ...
    private void func_188635_i()
    {
        for (Entry<String, ResourceLocation> entry : this.field_177615_s.entrySet())
        {
            ...
            if (modelblock != null && modelblock.func_178303_d())
            {
                ...
                {
                    this.field_177605_n.func_82595_a(modelresourcelocation, new BuiltInModel(modelblock.getAllTransforms(), modelblock.func_187967_g()));
                }
                else
                {
    ...
    private Set<ResourceLocation> func_177575_g()
    {
        ...
        for (ModelBlockDefinition modelblockdefinition : this.field_188642_k.keySet())
        {
            for (VariantList variantlist1 : modelblockdefinition.getMultipartData().getVariants())
            {
                ...
                {
                    ModelBlock modelblock1 = this.field_177611_h.get(variant1.getModelLocation());

                    if (modelblock1 == null)
                    {
                        LOGGER.warn("Missing model for: {}", Block.field_149771_c.getKey(modelblockdefinition.getMultipartData().func_188135_c().getOwner()));
                    }
                    else
                    {
    ...
    private IBakedModel func_177578_a(ModelBlock p_177578_1_, ModelRotation p_177578_2_, boolean p_177578_3_)
    {
        ...
        SimpleBakedModel.Builder simplebakedmodel$builder = (new SimpleBakedModel.Builder(p_177578_1_, p_177578_1_.func_187967_g())).setTexture(textureatlassprite);

        if (p_177578_1_.getElements().isEmpty())
        {
            return null;
        }
        else
        {
            for (BlockPart blockpart : p_177578_1_.getElements())
            {
                for (EnumFacing enumfacing : blockpart.mapFaces.keySet())
                {
                    BlockPartFace blockpartface = blockpart.mapFaces.get(enumfacing);
                    TextureAtlasSprite textureatlassprite1 = this.field_177599_g.get(new ResourceLocation(p_177578_1_.func_178308_c(blockpartface.texture)));

                    if (blockpartface.cullFace == null)
                    {
                        simplebakedmodel$builder.addGeneralQuad(this.func_177589_a(blockpart, blockpartface, textureatlassprite1, enumfacing, p_177578_2_, p_177578_3_));
                    }
                    else
                    {
                        simplebakedmodel$builder.addFaceQuad(p_177578_2_.func_177523_a(blockpartface.cullFace), this.func_177589_a(blockpart, blockpartface, textureatlassprite1, enumfacing, p_177578_2_, p_177578_3_));
                    }
                }
            }
    ...
    {
        return this.field_177607_l.func_178414_a(p_177589_1_.positionFrom, p_177589_1_.positionTo, p_177589_2_, p_177589_3_, p_177589_4_, p_177589_5_, p_177589_1_.partRotation, p_177589_6_, p_177589_1_.shade);
    }
    ...
    private void func_177574_i()
    {
        ...
        while (!deque.isEmpty())
        {
            ...
            {
                LOGGER.warn("In parent chain: {}; unable to load model: '{}'", field_177601_e.join(this.func_177573_e(resourcelocation1)), resourcelocation1, exception);
            }
    ...
    private Set<ResourceLocation> func_177585_a(ModelBlock p_177585_1_)
    {
        ...
        for (BlockPart blockpart : p_177585_1_.getElements())
        {
            ...
            {
                ResourceLocation resourcelocation = new ResourceLocation(p_177585_1_.func_178308_c(blockpartface.texture));
                set.add(resourcelocation);
            }
        }
    ...
    private void func_177572_j()
    {
        ...
        this.field_177609_j.func_174943_a(this.resourceManager, itexturemappopulator);
            ...
            if (modelblock != null)
            {
                ...
                else if (!this.func_177587_c(modelblock))
                {
                    for (BlockPart blockpart : modelblock.getElements())
                    {
                        for (BlockPartFace blockpartface : blockpart.mapFaces.values())
                        {
                            ResourceLocation resourcelocation1 = new ResourceLocation(modelblock.func_178308_c(blockpartface.texture));
                            set.add(resourcelocation1);
                        }
                    }
                }
