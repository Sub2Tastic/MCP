...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
            ...
            if (itemarmor.getEquipmentSlot() == p_188361_9_)
            {
                ...
                switch (itemarmor.func_82812_d())
                {
                    case LEATHER:
                        ...
                        this.field_177190_a.func_110776_a(this.getArmorResource(itemarmor, flag, "overlay"));
                    ...
                    default:
                        if (!this.field_177193_i && itemstack.isEnchanted())
                        {
    ...
    {
        String s = String.format("textures/models/armor/%s_layer_%d%s.png", armor.func_82812_d().func_179242_c(), legSlotIn ? 2 : 1, suffixOverlayIn == null ? "" : String.format("_%s", suffixOverlayIn));
    ...
    protected abstract void setModelSlotVisible(T modelIn, EntityEquipmentSlot slotIn);
}
