...
public class TileEntityMobSpawnerRenderer extends TileEntitySpecialRenderer<TileEntityMobSpawner>
{
    public void func_192841_a(TileEntityMobSpawner p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_)
    {
        ...
        func_147517_a(p_192841_1_.getSpawnerBaseLogic(), p_192841_2_, p_192841_4_, p_192841_6_, p_192841_8_);
    ...
    public static void func_147517_a(MobSpawnerBaseLogic p_147517_0_, double p_147517_1_, double p_147517_3_, double p_147517_5_, float p_147517_7_)
    {
        ...
        if (entity != null)
        {
            ...
            GlStateManager.func_179114_b((float)(p_147517_0_.getPrevMobRotation() + (p_147517_0_.getMobRotation() - p_147517_0_.getPrevMobRotation()) * (double)p_147517_7_) * 10.0F, 0.0F, 1.0F, 0.0F);
            GlStateManager.func_179109_b(0.0F, -0.2F, 0.0F);
            GlStateManager.func_179114_b(-30.0F, 1.0F, 0.0F, 0.0F);
            GlStateManager.func_179152_a(f, f, f);
            entity.setLocationAndAngles(p_147517_1_, p_147517_3_, p_147517_5_, 0.0F, 0.0F);
            Minecraft.getInstance().getRenderManager().func_188391_a(entity, 0.0D, 0.0D, 0.0D, 0.0F, p_147517_7_, false);
        }
    }
}
