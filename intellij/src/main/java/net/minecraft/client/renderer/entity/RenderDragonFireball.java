...
public class RenderDragonFireball extends Render<EntityDragonFireball>
{
    ...
    public void func_76986_a(EntityDragonFireball p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        bufferbuilder.func_181662_b(-0.5D, -0.25D, 0.0D).func_187315_a(0.0D, 1.0D).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        bufferbuilder.func_181662_b(0.5D, -0.25D, 0.0D).func_187315_a(1.0D, 1.0D).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        bufferbuilder.func_181662_b(0.5D, 0.75D, 0.0D).func_187315_a(1.0D, 0.0D).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        bufferbuilder.func_181662_b(-0.5D, 0.75D, 0.0D).func_187315_a(0.0D, 0.0D).func_181663_c(0.0F, 1.0F, 0.0F).endVertex();
        tessellator.draw();
