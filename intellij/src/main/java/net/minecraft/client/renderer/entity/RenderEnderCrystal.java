...
public class RenderEnderCrystal extends Render<EntityEnderCrystal>
{
    ...
    public void func_76986_a(EntityEnderCrystal p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        this.func_110776_a(ENDER_CRYSTAL_TEXTURES);
        ...
        if (blockpos != null)
        {
            this.func_110776_a(RenderDragon.ENDERCRYSTAL_BEAM_TEXTURES);
            ...
            RenderDragon.func_188325_a(p_76986_2_ + d0, p_76986_4_ - 0.3D + (double)(f1 * 0.4F) + d1, p_76986_6_ + d2, p_76986_9_, (double)f2, (double)f3, (double)f4, p_76986_1_.innerRotation, p_76986_1_.posX, p_76986_1_.posY, p_76986_1_.posZ);
        }
    ...
    {
        return super.func_177071_a(p_177071_1_, p_177071_2_, p_177071_3_, p_177071_5_, p_177071_7_) || p_177071_1_.getBeamTarget() != null;
    }
}
