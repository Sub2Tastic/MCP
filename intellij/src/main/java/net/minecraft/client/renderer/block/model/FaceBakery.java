...
public class FaceBakery
{
    ...
    public BakedQuad func_178414_a(Vector3f p_178414_1_, Vector3f p_178414_2_, BlockPartFace p_178414_3_, TextureAtlasSprite p_178414_4_, EnumFacing p_178414_5_, ModelRotation p_178414_6_, @Nullable BlockPartRotation p_178414_7_, boolean p_178414_8_, boolean p_178414_9_)
    {
        ...
        if (p_178414_8_)
        {
            blockfaceuv = this.func_188010_a(p_178414_3_.blockFaceUV, p_178414_5_, p_178414_6_);
        }
        ...
        return new BakedQuad(aint, p_178414_3_.tintIndex, enumfacing, p_178414_4_);
    }
    ...
    private void func_178404_a(int[] p_178404_1_, int p_178404_2_, int p_178404_3_, Vector3f p_178404_4_, int p_178404_5_, TextureAtlasSprite p_178404_6_, BlockFaceUV p_178404_7_)
    {
        ...
        p_178404_1_[i + 4] = Float.floatToRawIntBits(p_178404_6_.getInterpolatedU((double)p_178404_7_.getVertexU(p_178404_3_)));
        p_178404_1_[i + 4 + 1] = Float.floatToRawIntBits(p_178404_6_.getInterpolatedV((double)p_178404_7_.getVertexV(p_178404_3_)));
    }
    ...
    private void applyFacing(int[] vertexData, EnumFacing directionIn)
    {
        ...
        EnumFaceDirection enumfacedirection = EnumFaceDirection.getFacing(directionIn);
