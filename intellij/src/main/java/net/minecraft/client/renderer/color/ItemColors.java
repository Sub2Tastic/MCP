...
public class ItemColors
{
    ...
    public static ItemColors init(final BlockColors colors)
    {
        ...
        itemcolors.func_186731_a(new IItemColor()
        {
            public int func_186726_a(ItemStack p_186726_1_, int p_186726_2_)
            {
                ...
                return colors.func_186724_a(iblockstate, (IBlockAccess)null, (BlockPos)null, p_186726_2_);
            }
    ...
    {
        IItemColor iitemcolor = this.colors.getByValue(Item.field_150901_e.getId(stack.getItem()));
    ...
    public void func_186731_a(IItemColor p_186731_1_, Block... p_186731_2_)
    {
        ...
        {
            this.colors.put(p_186731_1_, Item.getIdFromItem(Item.getItemFromBlock(block)));
        }
    }
    ...
    public void func_186730_a(IItemColor p_186730_1_, Item... p_186730_2_)
    {
        ...
        {
            this.colors.put(p_186730_1_, Item.getIdFromItem(item));
        }
    }
}
