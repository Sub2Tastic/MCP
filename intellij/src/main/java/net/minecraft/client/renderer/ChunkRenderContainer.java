...
public abstract class ChunkRenderContainer
{
    ...
    public void func_178003_a(RenderChunk p_178003_1_)
    {
        ...
        GlStateManager.func_179109_b((float)((double)blockpos.getX() - this.field_178008_c), (float)((double)blockpos.getY() - this.field_178005_d), (float)((double)blockpos.getZ() - this.field_178006_e));
    }
    ...
    public abstract void func_178001_a(BlockRenderLayer p_178001_1_);
}
