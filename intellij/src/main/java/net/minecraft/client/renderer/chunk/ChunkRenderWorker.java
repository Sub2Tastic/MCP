...
public class ChunkRenderWorker implements Runnable
{
    ...
    protected void func_178474_a(final ChunkCompileTaskGenerator p_178474_1_) throws InterruptedException
    {
        ...
        try
        {
            ...
            BlockPos blockpos1 = p_178474_1_.func_178536_b().getPosition();
            int i = 16;
            int j = 8;
            int k = 24;
            ...
            if (blockpos1.add(8, 8, 8).distanceSq(blockpos) > 576.0D)
            {
                ...
                if (!this.func_188263_a(blockpos$mutableblockpos.setPos(blockpos1).move(EnumFacing.WEST, 16), world) || !this.func_188263_a(blockpos$mutableblockpos.setPos(blockpos1).move(EnumFacing.NORTH, 16), world) || !this.func_188263_a(blockpos$mutableblockpos.setPos(blockpos1).move(EnumFacing.EAST, 16), world) || !this.func_188263_a(blockpos$mutableblockpos.setPos(blockpos1).move(EnumFacing.SOUTH, 16), world))
                {
                    return;
                }
            }
    ...
    {
        return !p_188263_2_.func_72964_e(p_188263_1_.getX() >> 4, p_188263_1_.getZ() >> 4).isEmpty();
    }
