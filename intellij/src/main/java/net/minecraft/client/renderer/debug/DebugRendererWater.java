...
public class DebugRendererWater implements DebugRenderer.IDebugRenderer
{
    ...
    {
        this.field_190062_b = this.minecraft.player;
        ...
        for (BlockPos blockpos1 : BlockPos.func_177980_a(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10)))
        {
        ...
        for (BlockPos blockpos2 : BlockPos.func_177980_a(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10)))
        {
            IBlockState iblockstate1 = world.getBlockState(blockpos2);

            if (iblockstate1.getBlock() == Blocks.WATER || iblockstate1.getBlock() == Blocks.field_150358_i)
            {
                ...
                String s = iblockstate1.getBlock() == Blocks.field_150358_i ? "f" : "s";
