...
public abstract class TileEntitySpecialRenderer<T extends TileEntity>
{
    ...
    public void func_192841_a(T p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_)
    {
        ...
        if (itextcomponent != null && this.field_147501_a.cameraHitResult != null && p_192841_1_.getPos().equals(this.field_147501_a.cameraHitResult.func_178782_a()))
        {
            this.func_190053_a(true);
            this.func_190052_a(p_192841_1_, itextcomponent.getFormattedText(), p_192841_2_, p_192841_4_, p_192841_6_, 12);
    ...
    {
        TextureManager texturemanager = this.field_147501_a.textureManager;
    ...
    {
        return this.field_147501_a.world;
    }
