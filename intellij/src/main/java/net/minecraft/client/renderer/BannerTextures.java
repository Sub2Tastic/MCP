    ...
    public static class Cache
    {
        ...
        public ResourceLocation func_187478_a(String p_187478_1_, List<BannerPattern> p_187478_2_, List<EnumDyeColor> p_187478_3_)
        {
            ...
            else
            {
                ...
                if (bannertextures$cacheentry == null)
                {
                    ...
                    {
                        list.add(this.field_187481_c + bannerpattern.getFileName() + ".png");
                    }
                    ...
                    Minecraft.getInstance().getTextureManager().func_110579_a(bannertextures$cacheentry.field_187484_b, new LayeredColorMaskTexture(this.field_187480_b, list, p_187478_3_));
        ...
        private boolean func_187477_a()
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    Minecraft.getInstance().getTextureManager().deleteTexture(bannertextures$cacheentry.field_187484_b);
                    iterator.remove();
                    return true;
                }
            }
