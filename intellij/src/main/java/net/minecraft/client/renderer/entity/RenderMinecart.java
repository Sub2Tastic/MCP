...
public class RenderMinecart<T extends EntityMinecart> extends Render<T>
{
    ...
    public void func_76986_a(T p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        if (vec3d != null)
        {
            Vec3d vec3d1 = p_76986_1_.getPosOffset(d0, d1, d2, 0.30000001192092896D);
            Vec3d vec3d2 = p_76986_1_.getPosOffset(d0, d1, d2, -0.30000001192092896D);
        ...
        if (f5 > 0.0F)
        {
            GlStateManager.func_179114_b(MathHelper.sin(f5) * f5 * f6 / 10.0F * (float)p_76986_1_.getRollingDirection(), 1.0F, 0.0F, 0.0F);
        }
        ...
        this.modelMinecart.func_78088_a(p_76986_1_, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GlStateManager.func_179121_F();
    ...
    {
        GlStateManager.func_179094_E();
        Minecraft.getInstance().getBlockRendererDispatcher().func_175016_a(p_188319_3_, p_188319_1_.getBrightness());
        GlStateManager.func_179121_F();
    }
}
