            ...
            for (int j = 0; j < 3; ++j)
            {
                ...
                for (int i1 = k; i1 >= l; --i1)
                {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1)
                    {
                        ...
                        bufferbuilder.func_181662_b(d10 + d2, p_76986_4_ + (double)(i1 * 16), d11 + d3).func_181666_a(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
                        bufferbuilder.func_181662_b(d8 + d4, p_76986_4_ + (double)((i1 + 1) * 16), d9 + d5).func_181666_a(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
                    }
