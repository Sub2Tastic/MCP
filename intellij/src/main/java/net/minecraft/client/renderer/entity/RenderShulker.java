...
public class RenderShulker extends RenderLiving<EntityShulker>
{
    ...
    {
        return SHULKER_ENDERGOLEM_TEXTURE[entity.getColor().func_176765_a()];
    }
    ...
    class HeadLayer implements LayerRenderer<EntityShulker>
    {
        ...
        public void func_177141_a(EntityShulker p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_)
        {
            ...
            ModelRenderer modelrenderer = RenderShulker.this.func_177087_b().head;
            modelrenderer.rotateAngleY = p_177141_6_ * 0.017453292F;
            modelrenderer.rotateAngleX = p_177141_7_ * 0.017453292F;
            RenderShulker.this.func_110776_a(RenderShulker.SHULKER_ENDERGOLEM_TEXTURE[p_177141_1_.getColor().func_176765_a()]);
