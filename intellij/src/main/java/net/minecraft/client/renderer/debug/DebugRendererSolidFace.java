...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer
{
    ...
    public void func_190060_a(float p_190060_1_, long p_190060_2_)
    {
        ...
        for (BlockPos blockpos : iterable)
        {
            ...
            {
                AxisAlignedBB axisalignedbb = iblockstate.func_185918_c(world, blockpos).grow(0.002D).offset(-d0, -d1, -d2);
                ...
                if (iblockstate.func_193401_d(world, blockpos, EnumFacing.WEST) == BlockFaceShape.SOLID)
                {
                    ...
                    bufferbuilder.func_181662_b(d3, d4, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder.func_181662_b(d3, d4, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder.func_181662_b(d3, d7, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder.func_181662_b(d3, d7, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    tessellator.draw();
                }
                ...
                if (iblockstate.func_193401_d(world, blockpos, EnumFacing.SOUTH) == BlockFaceShape.SOLID)
                {
                    ...
                    bufferbuilder1.func_181662_b(d3, d7, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder1.func_181662_b(d3, d4, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder1.func_181662_b(d6, d7, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder1.func_181662_b(d6, d4, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    tessellator1.draw();
                }
                ...
                if (iblockstate.func_193401_d(world, blockpos, EnumFacing.EAST) == BlockFaceShape.SOLID)
                {
                    ...
                    bufferbuilder2.func_181662_b(d6, d4, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder2.func_181662_b(d6, d4, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder2.func_181662_b(d6, d7, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder2.func_181662_b(d6, d7, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    tessellator2.draw();
                }
                ...
                if (iblockstate.func_193401_d(world, blockpos, EnumFacing.NORTH) == BlockFaceShape.SOLID)
                {
                    ...
                    bufferbuilder3.func_181662_b(d6, d7, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder3.func_181662_b(d6, d4, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder3.func_181662_b(d3, d7, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder3.func_181662_b(d3, d4, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    tessellator3.draw();
                }
                ...
                if (iblockstate.func_193401_d(world, blockpos, EnumFacing.DOWN) == BlockFaceShape.SOLID)
                {
                    ...
                    bufferbuilder4.func_181662_b(d3, d4, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder4.func_181662_b(d6, d4, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder4.func_181662_b(d3, d4, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder4.func_181662_b(d6, d4, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    tessellator4.draw();
                }
                ...
                if (iblockstate.func_193401_d(world, blockpos, EnumFacing.UP) == BlockFaceShape.SOLID)
                {
                    ...
                    bufferbuilder5.func_181662_b(d3, d7, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder5.func_181662_b(d3, d7, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder5.func_181662_b(d6, d7, d5).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    bufferbuilder5.func_181662_b(d6, d7, d8).func_181666_a(1.0F, 0.0F, 0.0F, 0.5F).endVertex();
                    tessellator5.draw();
                }
            }
        }
