...
public class LayerIronGolemFlower implements LayerRenderer<EntityIronGolem>
{
    ...
    public void func_177141_a(EntityIronGolem p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_)
    {
        if (p_177141_1_.getHoldRoseTick() != 0)
        {
            ...
            GlStateManager.func_179114_b(5.0F + 180.0F * ((ModelIronGolem)this.field_177154_a.func_177087_b()).ironGolemRightArm.rotateAngleX / (float)Math.PI, 1.0F, 0.0F, 0.0F);
            ...
            this.field_177154_a.func_110776_a(TextureMap.LOCATION_BLOCKS_TEXTURE);
            blockrendererdispatcher.func_175016_a(Blocks.field_150328_O.getDefaultState(), 1.0F);
