...
public class ClippingHelperImpl extends ClippingHelper
{
    ...
    private final FloatBuffer field_78561_f = GLAllocation.createDirectFloatBuffer(16);
    private final FloatBuffer field_78562_g = GLAllocation.createDirectFloatBuffer(16);
