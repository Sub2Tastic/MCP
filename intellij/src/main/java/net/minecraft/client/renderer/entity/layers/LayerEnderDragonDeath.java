...
public class LayerEnderDragonDeath implements LayerRenderer<EntityDragon>
{
    ...
    {
        if (p_177141_1_.deathTicks > 0)
        {
            Tessellator tessellator = Tessellator.getInstance();
            BufferBuilder bufferbuilder = tessellator.getBuffer();
            RenderHelper.disableStandardItemLighting();
            float f = ((float)p_177141_1_.deathTicks + p_177141_4_) / 200.0F;
            float f1 = 0.0F;
            ...
            for (int i = 0; (float)i < (f + f * f) / 2.0F * 60.0F; ++i)
            {
                ...
                bufferbuilder.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(255, 255, 255, (int)(255.0F * (1.0F - f1))).endVertex();
                bufferbuilder.func_181662_b(-0.866D * (double)f3, (double)f2, (double)(-0.5F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
                bufferbuilder.func_181662_b(0.866D * (double)f3, (double)f2, (double)(-0.5F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
                bufferbuilder.func_181662_b(0.0D, (double)f2, (double)(1.0F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
                bufferbuilder.func_181662_b(-0.866D * (double)f3, (double)f2, (double)(-0.5F * f3)).func_181669_b(255, 0, 255, 0).endVertex();
                tessellator.draw();
            }
