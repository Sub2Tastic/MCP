...
public class BlockModelRenderer
{
    ...
    {
        boolean flag = Minecraft.isAmbientOcclusionEnabled() && p_187493_3_.getLightValue() == 0 && p_187493_2_.isAmbientOcclusion();
    ...
    public boolean func_187497_c(IBlockAccess p_187497_1_, IBakedModel p_187497_2_, IBlockState p_187497_3_, BlockPos p_187497_4_, BufferBuilder p_187497_5_, boolean p_187497_6_, long p_187497_7_)
    {
        ...
        for (EnumFacing enumfacing : EnumFacing.values())
        {
            ...
            {
                int i = p_187497_3_.func_185889_a(p_187497_1_, p_187497_4_.offset(enumfacing));
    ...
    private void func_187492_a(IBlockAccess p_187492_1_, IBlockState p_187492_2_, BlockPos p_187492_3_, BufferBuilder p_187492_4_, List<BakedQuad> p_187492_5_, float[] p_187492_6_, BitSet p_187492_7_, BlockModelRenderer.AmbientOcclusionFace p_187492_8_)
    {
        ...
        for (int j = p_187492_5_.size(); i < j; ++i)
        {
            ...
            this.func_187494_a(p_187492_2_, bakedquad.getVertexData(), bakedquad.getFace(), p_187492_6_, p_187492_7_);
            p_187492_8_.func_187491_a(p_187492_1_, p_187492_2_, p_187492_3_, bakedquad.getFace(), p_187492_6_, p_187492_7_);
            p_187492_4_.func_178981_a(bakedquad.getVertexData());
            p_187492_4_.func_178962_a(p_187492_8_.vertexBrightness[0], p_187492_8_.vertexBrightness[1], p_187492_8_.vertexBrightness[2], p_187492_8_.vertexBrightness[3]);

            if (bakedquad.hasTintIndex())
            {
                int k = this.blockColors.func_186724_a(p_187492_2_, p_187492_1_, p_187492_3_, bakedquad.getTintIndex());
                ...
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[0] * f, p_187492_8_.vertexColorMultiplier[0] * f1, p_187492_8_.vertexColorMultiplier[0] * f2, 4);
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[1] * f, p_187492_8_.vertexColorMultiplier[1] * f1, p_187492_8_.vertexColorMultiplier[1] * f2, 3);
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[2] * f, p_187492_8_.vertexColorMultiplier[2] * f1, p_187492_8_.vertexColorMultiplier[2] * f2, 2);
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[3] * f, p_187492_8_.vertexColorMultiplier[3] * f1, p_187492_8_.vertexColorMultiplier[3] * f2, 1);
            }
            else
            {
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[0], p_187492_8_.vertexColorMultiplier[0], p_187492_8_.vertexColorMultiplier[0], 4);
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[1], p_187492_8_.vertexColorMultiplier[1], p_187492_8_.vertexColorMultiplier[1], 3);
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[2], p_187492_8_.vertexColorMultiplier[2], p_187492_8_.vertexColorMultiplier[2], 2);
                p_187492_4_.func_178978_a(p_187492_8_.vertexColorMultiplier[3], p_187492_8_.vertexColorMultiplier[3], p_187492_8_.vertexColorMultiplier[3], 1);
            }
    ...
    private void func_187496_a(IBlockAccess p_187496_1_, IBlockState p_187496_2_, BlockPos p_187496_3_, int p_187496_4_, boolean p_187496_5_, BufferBuilder p_187496_6_, List<BakedQuad> p_187496_7_, BitSet p_187496_8_)
    {
        ...
        for (int j = p_187496_7_.size(); i < j; ++i)
        {
            ...
            if (p_187496_5_)
            {
                this.func_187494_a(p_187496_2_, bakedquad.getVertexData(), bakedquad.getFace(), (float[])null, p_187496_8_);
            ...
            p_187496_6_.func_178981_a(bakedquad.getVertexData());
            p_187496_6_.func_178962_a(p_187496_4_, p_187496_4_, p_187496_4_, p_187496_4_);

            if (bakedquad.hasTintIndex())
            {
                int k = this.blockColors.func_186724_a(p_187496_2_, p_187496_1_, p_187496_3_, bakedquad.getTintIndex());
    ...
    public void func_178266_a(IBakedModel p_178266_1_, IBlockState p_178266_2_, float p_178266_3_, boolean p_178266_4_)
    {
        ...
        int i = this.blockColors.func_186724_a(p_178266_2_, (IBlockAccess)null, (BlockPos)null, 0);
    ...
    private void func_178264_a(float p_178264_1_, float p_178264_2_, float p_178264_3_, float p_178264_4_, List<BakedQuad> p_178264_5_)
    {
        ...
        for (int j = p_178264_5_.size(); i < j; ++i)
        {
            ...
            bufferbuilder.begin(7, DefaultVertexFormats.field_176599_b);
            bufferbuilder.func_178981_a(bakedquad.getVertexData());
            ...
            bufferbuilder.func_178975_e((float)vec3i.getX(), (float)vec3i.getY(), (float)vec3i.getZ());
            tessellator.draw();
        }
    }
    ...
    class AmbientOcclusionFace
    {
        ...
        public void func_187491_a(IBlockAccess p_187491_1_, IBlockState p_187491_2_, BlockPos p_187491_3_, EnumFacing p_187491_4_, float[] p_187491_5_, BitSet p_187491_6_)
        {
            ...
            boolean flag = p_187491_1_.getBlockState(blockpos$pooledmutableblockpos.setPos(blockpos$pooledmutableblockpos1).move(p_187491_4_)).func_185895_e();
            boolean flag1 = p_187491_1_.getBlockState(blockpos$pooledmutableblockpos.setPos(blockpos$pooledmutableblockpos2).move(p_187491_4_)).func_185895_e();
            boolean flag2 = p_187491_1_.getBlockState(blockpos$pooledmutableblockpos.setPos(blockpos$pooledmutableblockpos3).move(p_187491_4_)).func_185895_e();
            boolean flag3 = p_187491_1_.getBlockState(blockpos$pooledmutableblockpos.setPos(blockpos$pooledmutableblockpos4).move(p_187491_4_)).func_185895_e();
            float f4;
            int i1;
            ...
            if (p_187491_6_.get(0) || !p_187491_1_.getBlockState(p_187491_3_.offset(p_187491_4_)).func_185914_p())
            {
                i3 = p_187491_2_.func_185889_a(p_187491_1_, p_187491_3_.offset(p_187491_4_));
            }
