...
public class TileEntityShulkerBoxRenderer extends TileEntitySpecialRenderer<TileEntityShulkerBox>
{
    ...
    public void func_192841_a(TileEntityShulkerBox p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_)
    {
        ...
        {
            IBlockState iblockstate = this.func_178459_a().getBlockState(p_192841_1_.getPos());
        ...
        {
            this.func_147499_a(RenderShulker.SHULKER_ENDERGOLEM_TEXTURE[p_192841_1_.getColor().func_176765_a()]);
        }
        ...
        GlStateManager.func_179109_b(0.0F, -p_192841_1_.getProgress(p_192841_8_) * 0.5F, 0.0F);
        GlStateManager.func_179114_b(270.0F * p_192841_1_.getProgress(p_192841_8_), 0.0F, 1.0F, 0.0F);
        this.model.lid.func_78785_a(0.0625F);
