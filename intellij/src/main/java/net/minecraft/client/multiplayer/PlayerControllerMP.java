    ...
    public boolean onPlayerDestroyBlock(BlockPos pos)
    {
        if (this.currentGameType.hasLimitedInteractions())
        {
            ...
            if (!this.mc.player.isAllowEdit())
            {
                ...
                if (!itemstack.func_179544_c(this.mc.world.getBlockState(pos).getBlock()))
                {
                    return false;
                }
            }
        ...
        else
        {
            ...
            if ((block instanceof BlockCommandBlock || block instanceof BlockStructure) && !this.mc.player.func_189808_dh())
            {
                return false;
            }
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face)
    {
        if (this.currentGameType.hasLimitedInteractions())
        {
            ...
            if (!this.mc.player.isAllowEdit())
            {
                ...
                if (!itemstack.func_179544_c(this.mc.world.getBlockState(loc).getBlock()))
                {
                    return false;
                }
            }
        ...
        else
        {
            ...
            else if (!this.isHittingBlock || !this.isHittingPosition(loc))
            {
                ...
                {
                    iblockstate.getBlock().func_180649_a(this.mc.world, loc, this.mc.player);
                }
