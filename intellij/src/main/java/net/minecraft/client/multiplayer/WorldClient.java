...
public class WorldClient extends World
{
    ...
    public void tick()
    {
        ...
        this.profiler.func_76318_c("chunkCache");
        this.field_73033_b.func_73156_b();
        this.profiler.func_76318_c("blocks");
        this.func_147456_g();
    ...
    protected void func_147467_a(int p_147467_1_, int p_147467_2_, Chunk p_147467_3_)
    {
        ...
        if (this.ambienceTicks == 0)
        {
            ...
            if (iblockstate.getMaterial() == Material.AIR && this.func_175699_k(blockpos) <= this.rand.nextInt(8) && this.func_175642_b(EnumSkyBlock.SKY, blockpos) <= 0)
            {
    ...
    public void playSound(double x, double y, double z, SoundEvent soundIn, SoundCategory category, float volume, float pitch, boolean distanceDelay)
    {
        ...
        if (distanceDelay && d0 > 100.0D)
        {
            ...
            this.mc.getSoundHandler().playDelayed(positionedsoundrecord, (int)(d1 * 20.0D));
        }
        else
        {
