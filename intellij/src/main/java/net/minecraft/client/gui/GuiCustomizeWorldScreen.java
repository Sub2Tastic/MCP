...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void func_73866_w_()
    {
        ...
        this.field_175345_v = this.func_189646_b(new GuiButton(302, 20, 5, 80, 20, I18n.format("createWorld.customize.custom.prev")));
        this.field_175344_w = this.func_189646_b(new GuiButton(303, this.field_146294_l - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next")));
        this.field_175346_u = this.func_189646_b(new GuiButton(304, this.field_146294_l / 2 - 187, this.field_146295_m - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults")));
        this.field_175347_t = this.func_189646_b(new GuiButton(301, this.field_146294_l / 2 - 92, this.field_146295_m - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize")));
        this.field_175350_z = this.func_189646_b(new GuiButton(305, this.field_146294_l / 2 + 3, this.field_146295_m - 27, 90, 20, I18n.format("createWorld.customize.custom.presets")));
        this.field_175348_s = this.func_189646_b(new GuiButton(300, this.field_146294_l / 2 + 98, this.field_146295_m - 27, 90, 20, I18n.format("gui.done")));
        this.field_175346_u.field_146124_l = this.field_175338_A;
        this.field_175352_x = new GuiButton(306, this.field_146294_l / 2 - 55, 160, 50, 20, I18n.format("gui.yes"));
        this.field_175352_x.field_146125_m = false;
        this.field_146292_n.add(this.field_175352_x);
        this.field_175351_y = new GuiButton(307, this.field_146294_l / 2 + 5, 160, 50, 20, I18n.format("gui.no"));
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_)
    {
        ...
        {
            case 132:
                this.field_175336_F.field_177917_i = MathHelper.clamp(f, 1.0F, 5000.0F);
                f1 = this.field_175336_F.field_177917_i;
                break;

            case 133:
                this.field_175336_F.field_177911_j = MathHelper.clamp(f, 1.0F, 5000.0F);
                f1 = this.field_175336_F.field_177911_j;
                break;

            case 134:
                this.field_175336_F.field_177913_k = MathHelper.clamp(f, 1.0F, 5000.0F);
                f1 = this.field_175336_F.field_177913_k;
                break;

            case 135:
                this.field_175336_F.field_177893_f = MathHelper.clamp(f, 1.0F, 2000.0F);
                f1 = this.field_175336_F.field_177893_f;
                break;

            case 136:
                this.field_175336_F.field_177894_g = MathHelper.clamp(f, 1.0F, 2000.0F);
                f1 = this.field_175336_F.field_177894_g;
                break;

            case 137:
                this.field_175336_F.field_177915_h = MathHelper.clamp(f, 0.01F, 20.0F);
                f1 = this.field_175336_F.field_177915_h;
                break;

            case 138:
                this.field_175336_F.field_177907_l = MathHelper.clamp(f, 1.0F, 25.0F);
                f1 = this.field_175336_F.field_177907_l;
                break;

            case 139:
                this.field_175336_F.field_177899_b = MathHelper.clamp(f, 1.0F, 6000.0F);
                f1 = this.field_175336_F.field_177899_b;
                break;

            case 140:
                this.field_175336_F.field_177900_c = MathHelper.clamp(f, 1.0F, 6000.0F);
                f1 = this.field_175336_F.field_177900_c;
                break;

            case 141:
                this.field_175336_F.field_177909_m = MathHelper.clamp(f, 0.01F, 50.0F);
                f1 = this.field_175336_F.field_177909_m;
                break;

            case 142:
                this.field_175336_F.field_177896_d = MathHelper.clamp(f, 1.0F, 5000.0F);
                f1 = this.field_175336_F.field_177896_d;
                break;

            case 143:
                this.field_175336_F.field_177898_e = MathHelper.clamp(f, 1.0F, 5000.0F);
                f1 = this.field_175336_F.field_177898_e;
                break;

            case 144:
                this.field_175336_F.field_177903_n = MathHelper.clamp(f, 1.0F, 20.0F);
                f1 = this.field_175336_F.field_177903_n;
                break;

            case 145:
                this.field_175336_F.field_177905_o = MathHelper.clamp(f, 0.0F, 20.0F);
                f1 = this.field_175336_F.field_177905_o;
                break;

            case 146:
                this.field_175336_F.field_177933_p = MathHelper.clamp(f, 1.0F, 20.0F);
                f1 = this.field_175336_F.field_177933_p;
                break;

            case 147:
                this.field_175336_F.field_177931_q = MathHelper.clamp(f, 0.0F, 20.0F);
    ...
    private String func_175330_b(int p_175330_1_, float p_175330_2_)
    {
        switch (p_175330_1_)
        {
            ...
            case 162:
                ...
                else if ((int)p_175330_2_ >= Biome.func_185362_a(Biomes.NETHER))
                {
        ...
        if (p_146284_1_.field_146124_l)
        {
            switch (p_146284_1_.field_146127_k)
            {
                case 300:
                    ...
                    this.field_146297_k.displayGuiScreen(this.field_175343_i);
                    break;
                ...
                case 305:
                    this.field_146297_k.displayGuiScreen(new GuiScreenCustomizePresets(this));
                    break;
    ...
    public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        if (this.field_175339_B != 0)
        {
            ...
            this.field_146297_k.getTextureManager().bindTexture(field_110325_k);
            GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
            float f2 = 32.0F;
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            bufferbuilder.func_181662_b((double)(this.field_146294_l / 2 - 90), 185.0D, 0.0D).func_187315_a(0.0D, 2.65625D).func_181669_b(64, 64, 64, 64).endVertex();
            bufferbuilder.func_181662_b((double)(this.field_146294_l / 2 + 90), 185.0D, 0.0D).func_187315_a(5.625D, 2.65625D).func_181669_b(64, 64, 64, 64).endVertex();
            bufferbuilder.func_181662_b((double)(this.field_146294_l / 2 + 90), 100.0D, 0.0D).func_187315_a(5.625D, 0.0D).func_181669_b(64, 64, 64, 64).endVertex();
            bufferbuilder.func_181662_b((double)(this.field_146294_l / 2 - 90), 100.0D, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(64, 64, 64, 64).endVertex();
            tessellator.draw();
            this.func_73732_a(this.field_146289_q, I18n.format("createWorld.customize.custom.confirmTitle"), this.field_146294_l / 2, 105, 16777215);
            this.func_73732_a(this.field_146289_q, I18n.format("createWorld.customize.custom.confirm1"), this.field_146294_l / 2, 125, 16777215);
            this.func_73732_a(this.field_146289_q, I18n.format("createWorld.customize.custom.confirm2"), this.field_146294_l / 2, 135, 16777215);
