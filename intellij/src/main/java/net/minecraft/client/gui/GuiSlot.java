...
public abstract class GuiSlot
{
    ...
    {
        this.field_148161_k = mcIn;
        this.field_148155_a = width;
        this.field_148158_l = height;
        this.field_148153_b = topIn;
        this.field_148154_c = bottomIn;
        this.field_148149_f = slotHeightIn;
        this.field_148152_e = 0;
        this.field_148151_d = width;
    }
    ...
    protected abstract void func_148144_a(int p_148144_1_, boolean p_148144_2_, int p_148144_3_, int p_148144_4_);
    ...
    {
        this.field_148169_q = MathHelper.clamp(this.field_148169_q, 0.0F, (float)this.func_148135_f());
    }
    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            this.field_148161_k.getTextureManager().bindTexture(Gui.field_110325_k);
            GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
            float f = 32.0F;
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            bufferbuilder.func_181662_b((double)this.field_148152_e, (double)this.field_148154_c, 0.0D).func_187315_a((double)((float)this.field_148152_e / 32.0F), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / 32.0F)).func_181669_b(32, 32, 32, 255).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148151_d, (double)this.field_148154_c, 0.0D).func_187315_a((double)((float)this.field_148151_d / 32.0F), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / 32.0F)).func_181669_b(32, 32, 32, 255).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148151_d, (double)this.field_148153_b, 0.0D).func_187315_a((double)((float)this.field_148151_d / 32.0F), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / 32.0F)).func_181669_b(32, 32, 32, 255).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148152_e, (double)this.field_148153_b, 0.0D).func_187315_a((double)((float)this.field_148152_e / 32.0F), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / 32.0F)).func_181669_b(32, 32, 32, 255).endVertex();
            tessellator.draw();
            ...
            int i1 = 4;
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            bufferbuilder.func_181662_b((double)this.field_148152_e, (double)(this.field_148153_b + 4), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 0).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148151_d, (double)(this.field_148153_b + 4), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 0).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148151_d, (double)this.field_148153_b, 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148152_e, (double)this.field_148153_b, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).endVertex();
            tessellator.draw();
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            bufferbuilder.func_181662_b((double)this.field_148152_e, (double)this.field_148154_c, 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148151_d, (double)this.field_148154_c, 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148151_d, (double)(this.field_148154_c - 4), 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 0).endVertex();
            bufferbuilder.func_181662_b((double)this.field_148152_e, (double)(this.field_148154_c - 4), 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 0).endVertex();
            tessellator.draw();
            ...
            if (j1 > 0)
            {
                ...
                k1 = MathHelper.clamp(k1, 32, this.field_148154_c - this.field_148153_b - 8);
                ...
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b((double)i, (double)this.field_148154_c, 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).endVertex();
                bufferbuilder.func_181662_b((double)j, (double)this.field_148154_c, 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).endVertex();
                bufferbuilder.func_181662_b((double)j, (double)this.field_148153_b, 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).endVertex();
                bufferbuilder.func_181662_b((double)i, (double)this.field_148153_b, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).endVertex();
                tessellator.draw();
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b((double)i, (double)(l1 + k1), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)j, (double)(l1 + k1), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)j, (double)l1, 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)i, (double)l1, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                tessellator.draw();
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b((double)i, (double)(l1 + k1 - 1), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(192, 192, 192, 255).endVertex();
                bufferbuilder.func_181662_b((double)(j - 1), (double)(l1 + k1 - 1), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(192, 192, 192, 255).endVertex();
                bufferbuilder.func_181662_b((double)(j - 1), (double)l1, 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(192, 192, 192, 255).endVertex();
                bufferbuilder.func_181662_b((double)i, (double)l1, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(192, 192, 192, 255).endVertex();
                tessellator.draw();
            }
                ...
                if (this.field_148157_o == -1)
                {
                    ...
                    if (this.field_148162_h >= this.field_148153_b && this.field_148162_h <= this.field_148154_c)
                    {
                        ...
                        if (this.field_148150_g >= i3 && this.field_148150_g <= j1)
                        {
                            ...
                            l1 = MathHelper.clamp(l1, 32, this.field_148154_c - this.field_148153_b - 8);
    ...
    protected void func_192638_a(int p_192638_1_, int p_192638_2_, int p_192638_3_, int p_192638_4_, float p_192638_5_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            if (this.field_148166_t && this.func_148131_a(j))
            {
                ...
                GlStateManager.func_179090_x();
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b((double)i1, (double)(k + l + 2), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)j1, (double)(k + l + 2), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)j1, (double)(k - 2), 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)i1, (double)(k - 2), 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)(i1 + 1), (double)(k + l + 1), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).endVertex();
                bufferbuilder.func_181662_b((double)(j1 - 1), (double)(k + l + 1), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).endVertex();
                bufferbuilder.func_181662_b((double)(j1 - 1), (double)(k - 1), 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).endVertex();
                bufferbuilder.func_181662_b((double)(i1 + 1), (double)(k - 1), 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).endVertex();
                tessellator.draw();
                GlStateManager.func_179098_w();
            }
    ...
    protected void func_148136_c(int p_148136_1_, int p_148136_2_, int p_148136_3_, int p_148136_4_)
    {
        ...
        float f = 32.0F;
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        bufferbuilder.func_181662_b((double)this.field_148152_e, (double)p_148136_2_, 0.0D).func_187315_a(0.0D, (double)((float)p_148136_2_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_4_).endVertex();
        bufferbuilder.func_181662_b((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_2_, 0.0D).func_187315_a((double)((float)this.field_148155_a / 32.0F), (double)((float)p_148136_2_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_4_).endVertex();
        bufferbuilder.func_181662_b((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_1_, 0.0D).func_187315_a((double)((float)this.field_148155_a / 32.0F), (double)((float)p_148136_1_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_3_).endVertex();
        bufferbuilder.func_181662_b((double)this.field_148152_e, (double)p_148136_1_, 0.0D).func_187315_a(0.0D, (double)((float)p_148136_1_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_3_).endVertex();
        tessellator.draw();
    }
