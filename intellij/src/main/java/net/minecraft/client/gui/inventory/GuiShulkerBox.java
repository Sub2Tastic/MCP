...
public class GuiShulkerBox extends GuiContainer
{
    ...
    {
        this.field_146289_q.func_78276_b(this.field_190779_v.getDisplayName().func_150260_c(), 8, 6, 4210752);
        this.field_146289_q.func_78276_b(this.field_190780_w.getDisplayName().func_150260_c(), 8, this.ySize - 96 + 2, 4210752);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.field_146297_k.getTextureManager().bindTexture(GUI_TEXTURE);
