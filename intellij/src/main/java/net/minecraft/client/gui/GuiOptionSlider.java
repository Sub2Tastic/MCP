...
public class GuiOptionSlider extends GuiButton
{
    ...
    protected void func_146119_b(Minecraft p_146119_1_, int p_146119_2_, int p_146119_3_)
    {
        if (this.field_146125_m)
        {
            if (this.field_146135_o)
            {
                ...
                this.field_146134_p = MathHelper.clamp(this.field_146134_p, 0.0F, 1.0F);
                float f = this.option.func_148262_d(this.field_146134_p);
                p_146119_1_.gameSettings.func_74304_a(this.option, f);
                this.field_146134_p = this.option.func_148266_c(f);
                this.field_146126_j = p_146119_1_.gameSettings.func_74297_c(this.option);
            }

            p_146119_1_.getTextureManager().bindTexture(field_146122_a);
    ...
    public boolean func_146116_c(Minecraft p_146116_1_, int p_146116_2_, int p_146116_3_)
    {
        if (super.func_146116_c(p_146116_1_, p_146116_2_, p_146116_3_))
        {
            ...
            this.field_146134_p = MathHelper.clamp(this.field_146134_p, 0.0F, 1.0F);
            p_146116_1_.gameSettings.func_74304_a(this.option, this.option.func_148262_d(this.field_146134_p));
            this.field_146126_j = p_146116_1_.gameSettings.func_74297_c(this.option);
