...
public class GuiToast extends Gui
{
    ...
    public void func_191783_a(ScaledResolution p_191783_1_)
    {
        if (!this.mc.gameSettings.hideGUI)
        {
            ...
            for (int i = 0; i < this.visible.length; ++i)
            {
                ...
                if (toastinstance != null && toastinstance.render(p_191783_1_.func_78326_a(), i))
                {
                    this.visible[i] = null;
                }
    ...
    class ToastInstance<T extends IToast>
    {
        ...
        public boolean render(int p_193684_1_, int p_193684_2_)
        {
            ...
            GlStateManager.func_179109_b((float)p_193684_1_ - 160.0F * this.getVisibility(i), (float)(p_193684_2_ * 32), (float)(500 + p_193684_2_));
