...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            this.func_180480_a(this.mc.player.getBrightness(), scaledresolution);
        }
        else
        {
        ...
        {
            this.spectatorGui.func_175264_a(scaledresolution, partialTicks);
        }
        else
        {
            this.func_180479_a(scaledresolution, partialTicks);
        }

        GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
        this.mc.getTextureManager().bindTexture(field_110324_m);
        GlStateManager.func_179147_l();
        ...
        if (this.mc.gameSettings.heldItemTooltips && !this.mc.playerController.func_78747_a())
        {
        ...
        if (this.overlayMessageTime > 0)
        {
            ...
            if (l1 > 8)
            {
                ...
                fontrenderer.func_78276_b(this.overlayMessage, -fontrenderer.getStringWidth(this.overlayMessage) / 2, -4, l + (l1 << 24 & -16777216));
                GlStateManager.func_179084_k();
        ...
        if (this.titlesTimer > 0)
        {
            ...
            if (i2 > 8)
            {
                ...
                fontrenderer.func_175065_a(this.displayedTitle, (float)(-fontrenderer.getStringWidth(this.displayedTitle) / 2), -10.0F, 16777215 | j2, true);
                GlStateManager.func_179121_F();
                GlStateManager.func_179094_E();
                GlStateManager.func_179152_a(2.0F, 2.0F, 2.0F);
                fontrenderer.func_175065_a(this.displayedSubTitle, (float)(-fontrenderer.getStringWidth(this.displayedSubTitle) / 2), 5.0F, 16777215 | j2, true);
                GlStateManager.func_179121_F();
                GlStateManager.func_179084_k();
                GlStateManager.func_179121_F();
            }
        ...
        ScorePlayerTeam scoreplayerteam = scoreboard.getPlayersTeam(this.mc.player.func_70005_c_());
        ...
        else
        {
            ...
            this.overlayPlayerList.render(i, scoreboard, scoreobjective1);
        }
    ...
    private void func_184045_a(float p_184045_1_, ScaledResolution p_184045_2_)
    {
        ...
        {
            if (this.mc.playerController.func_78747_a() && this.mc.pointedEntity == null)
            {
            ...
            if (gamesettings.showDebugInfo && !gamesettings.hideGUI && !this.mc.player.hasReducedDebug() && !gamesettings.reducedDebugInfo)
            {
                ...
                GlStateManager.func_179114_b(entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * p_184045_1_, -1.0F, 0.0F, 0.0F);
                GlStateManager.func_179114_b(entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * p_184045_1_, 0.0F, 1.0F, 0.0F);
            ...
            else
            {
                ...
                if (this.mc.gameSettings.attackIndicator == 1)
                {
                    ...
                    if (this.mc.pointedEntity != null && this.mc.pointedEntity instanceof EntityLivingBase && f >= 1.0F)
                    {
                        ...
                        flag = flag & ((EntityLivingBase)this.mc.pointedEntity).isAlive();
                    }
    ...
    protected void func_184048_a(ScaledResolution p_184048_1_)
    {
        ...
        if (!collection.isEmpty())
        {
            ...
            for (PotionEffect potioneffect : Ordering.natural().reverse().sortedCopy(collection))
            {
                ...
                if (potion.func_76400_d() && potioneffect.doesShowParticles())
                {
    ...
    protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            this.func_73729_b(i - 91 - 1 + entityplayer.inventory.currentItem * 20, p_180479_1_.func_78328_b() - 22 - 1, 0, 22, 24, 22);
            ...
            for (int l = 0; l < 9; ++l)
            {
                ...
                this.renderHotbarItem(i1, j1, p_180479_2_, entityplayer, entityplayer.inventory.mainInventory.get(l));
            }
            ...
            if (!itemstack.isEmpty())
            {
                ...
                if (enumhandside == EnumHandSide.LEFT)
                {
                    this.renderHotbarItem(i - 91 - 26, l1, p_180479_2_, entityplayer, itemstack);
                }
                else
                {
                    this.renderHotbarItem(i + 91 + 10, l1, p_180479_2_, entityplayer, itemstack);
                }
            }
    ...
    public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        if (this.mc.player.experienceLevel > 0)
        {
            ...
            int i1 = (p_175176_1_.func_78326_a() - this.getFontRenderer().getStringWidth(s)) / 2;
            int j1 = p_175176_1_.func_78328_b() - 31 - 4;
            this.getFontRenderer().func_78276_b(s, i1 + 1, j1, 0);
            this.getFontRenderer().func_78276_b(s, i1 - 1, j1, 0);
            this.getFontRenderer().func_78276_b(s, i1, j1 + 1, 0);
            this.getFontRenderer().func_78276_b(s, i1, j1 - 1, 0);
            this.getFontRenderer().func_78276_b(s, i1, j1, 8453920);
            this.mc.profiler.endSection();
        }
    }
    ...
    public void func_181551_a(ScaledResolution p_181551_1_)
    {
        ...
        {
            String s = this.highlightingItemStack.func_82833_r();
            ...
            int i = (p_181551_1_.func_78326_a() - this.getFontRenderer().getStringWidth(s)) / 2;
    ...
    public void func_175185_b(ScaledResolution p_175185_1_)
    {
        ...
        this.getFontRenderer().drawStringWithShadow(s, (float)(p_175185_1_.func_78326_a() - i - 10), 5.0F, 16777215);
        this.mc.profiler.endSection();
    }
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Score score : collection)
        {
            ...
            String s = ScorePlayerTeam.func_96667_a(scoreplayerteam, score.getPlayerName()) + ": " + TextFormatting.RED + score.getScorePoints();
        ...
        for (Score score1 : collection)
        {
            ...
            String s1 = ScorePlayerTeam.func_96667_a(scoreplayerteam1, score1.getPlayerName());
            String s2 = TextFormatting.RED + "" + score1.getScorePoints();
            int k = j1 - j * this.getFontRenderer().FONT_HEIGHT;
            int l = p_180475_2_.func_78326_a() - 3 + 2;
            func_73734_a(l1 - 2, k, l, k + this.getFontRenderer().FONT_HEIGHT, 1342177280);
            this.getFontRenderer().func_78276_b(s1, l1, k, 553648127);
            this.getFontRenderer().func_78276_b(s2, l - this.getFontRenderer().getStringWidth(s2), k, 553648127);

            if (j == collection.size())
            {
                String s3 = p_180475_1_.getDisplayName();
                func_73734_a(l1 - 2, k - this.getFontRenderer().FONT_HEIGHT - 1, l, k - 1, 1610612736);
                func_73734_a(l1 - 2, k - 1, l, k, 1342177280);
                this.getFontRenderer().func_78276_b(s3, l1 + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, k - this.getFontRenderer().FONT_HEIGHT, 553648127);
            }
        }
    }
    ...
    private void func_180477_d(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            {
                j3 = this.ticks % MathHelper.ceil(f + 5.0F);
            }
            ...
            this.mc.profiler.func_76318_c("health");
            ...
            {
                this.mc.profiler.func_76318_c("food");
                ...
                for (int l5 = 0; l5 < 10; ++l5)
                {
                    ...
                    if (entityplayer.getFoodStats().getSaturationLevel() <= 0.0F && this.ticks % (k * 3 + 1) == 0)
                    {
            ...
            this.mc.profiler.func_76318_c("air");

            if (entityplayer.func_70055_a(Material.WATER))
            {
    ...
    private void func_184047_e(ScaledResolution p_184047_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            {
                this.mc.profiler.func_76318_c("mountHealth");
    ...
    private void func_180476_e(ScaledResolution p_180476_1_)
    {
        ...
        bufferbuilder.func_181662_b(0.0D, (double)p_180476_1_.func_78328_b(), -90.0D).func_187315_a(0.0D, 1.0D).endVertex();
        bufferbuilder.func_181662_b((double)p_180476_1_.func_78326_a(), (double)p_180476_1_.func_78328_b(), -90.0D).func_187315_a(1.0D, 1.0D).endVertex();
        bufferbuilder.func_181662_b((double)p_180476_1_.func_78326_a(), 0.0D, -90.0D).func_187315_a(1.0D, 0.0D).endVertex();
        bufferbuilder.func_181662_b(0.0D, 0.0D, -90.0D).func_187315_a(0.0D, 0.0D).endVertex();
        tessellator.draw();
    ...
    private void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_)
    {
        ...
        p_180480_1_ = MathHelper.clamp(p_180480_1_, 0.0F, 1.0F);
        ...
        {
            GlStateManager.func_179131_c(this.prevVignetteBrightness, this.prevVignetteBrightness, this.prevVignetteBrightness, 1.0F);
        }
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.func_181662_b(0.0D, (double)p_180480_2_.func_78328_b(), -90.0D).func_187315_a(0.0D, 1.0D).endVertex();
        bufferbuilder.func_181662_b((double)p_180480_2_.func_78326_a(), (double)p_180480_2_.func_78328_b(), -90.0D).func_187315_a(1.0D, 1.0D).endVertex();
        bufferbuilder.func_181662_b((double)p_180480_2_.func_78326_a(), 0.0D, -90.0D).func_187315_a(1.0D, 0.0D).endVertex();
        bufferbuilder.func_181662_b(0.0D, 0.0D, -90.0D).func_187315_a(0.0D, 0.0D).endVertex();
        tessellator.draw();
        GlStateManager.func_179132_a(true);
        GlStateManager.func_179126_j();
    ...
    private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_)
    {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.func_181662_b(0.0D, (double)p_180474_2_.func_78328_b(), -90.0D).func_187315_a((double)f, (double)f3).endVertex();
        bufferbuilder.func_181662_b((double)p_180474_2_.func_78326_a(), (double)p_180474_2_.func_78328_b(), -90.0D).func_187315_a((double)f2, (double)f3).endVertex();
        bufferbuilder.func_181662_b((double)p_180474_2_.func_78326_a(), 0.0D, -90.0D).func_187315_a((double)f2, (double)f1).endVertex();
        bufferbuilder.func_181662_b(0.0D, 0.0D, -90.0D).func_187315_a((double)f, (double)f1).endVertex();
        tessellator.draw();
        GlStateManager.func_179132_a(true);
        GlStateManager.func_179126_j();
        GlStateManager.func_179141_d();
    ...
    public void tick()
    {
        ...
        if (this.mc.player != null)
        {
            ...
            else if (!this.highlightingItemStack.isEmpty() && itemstack.getItem() == this.highlightingItemStack.getItem() && ItemStack.areItemStackTagsEqual(itemstack, this.highlightingItemStack) && (itemstack.isDamageable() || itemstack.func_77960_j() == this.highlightingItemStack.func_77960_j()))
            {
    ...
    {
        this.setOverlayMessage(component.func_150260_c(), animateColor);
    }
