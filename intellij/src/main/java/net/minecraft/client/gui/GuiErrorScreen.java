...
public class GuiErrorScreen extends GuiScreen
{
    ...
    {
        super.func_73866_w_();
        this.field_146292_n.add(new GuiButton(0, this.field_146294_l / 2 - 100, 140, I18n.format("gui.cancel")));
    }
    ...
    public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.func_73732_a(this.field_146289_q, this.message, this.field_146294_l / 2, 110, 16777215);
