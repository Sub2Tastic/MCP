...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    {
        return p_175243_1_.getDisplayName() != null ? p_175243_1_.getDisplayName().getFormattedText() : ScorePlayerTeam.func_96667_a(p_175243_1_.getPlayerTeam(), p_175243_1_.getGameProfile().getName());
    }
    ...
    public void render(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn)
    {
        ...
        {
            int k = this.mc.fontRenderer.getStringWidth(this.func_175243_a(networkplayerinfo));
            i = Math.max(i, k);
        ...
        if (list1 != null)
        {
            func_73734_a(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.fontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if (flag)
                {
                    EntityPlayer entityplayer = this.mc.world.func_152378_a(gameprofile.getId());
        ...
        {
            k1 = k1 + i4 * 9 + 1;
            func_73734_a(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list2.size() * this.mc.fontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);
    ...
    private void drawScoreboardValues(ScoreObjective objective, int p_175247_2_, String name, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo info)
    {
        ...
        if (objective.func_178766_e() == IScoreCriteria.EnumRenderType.HEARTS)
        {
            ...
            if (this.lastTimeOpened == info.getRenderVisibilityId())
            {
                ...
                {
                    info.setLastHealthTime(Minecraft.func_71386_F());
            ...
            if (Minecraft.func_71386_F() - info.getLastHealthTime() > 1000L || this.lastTimeOpened != info.getRenderVisibilityId())
            {
