...
public abstract class GuiResourcePackList extends GuiListExtended
{
    ...
    protected void func_148129_a(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_)
    {
        ...
        this.mc.fontRenderer.func_78276_b(s, p_148129_1_ + this.field_148155_a / 2 - this.mc.fontRenderer.getStringWidth(s) / 2, Math.min(this.field_148153_b + 3, p_148129_2_), 16777215);
    }
