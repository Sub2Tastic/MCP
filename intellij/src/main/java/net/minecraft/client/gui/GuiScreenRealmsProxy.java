...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    {
        return this.field_146289_q.FONT_HEIGHT;
    }

    public int func_154326_c(String p_154326_1_)
    {
        return this.field_146289_q.getStringWidth(p_154326_1_);
    }

    public void func_154319_c(String p_154319_1_, int p_154319_2_, int p_154319_3_, int p_154319_4_)
    {
        this.field_146289_q.drawStringWithShadow(p_154319_1_, (float)p_154319_2_, (float)p_154319_3_, p_154319_4_);
    }

    public List<String> func_154323_a(String p_154323_1_, int p_154323_2_)
    {
        return this.field_146289_q.listFormattedStringToWidth(p_154323_1_, p_154323_2_);
    }
