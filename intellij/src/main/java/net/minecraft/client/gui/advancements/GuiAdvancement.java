...
public class GuiAdvancement extends Gui
{
    ...
    public void draw(int p_191817_1_, int p_191817_2_)
    {
        if (!this.displayInfo.isHidden() || this.advancementProgress != null && this.advancementProgress.isDone())
        {
            ...
            this.func_73729_b(p_191817_1_ + this.x + 3, p_191817_2_ + this.y, this.displayInfo.getFrame().getIcon(), 128 + advancementstate.getId() * 26, 26, 26);
    ...
    {
        boolean flag = p_191821_4_ + p_191821_1_ + this.x + this.width + 26 >= this.guiAdvancementTab.getScreen().field_146294_l;
        ...
        this.func_73729_b(i1, l, 0, advancementstate.getId() * 26, j, 26);
        this.func_73729_b(i1 + j, l, 200 - k, advancementstate1.getId() * 26, k, 26);
        this.func_73729_b(p_191821_1_ + this.x + 3, p_191821_2_ + this.y, this.displayInfo.getFrame().getIcon(), 128 + advancementstate2.getId() * 26, 26, 26);

        if (flag)
        {
            this.minecraft.fontRenderer.func_175065_a(this.title, (float)(i1 + 5), (float)(p_191821_2_ + this.y + 9), -1, true);

            if (s != null)
            {
                this.minecraft.fontRenderer.func_175065_a(s, (float)(p_191821_1_ + this.x - i), (float)(p_191821_2_ + this.y + 9), -1, true);
            }
        }
        else
        {
            this.minecraft.fontRenderer.func_175065_a(this.title, (float)(p_191821_1_ + this.x + 32), (float)(p_191821_2_ + this.y + 9), -1, true);

            if (s != null)
            {
                this.minecraft.fontRenderer.func_175065_a(s, (float)(p_191821_1_ + this.x + this.width - i - 5), (float)(p_191821_2_ + this.y + 9), -1, true);
            }
        }
        ...
        if (flag1)
        {
            ...
            {
                this.minecraft.fontRenderer.func_175065_a(this.description.get(k1), (float)(i1 + 5), (float)(l + 26 - j1 + 7 + k1 * this.minecraft.fontRenderer.FONT_HEIGHT), -5592406, false);
            }
        }
        else
        {
            ...
            {
                this.minecraft.fontRenderer.func_175065_a(this.description.get(l1), (float)(i1 + 5), (float)(p_191821_2_ + this.y + 9 + 17 + l1 * this.minecraft.fontRenderer.FONT_HEIGHT), -5592406, false);
            }
        }
