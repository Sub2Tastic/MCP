...
public class GuiScreenBook extends GuiScreen
{
    ...
    public GuiScreenBook(EntityPlayer p_i1080_1_, ItemStack p_i1080_2_, boolean p_i1080_3_)
    {
        ...
        if (p_i1080_2_.hasTag())
        {
            NBTTagCompound nbttagcompound = p_i1080_2_.getTag();
            this.field_146483_y = nbttagcompound.getList("pages", 8).copy();
    ...
    public void func_73866_w_()
    {
        ...
        {
            this.field_146465_D = this.func_189646_b(new GuiButton(3, this.field_146294_l / 2 - 100, 196, 98, 20, I18n.format("book.signButton")));
            this.field_146472_C = this.func_189646_b(new GuiButton(0, this.field_146294_l / 2 + 2, 196, 98, 20, I18n.format("gui.done")));
            this.field_146467_E = this.func_189646_b(new GuiButton(5, this.field_146294_l / 2 - 100, 196, 98, 20, I18n.format("book.finalizeButton")));
            this.field_146469_F = this.func_189646_b(new GuiButton(4, this.field_146294_l / 2 + 2, 196, 98, 20, I18n.format("gui.cancel")));
        }
        else
        {
            this.field_146472_C = this.func_189646_b(new GuiButton(0, this.field_146294_l / 2 - 100, 196, 200, 20, I18n.format("gui.done")));
        }
    ...
    private void func_146462_a(boolean p_146462_1_) throws IOException
    {
        if (this.field_146475_i && this.field_146481_r)
        {
            if (this.field_146483_y != null)
            {
                ...
                {
                    String s = this.field_146483_y.getString(this.field_146483_y.func_74745_c() - 1);
                ...
                if (this.field_146474_h.hasTag())
                {
                    NBTTagCompound nbttagcompound = this.field_146474_h.getTag();
                ...
                {
                    s1 = "MC|BSign";
                    this.field_146474_h.setTagInfo("author", new NBTTagString(this.field_146468_g.func_70005_c_()));
                    this.field_146474_h.setTagInfo("title", new NBTTagString(this.field_146482_z.trim()));
                }

                PacketBuffer packetbuffer = new PacketBuffer(Unpooled.buffer());
                packetbuffer.writeItemStack(this.field_146474_h);
                this.field_146297_k.getConnection().sendPacket(new CPacketCustomPayload(s1, packetbuffer));
            }
        }
    }
    ...
    {
        return this.field_146483_y != null && this.field_146484_x >= 0 && this.field_146484_x < this.field_146483_y.func_74745_c() ? this.field_146483_y.getString(this.field_146484_x) : "";
    }
    ...
    private void func_146459_b(String p_146459_1_)
    {
        ...
        int i = this.field_146289_q.getWordWrappedHeight(s1 + "" + TextFormatting.BLACK + "_", 118);
    ...
    public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        if (this.field_146480_s)
        {
            ...
            int k = this.field_146289_q.getStringWidth(s1);
            ...
            String s2 = I18n.format("book.byAuthor", this.field_146468_g.func_70005_c_());
            int i1 = this.field_146289_q.getStringWidth(s2);
            ...
            this.field_146289_q.drawSplitString(s3, i + 36, 82, 116, 0);
        }
        else
        {
            String s4 = I18n.format("book.pageIndicator", this.field_146484_x + 1, this.field_146476_w);
            String s5 = "";

            if (this.field_146483_y != null && this.field_146484_x >= 0 && this.field_146484_x < this.field_146483_y.func_74745_c())
            {
                s5 = this.field_146483_y.getString(this.field_146484_x);
            }
            ...
            {
                if (ItemWrittenBook.validBookTagContents(this.field_146474_h.getTag()))
                {
                    try
                    {
                        ITextComponent itextcomponent = ITextComponent.Serializer.fromJson(s5);
                        this.field_175386_A = itextcomponent != null ? GuiUtilRenderComponents.splitText(itextcomponent, 116, this.field_146289_q, true, true) : null;
                    }
            ...
            int j1 = this.field_146289_q.getStringWidth(s4);
            this.field_146289_q.func_78276_b(s4, i - j1 + 192 - 44, 18, 0);

            if (this.field_175386_A == null)
            {
                this.field_146289_q.drawSplitString(s5, i + 36, 34, 116, 0);
            }
            else
            {
                int k1 = Math.min(128 / this.field_146289_q.FONT_HEIGHT, this.field_175386_A.size());

                for (int l1 = 0; l1 < k1; ++l1)
                {
                    ITextComponent itextcomponent2 = this.field_175386_A.get(l1);
                    this.field_146289_q.func_78276_b(itextcomponent2.func_150260_c(), i + 36, 34 + l1 * this.field_146289_q.FONT_HEIGHT, 0);
                }
    ...
    public ITextComponent func_175385_b(int p_175385_1_, int p_175385_2_)
    {
        ...
        else
        {
            ...
            if (i >= 0 && j >= 0)
            {
                int k = Math.min(128 / this.field_146289_q.FONT_HEIGHT, this.field_175386_A.size());

                if (i <= 116 && j < this.field_146297_k.fontRenderer.FONT_HEIGHT * k + k)
                {
                    int l = j / this.field_146297_k.fontRenderer.FONT_HEIGHT;
                    ...
                    if (l >= 0 && l < this.field_175386_A.size())
                    {
                        ...
                        for (ITextComponent itextcomponent1 : itextcomponent)
                        {
                            ...
                            {
                                i1 += this.field_146297_k.fontRenderer.getStringWidth(((TextComponentString)itextcomponent1).getText());
    ...
    static class NextPageButton extends GuiButton
    {
        ...
        public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_)
        {
            if (this.field_146125_m)
            {
                ...
                GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
                p_191745_1_.getTextureManager().bindTexture(GuiScreenBook.field_146466_f);
                int i = 0;
                int j = 192;
