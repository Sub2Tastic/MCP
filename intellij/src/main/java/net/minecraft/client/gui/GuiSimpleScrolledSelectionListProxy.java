    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            if (i1 > 0)
            {
                ...
                j1 = MathHelper.clamp(j1, 32, this.field_148154_c - this.field_148153_b - 8);
                ...
                tessellator.draw();
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b((double)i, (double)(k1 + j1), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)j, (double)(k1 + j1), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)j, (double)k1, 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                bufferbuilder.func_181662_b((double)i, (double)k1, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                tessellator.draw();
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b((double)i, (double)(k1 + j1 - 1), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(192, 192, 192, 255).endVertex();
                bufferbuilder.func_181662_b((double)(j - 1), (double)(k1 + j1 - 1), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(192, 192, 192, 255).endVertex();
                bufferbuilder.func_181662_b((double)(j - 1), (double)k1, 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(192, 192, 192, 255).endVertex();
                bufferbuilder.func_181662_b((double)i, (double)k1, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(192, 192, 192, 255).endVertex();
                tessellator.draw();
            }
