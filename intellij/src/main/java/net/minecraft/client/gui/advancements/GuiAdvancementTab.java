...
public class GuiAdvancementTab extends Gui
{
    ...
    public void drawToolTips(int p_192991_1_, int p_192991_2_, int p_192991_3_, int p_192991_4_)
    {
        ...
        func_73734_a(0, 0, 234, 113, MathHelper.floor(this.fade * 255.0F) << 24);
        boolean flag = false;
    ...
    {
        return this.type.func_192654_a(p_191793_1_, p_191793_2_, this.index, p_191793_3_, p_191793_4_);
    }
