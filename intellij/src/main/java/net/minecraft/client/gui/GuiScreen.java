...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void func_73869_a(char p_73869_1_, int p_73869_2_) throws IOException
    {
        if (p_73869_2_ == 1)
        {
            ...
            if (this.field_146297_k.currentScreen == null)
            {
    ...
    {
        List<String> list = p_191927_1_.getTooltip(this.field_146297_k.player, this.field_146297_k.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
    ...
    public void func_146283_a(List<String> p_146283_1_, int p_146283_2_, int p_146283_3_)
    {
        if (!p_146283_1_.isEmpty())
        {
            ...
            {
                int j = this.field_146289_q.getStringWidth(s);
            ...
            this.field_146296_j.zLevel = 300.0F;
            int l = -267386864;
            ...
            for (int k1 = 0; k1 < p_146283_1_.size(); ++k1)
            {
                ...
                this.field_146289_q.drawStringWithShadow(s1, (float)l1, (float)i2, -1);
    ...
    protected void func_175272_a(ITextComponent p_175272_1_, int p_175272_2_, int p_175272_3_)
    {
        if (p_175272_1_ != null && p_175272_1_.getStyle().getHoverEvent() != null)
        {
            ...
            {
                if (this.field_146297_k.gameSettings.advancedItemTooltips)
                {
                    try
                    {
            ...
            {
                this.func_146283_a(this.field_146297_k.fontRenderer.listFormattedStringToWidth(hoverevent.getValue().getFormattedText(), Math.max(this.field_146294_l / 2, 200)), p_175272_2_, p_175272_3_);
            }
    ...
    public boolean func_175276_a(ITextComponent p_175276_1_)
    {
        ...
        else
        {
            ...
            if (func_146272_n())
            {
                ...
                {
                    this.func_175274_a(p_175276_1_.getStyle().getInsertion(), false);
                }
            }
            else if (clickevent != null)
            {
                if (clickevent.getAction() == ClickEvent.Action.OPEN_URL)
                {
                    ...
                    try
                    {
                        ...
                        if (this.field_146297_k.gameSettings.chatLinksPrompt)
                        {
                            ...
                            this.field_146297_k.displayGuiScreen(new GuiConfirmOpenLink(this, clickevent.getValue(), 31102009, false));
                        }
                        else
                        {
                ...
                {
                    this.func_175274_a(clickevent.getValue(), true);
                }
                else if (clickevent.getAction() == ClickEvent.Action.RUN_COMMAND)
                {
                    this.func_175281_b(clickevent.getValue(), false);
                }
                else
                {
    ...
    public void func_175281_b(String p_175281_1_, boolean p_175281_2_)
    {
        if (p_175281_2_)
        {
            this.field_146297_k.ingameGUI.getChatGUI().addToSentMessages(p_175281_1_);
        }

        this.field_146297_k.player.sendChatMessage(p_175281_1_);
    }
        ...
        if (p_73864_3_ == 0)
        {
            for (int i = 0; i < this.field_146292_n.size(); ++i)
            {
                ...
                if (guibutton.func_146116_c(this.field_146297_k, p_73864_1_, p_73864_2_))
                {
                    ...
                    guibutton.func_146113_a(this.field_146297_k.getSoundHandler());
    ...
    public void func_146280_a(Minecraft p_146280_1_, int p_146280_2_, int p_146280_3_)
    {
        ...
        this.field_146296_j = p_146280_1_.getItemRenderer();
    ...
    public void func_146278_c(int p_146278_1_)
    {
        ...
        bufferbuilder.func_181662_b(0.0D, (double)this.field_146295_m, 0.0D).func_187315_a(0.0D, (double)((float)this.field_146295_m / 32.0F + (float)p_146278_1_)).func_181669_b(64, 64, 64, 255).endVertex();
        bufferbuilder.func_181662_b((double)this.field_146294_l, (double)this.field_146295_m, 0.0D).func_187315_a((double)((float)this.field_146294_l / 32.0F), (double)((float)this.field_146295_m / 32.0F + (float)p_146278_1_)).func_181669_b(64, 64, 64, 255).endVertex();
        bufferbuilder.func_181662_b((double)this.field_146294_l, 0.0D, 0.0D).func_187315_a((double)((float)this.field_146294_l / 32.0F), (double)p_146278_1_).func_181669_b(64, 64, 64, 255).endVertex();
        bufferbuilder.func_181662_b(0.0D, 0.0D, 0.0D).func_187315_a(0.0D, (double)p_146278_1_).func_181669_b(64, 64, 64, 255).endVertex();
        tessellator.draw();
    }
