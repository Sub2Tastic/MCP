...
public class TutorialToast implements IToast
{
    ...
    public IToast.Visibility draw(GuiToast toastGui, long delta)
    {
        ...
        toastGui.func_73729_b(0, 0, 0, 96, 160, 32);
        this.icon.draw(toastGui, 6, 6);

        if (this.subtitle == null)
        {
            toastGui.getMinecraft().fontRenderer.func_78276_b(this.title, 30, 12, -11534256);
        }
        else
        {
            toastGui.getMinecraft().fontRenderer.func_78276_b(this.title, 30, 7, -11534256);
            toastGui.getMinecraft().fontRenderer.func_78276_b(this.subtitle, 30, 18, -16777216);
        }
    ...
    public static enum Icons
    {
        ...
        public void draw(Gui guiIn, int x, int y)
        {
            ...
            guiIn.func_73729_b(x, y, 176 + this.column * 20, this.row * 20, 20, 20);
            GlStateManager.func_179147_l();
        }
    }
}
