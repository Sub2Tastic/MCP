...
public class GuiSnooper extends GuiScreen
{
    ...
    public void func_73866_w_()
    {
        ...
        for (String s1 : this.field_146289_q.listFormattedStringToWidth(s, this.field_146294_l - 30))
        {
            list.add(s1);
        }
        ...
        this.field_146292_n.add(new GuiButton(2, this.field_146294_l / 2 + 2, this.field_146295_m - 30, 150, 20, I18n.format("gui.done")));
        boolean flag = this.field_146297_k.getIntegratedServer() != null && this.field_146297_k.getIntegratedServer().getSnooper() != null;

        for (Entry<String, String> entry : (new TreeMap<String, String>(this.field_146297_k.getSnooper().func_76465_c())).entrySet())
        {
            this.field_146604_g.add((flag ? "C " : "") + (String)entry.getKey());
            this.field_146609_h.add(this.field_146289_q.trimStringToWidth(entry.getValue(), this.field_146294_l - 220));
        }

        if (flag)
        {
            for (Entry<String, String> entry1 : (new TreeMap<String, String>(this.field_146297_k.getIntegratedServer().getSnooper().func_76465_c())).entrySet())
            {
                this.field_146604_g.add("S " + (String)entry1.getKey());
                this.field_146609_h.add(this.field_146289_q.trimStringToWidth(entry1.getValue(), this.field_146294_l - 220));
            }
        }
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        if (p_146284_1_.field_146124_l)
        {
            if (p_146284_1_.field_146127_k == 2)
            {
                ...
                this.field_146603_f.saveOptions();
                this.field_146297_k.displayGuiScreen(this.field_146608_a);
            }
