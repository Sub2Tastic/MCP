...
public class SystemToast implements IToast
{
    ...
    public IToast.Visibility draw(GuiToast toastGui, long delta)
    {
        ...
        {
            toastGui.getMinecraft().fontRenderer.func_78276_b(this.title, 18, 12, -256);
        }
        else
        {
            toastGui.getMinecraft().fontRenderer.func_78276_b(this.title, 18, 7, -256);
            toastGui.getMinecraft().fontRenderer.func_78276_b(this.subtitle, 18, 18, -1);
        }
