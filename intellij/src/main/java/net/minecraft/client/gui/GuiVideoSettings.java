...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public GuiVideoSettings(GuiScreen parentScreenIn, GameSettings gameSettingsIn)
    {
        ...
        this.field_146499_g = gameSettingsIn;
    }
    ...
    public void func_73866_w_()
    {
        ...
        this.field_146292_n.add(new GuiButton(200, this.field_146294_l / 2 - 100, this.field_146295_m - 27, I18n.format("gui.done")));

        if (OpenGlHelper.field_176083_O)
        {
            this.optionsRowList = new GuiOptionsRowList(this.field_146297_k, this.field_146294_l, this.field_146295_m, 32, this.field_146295_m - 32, 25, field_146502_i);
        }
        else
        {
            ...
            this.optionsRowList = new GuiOptionsRowList(this.field_146297_k, this.field_146294_l, this.field_146295_m, 32, this.field_146295_m - 32, 25, agamesettings$options);
        }
    }
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        if (p_146284_1_.field_146124_l)
        {
            ...
            {
                this.field_146297_k.gameSettings.saveOptions();
                this.field_146297_k.displayGuiScreen(this.field_146498_f);
            }
        }
    }
    ...
    {
        this.func_146276_q_();
        this.optionsRowList.func_148128_a(p_73863_1_, p_73863_2_, p_73863_3_);
