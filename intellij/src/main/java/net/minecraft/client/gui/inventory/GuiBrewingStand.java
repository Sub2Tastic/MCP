...
public class GuiBrewingStand extends GuiContainer
{
    ...
    {
        String s = this.field_147013_v.getDisplayName().func_150260_c();
        this.field_146289_q.func_78276_b(s, this.xSize / 2 - this.field_146289_q.getStringWidth(s) / 2, 6, 4210752);
        this.field_146289_q.func_78276_b(this.field_175384_v.getDisplayName().func_150260_c(), 8, this.ySize - 96 + 2, 4210752);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.field_146297_k.getTextureManager().bindTexture(BREWING_STAND_GUI_TEXTURES);
