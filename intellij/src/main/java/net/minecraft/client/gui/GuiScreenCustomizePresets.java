...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void func_73866_w_()
    {
        ...
        this.field_175316_h = this.func_189646_b(new GuiButton(0, this.field_146294_l / 2 - 102, this.field_146295_m - 27, 100, 20, I18n.format("createWorld.customize.presets.select")));
        this.field_146292_n.add(new GuiButton(1, this.field_146294_l / 2 + 3, this.field_146295_m - 27, 100, 20, I18n.format("gui.cancel")));
        this.func_175304_a();
    }
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        switch (p_146284_1_.field_146127_k)
        {
            case 0:
                ...
                this.field_146297_k.displayGuiScreen(this.field_175314_r);
                break;
    ...
    class ListPreset extends GuiSlot
    {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_)
        {
            ...
            this.field_148161_k.getTextureManager().bindTexture(p_178051_3_);
            int j = 32;
            int k = 32;
            Tessellator tessellator = Tessellator.getInstance();
            BufferBuilder bufferbuilder = tessellator.getBuffer();
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
            bufferbuilder.func_181662_b((double)(i + 0), (double)(p_178051_2_ + 32), 0.0D).func_187315_a(0.0D, 1.0D).endVertex();
            bufferbuilder.func_181662_b((double)(i + 32), (double)(p_178051_2_ + 32), 0.0D).func_187315_a(1.0D, 1.0D).endVertex();
            bufferbuilder.func_181662_b((double)(i + 32), (double)(p_178051_2_ + 0), 0.0D).func_187315_a(1.0D, 0.0D).endVertex();
            bufferbuilder.func_181662_b((double)(i + 0), (double)(p_178051_2_ + 0), 0.0D).func_187315_a(0.0D, 0.0D).endVertex();
            tessellator.draw();
        }
