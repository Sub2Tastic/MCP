    ...
    public void func_184068_a(ScaledResolution p_184068_1_)
    {
        ...
        if (this.enabled && !this.subtitles.isEmpty())
        {
            ...
            for (GuiSubtitleOverlay.Subtitle guisubtitleoverlay$subtitle1 : this.subtitles)
            {
                ...
                int l1 = MathHelper.floor(MathHelper.clampedLerp(255.0D, 75.0D, (double)((float)(Minecraft.func_71386_F() - guisubtitleoverlay$subtitle1.getStartTime()) / 3000.0F)));
                ...
                if (!flag)
                {
                    if (d0 > 0.0D)
                    {
                        this.client.fontRenderer.func_78276_b(">", l - this.client.fontRenderer.getStringWidth(">"), -j1, i2 + -16777216);
                    }
                    else if (d0 < 0.0D)
                    {
                        this.client.fontRenderer.func_78276_b("<", -l, -j1, i2 + -16777216);
                    }
                }

                this.client.fontRenderer.func_78276_b(s, -k1 / 2, -j1, i2 + -16777216);
