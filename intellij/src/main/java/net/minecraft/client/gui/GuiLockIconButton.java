...
public class GuiLockIconButton extends GuiButton
{
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_)
    {
        ...
        {
            p_191745_1_.getTextureManager().bindTexture(GuiButton.field_146122_a);
            ...
            this.func_73729_b(this.field_146128_h, this.field_146129_i, guilockiconbutton$icon.getX(), guilockiconbutton$icon.getY(), this.field_146120_f, this.field_146121_g);
        }
    }
