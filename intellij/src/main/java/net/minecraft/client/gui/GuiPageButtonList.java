...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    public boolean func_148179_a(int p_148179_1_, int p_148179_2_, int p_148179_3_)
    {
        ...
        if (i >= 0)
        {
            ...
            {
                ((GuiTextField)this.field_178075_A).setFocused2(false);
            }
    ...
    {
        GuiTextField guitextfield = new GuiTextField(p_178068_3_.func_178935_b(), this.field_148161_k.fontRenderer, p_178068_1_, p_178068_2_, 150, 20);
    ...
    private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_)
    {
        ...
        if (p_178063_4_)
        {
            guilabel = new GuiLabel(this.field_148161_k.fontRenderer, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.field_148155_a - p_178063_1_ * 2, 20, -1);
        }
        else
        {
            guilabel = new GuiLabel(this.field_148161_k.fontRenderer, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
        }
