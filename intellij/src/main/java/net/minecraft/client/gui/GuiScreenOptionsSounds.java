...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    public GuiScreenOptionsSounds(GuiScreen parentIn, GameSettings settingsIn)
    {
        ...
        this.field_146506_g = settingsIn;
    }
    ...
    protected void func_146284_a(GuiButton p_146284_1_) throws IOException
    {
        if (p_146284_1_.field_146124_l)
        {
            ...
            {
                this.field_146297_k.gameSettings.saveOptions();
                this.field_146297_k.displayGuiScreen(this.field_146505_f);
            }
            else if (p_146284_1_.field_146127_k == 201)
            {
                this.field_146297_k.gameSettings.func_74306_a(GameSettings.Options.SHOW_SUBTITLES, 1);
                p_146284_1_.field_146126_j = this.field_146297_k.gameSettings.func_74297_c(GameSettings.Options.SHOW_SUBTITLES);
                this.field_146297_k.gameSettings.saveOptions();
            }
        }
    }
    ...
    {
        float f = this.field_146506_g.getSoundLevel(p_184097_1_);
    ...
    class Button extends GuiButton
    {
        ...
        public Button(int p_i46744_2_, int p_i46744_3_, int p_i46744_4_, SoundCategory p_i46744_5_, boolean p_i46744_6_)
        {
            ...
            this.field_146152_s = I18n.format("soundCategory." + p_i46744_5_.getName());
            this.field_146126_j = this.field_146152_s + ": " + GuiScreenOptionsSounds.this.func_184097_a(p_i46744_5_);
            this.field_146156_o = GuiScreenOptionsSounds.this.field_146506_g.getSoundLevel(p_i46744_5_);
        }
        ...
        protected void func_146119_b(Minecraft p_146119_1_, int p_146119_2_, int p_146119_3_)
        {
            if (this.field_146125_m)
            {
                if (this.field_146155_p)
                {
                    ...
                    this.field_146156_o = MathHelper.clamp(this.field_146156_o, 0.0F, 1.0F);
                    p_146119_1_.gameSettings.setSoundLevel(this.field_184063_r, this.field_146156_o);
        ...
        public boolean func_146116_c(Minecraft p_146116_1_, int p_146116_2_, int p_146116_3_)
        {
            if (super.func_146116_c(p_146116_1_, p_146116_2_, p_146116_3_))
            {
                ...
                this.field_146156_o = MathHelper.clamp(this.field_146156_o, 0.0F, 1.0F);
                p_146116_1_.gameSettings.setSoundLevel(this.field_184063_r, this.field_146156_o);
        ...
        public void func_146118_a(int p_146118_1_, int p_146118_2_)
        {
            if (this.field_146155_p)
            {
                GuiScreenOptionsSounds.this.field_146297_k.getSoundHandler().play(PositionedSoundRecord.master(SoundEvents.UI_BUTTON_CLICK, 1.0F));
            }
