...
public class ParticleRain extends Particle
{
    protected ParticleRain(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn)
    {
        ...
        this.func_70536_a(19 + this.rand.nextInt(4));
    ...
    public void tick()
    {
        ...
        if (material.isLiquid() || material.isSolid())
        {
            ...
            {
                d0 = (double)(1.0F - BlockLiquid.func_149801_b(((Integer)iblockstate.get(BlockLiquid.LEVEL)).intValue()));
            }
            else
            {
                d0 = iblockstate.func_185900_c(this.world, blockpos).maxY;
            }
