...
public class ParticleFootStep extends Particle
{
    ...
    public void func_180434_a(BufferBuilder p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
    {
        ...
        float f2 = 0.125F;
        float f3 = (float)(this.posX - field_70556_an);
        float f4 = (float)(this.posY - field_70554_ao);
        float f5 = (float)(this.posZ - field_70555_ap);
        ...
        p_180434_1_.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        p_180434_1_.func_181662_b((double)(f3 - 0.125F), (double)f4, (double)(f5 + 0.125F)).func_187315_a(0.0D, 1.0D).func_181666_a(f6, f6, f6, f1).endVertex();
        p_180434_1_.func_181662_b((double)(f3 + 0.125F), (double)f4, (double)(f5 + 0.125F)).func_187315_a(1.0D, 1.0D).func_181666_a(f6, f6, f6, f1).endVertex();
        p_180434_1_.func_181662_b((double)(f3 + 0.125F), (double)f4, (double)(f5 - 0.125F)).func_187315_a(1.0D, 0.0D).func_181666_a(f6, f6, f6, f1).endVertex();
        p_180434_1_.func_181662_b((double)(f3 - 0.125F), (double)f4, (double)(f5 - 0.125F)).func_187315_a(0.0D, 0.0D).func_181666_a(f6, f6, f6, f1).endVertex();
