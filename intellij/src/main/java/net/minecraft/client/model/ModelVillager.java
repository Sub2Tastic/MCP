...
public class ModelVillager extends ModelBase
{
    ...
    public ModelVillager(float p_i1164_1_, float p_i1164_2_, int p_i1164_3_, int p_i1164_4_)
    {
        ...
        this.villagerHead.setTextureOffset(0, 0).func_78790_a(-4.0F, -10.0F, -4.0F, 8, 10, 8, p_i1164_1_);
        ...
        this.villagerNose.setTextureOffset(24, 0).func_78790_a(-1.0F, -1.0F, -6.0F, 2, 4, 2, p_i1164_1_);
        ...
        this.villagerBody.setTextureOffset(16, 20).func_78790_a(-4.0F, 0.0F, -3.0F, 8, 12, 6, p_i1164_1_);
        this.villagerBody.setTextureOffset(0, 38).func_78790_a(-4.0F, 0.0F, -3.0F, 8, 18, 6, p_i1164_1_ + 0.5F);
        ...
        this.villagerArms.setTextureOffset(44, 22).func_78790_a(-8.0F, -2.0F, -2.0F, 4, 8, 4, p_i1164_1_);
        this.villagerArms.setTextureOffset(44, 22).func_78790_a(4.0F, -2.0F, -2.0F, 4, 8, 4, p_i1164_1_);
        this.villagerArms.setTextureOffset(40, 38).func_78790_a(-4.0F, 2.0F, -2.0F, 8, 4, 4, p_i1164_1_);
        ...
        this.rightVillagerLeg.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i1164_1_);
        ...
        this.leftVillagerLeg.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i1164_1_);
    }

    public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        this.func_78087_a(p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, p_78088_7_, p_78088_1_);
        this.villagerHead.func_78785_a(p_78088_7_);
        this.villagerBody.func_78785_a(p_78088_7_);
        this.rightVillagerLeg.func_78785_a(p_78088_7_);
        this.leftVillagerLeg.func_78785_a(p_78088_7_);
        this.villagerArms.func_78785_a(p_78088_7_);
    }

    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        this.villagerHead.rotateAngleY = p_78087_4_ * 0.017453292F;
        this.villagerHead.rotateAngleX = p_78087_5_ * 0.017453292F;
