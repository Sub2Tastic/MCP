...
public class ModelEnderCrystal extends ModelBase
{
    ...
    {
        this.field_78228_b.setTextureOffset(0, 0).func_78789_a(-4.0F, -4.0F, -4.0F, 8, 8, 8);
        this.field_78230_a = new ModelRenderer(this, "cube");
        this.field_78230_a.setTextureOffset(32, 0).func_78789_a(-4.0F, -4.0F, -4.0F, 8, 8, 8);

        if (p_i1170_2_)
        {
            this.field_78229_c = new ModelRenderer(this, "base");
            this.field_78229_c.setTextureOffset(0, 16).func_78789_a(-6.0F, 0.0F, -6.0F, 12, 4, 12);
        }
    }
