...
public class ModelWither extends ModelBase
{
    ...
    public ModelWither(float p_i46302_1_)
    {
        ...
        this.upperBodyParts[1].setTextureOffset(0, 22).func_78790_a(0.0F, 0.0F, 0.0F, 3, 10, 3, p_i46302_1_);
        this.upperBodyParts[1].setTextureOffset(24, 22).func_78790_a(-4.0F, 1.5F, 0.5F, 11, 2, 2, p_i46302_1_);
        this.upperBodyParts[1].setTextureOffset(24, 22).func_78790_a(-4.0F, 4.0F, 0.5F, 11, 2, 2, p_i46302_1_);
        this.upperBodyParts[1].setTextureOffset(24, 22).func_78790_a(-4.0F, 6.5F, 0.5F, 11, 2, 2, p_i46302_1_);
        ...
        this.heads[0].func_78790_a(-4.0F, -4.0F, -4.0F, 8, 8, 8, p_i46302_1_);
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.heads[0].rotateAngleY = p_78087_4_ * 0.017453292F;
        this.heads[0].rotateAngleX = p_78087_5_ * 0.017453292F;
    }
    ...
    public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        for (int i = 1; i < 3; ++i)
        {
            this.heads[i].rotateAngleY = (entitywither.getHeadYRotation(i - 1) - p_78086_1_.renderYawOffset) * 0.017453292F;
