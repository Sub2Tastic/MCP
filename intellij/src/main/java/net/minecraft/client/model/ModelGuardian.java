...
public class ModelGuardian extends ModelBase
{
    ...
    public ModelGuardian()
    {
        ...
        this.guardianBody.setTextureOffset(0, 0).func_78789_a(-6.0F, 10.0F, -8.0F, 12, 12, 16);
        this.guardianBody.setTextureOffset(0, 28).func_78789_a(-8.0F, 10.0F, -6.0F, 2, 12, 12);
        this.guardianBody.setTextureOffset(0, 28).func_178769_a(6.0F, 10.0F, -6.0F, 2, 12, 12, true);
        this.guardianBody.setTextureOffset(16, 40).func_78789_a(-6.0F, 8.0F, -6.0F, 12, 2, 12);
        this.guardianBody.setTextureOffset(16, 40).func_78789_a(-6.0F, 22.0F, -6.0F, 12, 2, 12);
        ...
        this.guardianTail[2].setTextureOffset(41, 32).func_78789_a(0.0F, 14.0F, 0.0F, 2, 2, 6);
        this.guardianTail[2].setTextureOffset(25, 19).func_78789_a(1.0F, 10.5F, 3.0F, 1, 9, 9);
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.guardianBody.rotateAngleY = p_78087_4_ * 0.017453292F;
        this.guardianBody.rotateAngleX = p_78087_5_ * 0.017453292F;
