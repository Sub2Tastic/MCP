...
public class ModelShulker extends ModelBase
{
    ...
    public ModelShulker()
    {
        ...
        this.lid.setTextureOffset(0, 0).func_78789_a(-8.0F, -16.0F, -8.0F, 16, 12, 16);
        this.lid.setRotationPoint(0.0F, 24.0F, 0.0F);
        this.base.setTextureOffset(0, 28).func_78789_a(-8.0F, -8.0F, -8.0F, 16, 8, 16);
        this.base.setRotationPoint(0.0F, 24.0F, 0.0F);
        this.head.setTextureOffset(0, 52).func_78789_a(-3.0F, 0.0F, -3.0F, 6, 6, 6);
    ...
    public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        ...
        this.lid.func_78785_a(p_78088_7_);
    }
}
