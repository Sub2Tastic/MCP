...
public class ModelIronGolem extends ModelBase
{
    ...
    public ModelIronGolem(float p_i46362_1_, float p_i46362_2_)
    {
        ...
        this.ironGolemHead.setTextureOffset(0, 0).func_78790_a(-4.0F, -12.0F, -5.5F, 8, 10, 8, p_i46362_1_);
        this.ironGolemHead.setTextureOffset(24, 0).func_78790_a(-1.0F, -5.0F, -7.5F, 2, 4, 2, p_i46362_1_);
        ...
        this.ironGolemBody.setTextureOffset(0, 40).func_78790_a(-9.0F, -2.0F, -6.0F, 18, 12, 11, p_i46362_1_);
        this.ironGolemBody.setTextureOffset(0, 70).func_78790_a(-4.5F, 10.0F, -3.0F, 9, 5, 6, p_i46362_1_ + 0.5F);
        this.ironGolemRightArm = (new ModelRenderer(this)).setTextureSize(128, 128);
        this.ironGolemRightArm.setRotationPoint(0.0F, -7.0F, 0.0F);
        this.ironGolemRightArm.setTextureOffset(60, 21).func_78790_a(-13.0F, -2.5F, -3.0F, 4, 30, 6, p_i46362_1_);
        this.ironGolemLeftArm = (new ModelRenderer(this)).setTextureSize(128, 128);
        this.ironGolemLeftArm.setRotationPoint(0.0F, -7.0F, 0.0F);
        this.ironGolemLeftArm.setTextureOffset(60, 58).func_78790_a(9.0F, -2.5F, -3.0F, 4, 30, 6, p_i46362_1_);
        ...
        this.ironGolemLeftLeg.setTextureOffset(37, 0).func_78790_a(-3.5F, -3.0F, -3.0F, 6, 16, 5, p_i46362_1_);
    ...
    {
        this.ironGolemHead.rotateAngleY = p_78087_4_ * 0.017453292F;
        this.ironGolemHead.rotateAngleX = p_78087_5_ * 0.017453292F;
        this.ironGolemLeftLeg.rotateAngleX = -1.5F * this.triangleWave(p_78087_1_, 13.0F) * p_78087_2_;
        this.ironGolemRightLeg.rotateAngleX = 1.5F * this.triangleWave(p_78087_1_, 13.0F) * p_78087_2_;
    ...
    public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        if (i > 0)
        {
            this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * this.triangleWave((float)i - p_78086_4_, 10.0F);
            this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * this.triangleWave((float)i - p_78086_4_, 10.0F);
        }
        else
        {
