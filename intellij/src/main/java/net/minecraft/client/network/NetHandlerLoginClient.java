...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void handleEncryptionRequest(SPacketEncryptionRequest packetIn)
    {
        ...
        this.networkManager.func_179288_a(new CPacketEncryptionResponse(secretkey, publickey, packetIn.getVerifyToken()), new GenericFutureListener < Future <? super Void >> ()
        {
    ...
    public void onDisconnect(ITextComponent reason)
    {
        ...
        {
            this.mc.displayGuiScreen((new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.previousGuiScreen).func_154321_a(), "connect.failed", reason)).getProxy());
        }
        else
        {
