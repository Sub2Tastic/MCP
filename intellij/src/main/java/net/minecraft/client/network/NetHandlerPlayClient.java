...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.client);
    ...
    public void handleChunkData(SPacketChunkData packetIn)
    {
        ...
        {
            this.world.func_73025_a(packetIn.getChunkX(), packetIn.getChunkZ(), true);
        }
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.client);
        this.world.func_73025_a(packetIn.getX(), packetIn.getZ(), false);
    }
    ...
    public void onDisconnect(ITextComponent reason)
    {
        ...
        if (this.guiScreenServer != null)
        {
            ...
            {
                this.client.displayGuiScreen((new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.guiScreenServer).func_154321_a(), "disconnect.lost", reason)).getProxy());
            }
            else
            {
    ...
    {
        PacketThreadUtil.func_180031_a(p_147278_1_, this, this.client);
        ...
        else
        {
            ...
            for (int i : packetIn.getPassengerIds())
            {
                ...
                if (entity1 != null)
                {
                    ...
                    {
                        this.client.ingameGUI.setOverlayMessage(I18n.format("mount.onboard", GameSettings.func_74298_c(this.client.gameSettings.field_74311_E.func_151463_i())), false);
                    }
                }
            }
        }
    ...
    public void handleEntityStatus(SPacketEntityStatus packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                int i = 40;
                this.client.particles.func_191271_a(entity, EnumParticleTypes.TOTEM, 30);
    ...
    {
        PacketThreadUtil.func_180031_a(p_147265_1_, this, this.client);
        ...
        else if ("EntityHorse".equals(p_147265_1_.func_148902_e()))
        {
            ...
            {
                entityplayersp.openHorseInventory((AbstractHorse)entity, new ContainerHorseChest(p_147265_1_.func_179840_c(), p_147265_1_.func_148898_f()));
                entityplayersp.openContainer.windowId = p_147265_1_.func_148901_c();
            }
        }
    ...
    public void handleMaps(SPacketMaps packetIn)
    {
        ...
        MapData mapdata = ItemMap.func_150912_a(packetIn.getMapId(), this.client.world);
        ...
        if (mapdata == null)
        {
            ...
            this.client.world.func_72823_a(s, mapdata);
        }
    ...
    public void handleStatistics(SPacketStatistics packetIn)
    {
        ...
        for (Entry<StatBase, Integer> entry : packetIn.getStatisticMap().entrySet())
        {
            ...
            this.client.player.getStats().setValue(this.client.player, statbase, k);
        }
    ...
    public void handleRecipeBook(SPacketRecipeBook packetIn)
    {
        ...
        PacketThreadUtil.func_180031_a(packetIn, this, this.client);
        recipebook = this.client.player.func_192035_E();
    ...
    {
        PacketThreadUtil.func_180031_a(p_147274_1_, this, this.client);
    ...
    {
        PacketThreadUtil.func_180031_a(packetIn, this, this.client);
        this.client.getSoundHandler().play(new PositionedSoundRecord(new ResourceLocation(packetIn.func_186930_a()), packetIn.getCategory(), packetIn.getVolume(), packetIn.getPitch(), false, 0, ISound.AttenuationType.LINEAR, (float)packetIn.getX(), (float)packetIn.getY(), (float)packetIn.getZ()));
    }
    ...
    public void handleResourcePack(SPacketResourcePackSend packetIn)
    {
        ...
        if (this.validateResourcePackUrl(s))
        {
            if (s.startsWith("level://"))
            {
                try
                {
                    ...
                    if (file2.isFile())
                    {
                        ...
                        Futures.addCallback(this.client.func_110438_M().func_177319_a(file2), this.func_189686_f());
                        return;
                    }
                }
            ...
            else
            {
                ...
                {
                    this.netManager.sendPacket(new CPacketResourcePackStatus(CPacketResourcePackStatus.Action.ACCEPTED));
                    Futures.addCallback(this.client.func_110438_M().func_180601_a(s, s1), this.func_189686_f());
                }
                ...
                {
                    this.client.func_152344_a(new Runnable()
                    {
                        public void run()
                        {
                            NetHandlerPlayClient.this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                            {
                                public void func_73878_a(boolean p_73878_1_, int p_73878_2_)
                                {
                                    ...
                                    if (p_73878_1_)
                                    {
                                        ...
                                        Futures.addCallback(NetHandlerPlayClient.this.client.func_110438_M().func_180601_a(s, s1), NetHandlerPlayClient.this.func_189686_f());
                                    }
                                    else
                                    {
                                        if (serverdata1 != null)
    ...
    public void handleParticles(SPacketParticles packetIn)
    {
        ...
        if (packetIn.getParticleCount() == 0)
        {
            ...
            {
                LOGGER.warn("Could not spawn particle effect {}", (Object)packetIn.func_179749_a());
            }
        }
        else
        {
    ...
    public void handlePlaceGhostRecipe(SPacketPlaceGhostRecipe packetIn)
    {
        ...
        if (container.windowId == packetIn.getWindowId() && container.getCanCraft(this.client.player))
        {
            if (this.client.currentScreen instanceof IRecipeShownListener)
            {
                GuiRecipeBook guirecipebook = ((IRecipeShownListener)this.client.currentScreen).getRecipeGui();
                guirecipebook.setupGhostRecipe(packetIn.func_194311_a(), container.inventorySlots);
            }
        }
    }
