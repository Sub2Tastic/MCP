            ...
            if (!this.playerTexturesLoaded)
            {
                ...
                Minecraft.getInstance().getSkinManager().loadProfileTextures(this.gameProfile, new SkinManager.SkinAvailableCallback()
                {
                    public void func_180521_a(Type p_180521_1_, ResourceLocation p_180521_2_, MinecraftProfileTexture p_180521_3_)
                    {
                        ...
                        {
                            case SKIN:
                                NetworkPlayerInfo.this.playerTextures.put(Type.SKIN, p_180521_2_);
                            ...
                            case CAPE:
                                NetworkPlayerInfo.this.playerTextures.put(Type.CAPE, p_180521_2_);
                                break;

                            case ELYTRA:
                                NetworkPlayerInfo.this.playerTextures.put(Type.ELYTRA, p_180521_2_);
                        }
                    }
                }, true);
            }
