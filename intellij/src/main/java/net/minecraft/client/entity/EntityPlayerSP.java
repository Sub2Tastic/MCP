...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void tick()
    {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            if (this.isPassenger())
            {
                ...
                this.connection.sendPacket(new CPacketInput(this.moveStrafing, this.moveForward, this.movementInput.jump, this.movementInput.field_78899_d));
    ...
    {
        this.mc.particles.func_178926_a(entityHit, EnumParticleTypes.CRIT);
    }

    public void onEnchantmentCritical(Entity entityHit)
    {
        this.mc.particles.func_178926_a(entityHit, EnumParticleTypes.CRIT_MAGIC);
    }

    public boolean func_70093_af()
    {
        boolean flag = this.movementInput != null && this.movementInput.field_78899_d;
    ...
    public void livingTick()
    {
        ...
        if (this.inPortal)
        {
            if (this.mc.currentScreen != null && !this.mc.currentScreen.func_73868_f())
            {
            ...
            {
                this.mc.getSoundHandler().play(PositionedSoundRecord.master(SoundEvents.BLOCK_PORTAL_TRIGGER, this.rand.nextFloat() * 0.4F + 0.8F));
            }
