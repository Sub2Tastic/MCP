...
{
    private static final Set<Block> TREE_BLOCKS = Sets.newHashSet(Blocks.field_150364_r, Blocks.field_150363_s, Blocks.field_150362_t, Blocks.field_150361_u);
    ...
    {
        if (result.field_72313_a == RayTraceResult.Type.BLOCK && result.func_178782_a() != null)
        {
            IBlockState iblockstate = worldIn.getBlockState(result.func_178782_a());
