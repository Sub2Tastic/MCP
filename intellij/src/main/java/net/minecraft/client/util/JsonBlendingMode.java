...
public class JsonBlendingMode
{
    ...
    public void apply()
    {
        if (!this.equals(lastApplied))
        {
            ...
            GlStateManager.func_187398_d(this.blendFunction);

            if (this.separateBlend)
            {
                GlStateManager.func_179120_a(this.srcColorFactor, this.destColorFactor, this.srcAlphaFactor, this.destAlphaFactor);
            }
            else
            {
                GlStateManager.func_179112_b(this.srcColorFactor, this.destColorFactor);
            }
        }
    }
