    ...
    public void setLoadingProgress(int progress)
    {
        ...
        else
        {
            ...
            if (i - this.field_73723_d >= 100L)
            {
                ...
                this.field_73725_b.getTextureManager().bindTexture(Gui.field_110325_k);
                float f = 32.0F;
                bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                bufferbuilder.func_181662_b(0.0D, (double)l, 0.0D).func_187315_a(0.0D, (double)((float)l / 32.0F)).func_181669_b(64, 64, 64, 255).endVertex();
                bufferbuilder.func_181662_b((double)k, (double)l, 0.0D).func_187315_a((double)((float)k / 32.0F), (double)((float)l / 32.0F)).func_181669_b(64, 64, 64, 255).endVertex();
                bufferbuilder.func_181662_b((double)k, 0.0D, 0.0D).func_187315_a((double)((float)k / 32.0F), 0.0D).func_181669_b(64, 64, 64, 255).endVertex();
                bufferbuilder.func_181662_b(0.0D, 0.0D, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(64, 64, 64, 255).endVertex();
                tessellator.draw();
                ...
                if (progress >= 0)
                {
                    ...
                    bufferbuilder.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)k1, (double)(l1 + 2), 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)(k1 + 100), (double)(l1 + 2), 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)(k1 + 100), (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)k1, (double)(l1 + 2), 0.0D).func_181669_b(128, 255, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)(k1 + progress), (double)(l1 + 2), 0.0D).func_181669_b(128, 255, 128, 255).endVertex();
                    bufferbuilder.func_181662_b((double)(k1 + progress), (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).endVertex();
                    tessellator.draw();
