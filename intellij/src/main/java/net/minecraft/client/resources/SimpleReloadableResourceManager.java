...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    {
        IResourceManager iresourcemanager = this.field_110548_a.get(p_110536_1_.getNamespace());
    ...
    {
        IResourceManager iresourcemanager = this.field_110548_a.get(p_135056_1_.getNamespace());
