...
public class MetadataSerializer
{
    ...
    {
        this.field_110508_a.func_82595_a(p_110504_1_.getSectionName(), new MetadataSerializer.Registration(p_110504_1_, p_110504_2_));
    ...
    public <T extends IMetadataSection> T func_110503_a(String p_110503_1_, JsonObject p_110503_2_)
    {
        ...
        {
            MetadataSerializer.Registration<?> registration = (MetadataSerializer.Registration)this.field_110508_a.getOrDefault(p_110503_1_);
