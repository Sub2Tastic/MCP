...
public class Snooper
{
    ...
    public void start()
    {
        if (!this.isRunning)
        {
            ...
            this.timer.schedule(new TimerTask()
            {
                public void run()
                {
                    if (Snooper.this.playerStatsCollector.func_70002_Q())
                    {
                        ...
                        HttpUtil.func_151226_a(Snooper.this.serverUrl, map, true, minecraftserver == null ? null : minecraftserver.func_110454_ao());
                    }
                }
            }, 0L, 900000L);
        }
    ...
    private void func_152766_h()
    {
        ...
        this.playerStatsCollector.func_70001_b(this);
    }
