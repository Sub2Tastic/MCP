...
public abstract class BlockLog extends BlockRotatedPillar
{
    ...
    public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_)
    {
        ...
        {
            for (BlockPos blockpos : BlockPos.func_177980_a(p_180663_2_.add(-4, -4, -4), p_180663_2_.add(4, 4, 4)))
            {
                IBlockState iblockstate = p_180663_1_.getBlockState(blockpos);

                if (iblockstate.getMaterial() == Material.LEAVES && !((Boolean)iblockstate.get(BlockLeaves.field_176236_b)).booleanValue())
                {
                    p_180663_1_.setBlockState(blockpos, iblockstate.func_177226_a(BlockLeaves.field_176236_b, Boolean.valueOf(true)), 4);
                }
            }
        }
    }
