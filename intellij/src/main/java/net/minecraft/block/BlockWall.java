...
public class BlockWall extends Block
{
    ...
    public static final PropertyEnum<BlockWall.EnumType> field_176255_P = PropertyEnum.<BlockWall.EnumType>create("variant", BlockWall.EnumType.class);
    ...
    {
        super(p_i45435_1_.material);
        this.setDefaultState(this.stateContainer.getBaseState().func_177226_a(UP, Boolean.valueOf(false)).func_177226_a(field_176254_b, Boolean.valueOf(false)).func_177226_a(field_176257_M, Boolean.valueOf(false)).func_177226_a(field_176258_N, Boolean.valueOf(false)).func_177226_a(field_176259_O, Boolean.valueOf(false)).func_177226_a(field_176255_P, BlockWall.EnumType.NORMAL));
        this.func_149711_c(p_i45435_1_.blockHardness);
        this.func_149752_b(p_i45435_1_.blockResistance / 3.0F);
        this.func_149672_a(p_i45435_1_.soundType);
    ...
    private static int func_185749_i(IBlockState p_185749_0_)
    {
        ...
        if (((Boolean)p_185749_0_.get(field_176254_b)).booleanValue())
        {
            i |= 1 << EnumFacing.NORTH.getHorizontalIndex();
        }

        if (((Boolean)p_185749_0_.get(field_176257_M)).booleanValue())
        {
            i |= 1 << EnumFacing.EAST.getHorizontalIndex();
        }

        if (((Boolean)p_185749_0_.get(field_176258_N)).booleanValue())
        {
            i |= 1 << EnumFacing.SOUTH.getHorizontalIndex();
        }

        if (((Boolean)p_185749_0_.get(field_176259_O)).booleanValue())
        {
    ...
    {
        return I18n.func_74838_a(this.getTranslationKey() + "." + BlockWall.EnumType.NORMAL.func_176659_c() + ".name");
    }
    ...
    {
        IBlockState iblockstate = p_176253_1_.getBlockState(p_176253_2_);
    ...
    {
        return Block.func_193382_c(p_194143_0_) || p_194143_0_ == Blocks.BARRIER || p_194143_0_ == Blocks.MELON || p_194143_0_ == Blocks.PUMPKIN || p_194143_0_ == Blocks.field_150428_aP;
    }
    ...
    public void fillItemGroup(CreativeTabs group, NonNullList<ItemStack> items)
    {
        ...
        {
            items.add(new ItemStack(this, 1, blockwall$enumtype.func_176657_a()));
        }
    }

    public int func_180651_a(IBlockState p_180651_1_)
    {
        return ((BlockWall.EnumType)p_180651_1_.get(field_176255_P)).func_176657_a();
    }
    ...
    {
        return p_176225_4_ == EnumFacing.DOWN ? super.shouldSideBeRendered(blockState, blockAccess, pos, p_176225_4_) : true;
    }

    public IBlockState func_176203_a(int p_176203_1_)
    {
        return this.getDefaultState().func_177226_a(field_176255_P, BlockWall.EnumType.func_176660_a(p_176203_1_));
    }

    public int func_176201_c(IBlockState p_176201_1_)
    {
        return ((BlockWall.EnumType)p_176201_1_.get(field_176255_P)).func_176657_a();
    }

    public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_)
    {
        boolean flag = this.func_176253_e(p_176221_2_, p_176221_3_.north(), EnumFacing.SOUTH);
        boolean flag1 = this.func_176253_e(p_176221_2_, p_176221_3_.east(), EnumFacing.WEST);
        boolean flag2 = this.func_176253_e(p_176221_2_, p_176221_3_.south(), EnumFacing.NORTH);
        boolean flag3 = this.func_176253_e(p_176221_2_, p_176221_3_.west(), EnumFacing.EAST);
        boolean flag4 = flag && !flag1 && flag2 && !flag3 || !flag && flag1 && !flag2 && flag3;
        return p_176221_1_.func_177226_a(UP, Boolean.valueOf(!flag4 || !p_176221_2_.isAirBlock(p_176221_3_.up()))).func_177226_a(field_176254_b, Boolean.valueOf(flag)).func_177226_a(field_176257_M, Boolean.valueOf(flag1)).func_177226_a(field_176258_N, Boolean.valueOf(flag2)).func_177226_a(field_176259_O, Boolean.valueOf(flag3));
    }

    protected BlockStateContainer func_180661_e()
    {
        return new BlockStateContainer(this, new IProperty[] {UP, field_176254_b, field_176257_M, field_176259_O, field_176258_N, field_176255_P});
    }
