...
{
    public static final PropertyEnum<BlockStoneBrick.EnumType> field_176249_a = PropertyEnum.<BlockStoneBrick.EnumType>create("variant", BlockStoneBrick.EnumType.class);
    ...
    {
        super(Material.ROCK);
        this.setDefaultState(this.stateContainer.getBaseState().func_177226_a(field_176249_a, BlockStoneBrick.EnumType.DEFAULT));
        this.func_149647_a(CreativeTabs.BUILDING_BLOCKS);
    }

    public int func_180651_a(IBlockState p_180651_1_)
    {
        return ((BlockStoneBrick.EnumType)p_180651_1_.get(field_176249_a)).func_176612_a();
    }
    ...
    public void fillItemGroup(CreativeTabs group, NonNullList<ItemStack> items)
    {
        ...
        {
            items.add(new ItemStack(this, 1, blockstonebrick$enumtype.func_176612_a()));
        }
    }

    public IBlockState func_176203_a(int p_176203_1_)
    {
        return this.getDefaultState().func_177226_a(field_176249_a, BlockStoneBrick.EnumType.func_176613_a(p_176203_1_));
    }

    public int func_176201_c(IBlockState p_176201_1_)
    {
        return ((BlockStoneBrick.EnumType)p_176201_1_.get(field_176249_a)).func_176612_a();
    }
