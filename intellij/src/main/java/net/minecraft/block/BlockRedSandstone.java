...
{
    public static final PropertyEnum<BlockRedSandstone.EnumType> field_176336_a = PropertyEnum.<BlockRedSandstone.EnumType>create("type", BlockRedSandstone.EnumType.class);

    public BlockRedSandstone()
    {
        super(Material.ROCK, BlockSand.EnumType.RED_SAND.func_176687_c());
        this.setDefaultState(this.stateContainer.getBaseState().func_177226_a(field_176336_a, BlockRedSandstone.EnumType.DEFAULT));
        this.func_149647_a(CreativeTabs.BUILDING_BLOCKS);
    }

    public int func_180651_a(IBlockState p_180651_1_)
    {
        return ((BlockRedSandstone.EnumType)p_180651_1_.get(field_176336_a)).func_176827_a();
    }
    ...
    public void fillItemGroup(CreativeTabs group, NonNullList<ItemStack> items)
    {
        ...
        {
            items.add(new ItemStack(this, 1, blockredsandstone$enumtype.func_176827_a()));
        }
    }

    public IBlockState func_176203_a(int p_176203_1_)
    {
        return this.getDefaultState().func_177226_a(field_176336_a, BlockRedSandstone.EnumType.func_176825_a(p_176203_1_));
    }

    public int func_176201_c(IBlockState p_176201_1_)
    {
        return ((BlockRedSandstone.EnumType)p_176201_1_.get(field_176336_a)).func_176827_a();
    }
