...
public abstract class BlockSlab extends Block
{
    ...
    {
        return ((BlockSlab)p_185481_1_.getBlock()).func_176552_j() || p_185481_1_.get(field_176554_a) == BlockSlab.EnumBlockHalf.TOP;
    }

    public BlockFaceShape func_193383_a(IBlockAccess p_193383_1_, IBlockState p_193383_2_, BlockPos p_193383_3_, EnumFacing p_193383_4_)
    {
        if (((BlockSlab)p_193383_2_.getBlock()).func_176552_j())
        {
            return BlockFaceShape.SOLID;
        }
        else if (p_193383_4_ == EnumFacing.UP && p_193383_2_.get(field_176554_a) == BlockSlab.EnumBlockHalf.TOP)
        {
            return BlockFaceShape.SOLID;
        }
        else
        {
            return p_193383_4_ == EnumFacing.DOWN && p_193383_2_.get(field_176554_a) == BlockSlab.EnumBlockHalf.BOTTOM ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
        }
    }
