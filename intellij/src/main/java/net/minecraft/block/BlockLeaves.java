...
public abstract class BlockLeaves extends Block
{
            ...
            for (int j1 = -1; j1 <= 1; ++j1)
            {
                for (int k1 = -1; k1 <= 1; ++k1)
                {
                    for (int l1 = -1; l1 <= 1; ++l1)
                    {
                        ...
                        if (iblockstate.getMaterial() == Material.LEAVES && !((Boolean)iblockstate.get(field_176236_b)).booleanValue())
                        {
                            p_180663_1_.setBlockState(blockpos, iblockstate.func_177226_a(field_176236_b, Boolean.valueOf(true)), 4);
                        }
                    }
                }
            }
    ...
    public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_)
    {
        if (!p_180650_1_.isRemote)
        {
            if (((Boolean)p_180650_3_.get(field_176236_b)).booleanValue() && ((Boolean)p_180650_3_.get(field_176237_a)).booleanValue())
            {
                ...
                if (p_180650_1_.isAreaLoaded(new BlockPos(k - 5, l - 5, i1 - 5), new BlockPos(k + 5, l + 5, i1 + 5)))
                {
    ...
    {
        if (worldIn.isRainingAt(pos.up()) && !worldIn.getBlockState(pos.down()).func_185896_q() && rand.nextInt(15) == 1)
        {
    ...
    public void func_180653_a(World p_180653_1_, BlockPos p_180653_2_, IBlockState p_180653_3_, float p_180653_4_, int p_180653_5_)
    {
        if (!p_180653_1_.isRemote)
        {
            ...
            if (p_180653_1_.rand.nextInt(i) == 0)
            {
