...
public abstract class BlockRailBase extends Block
{
    ...
    public static boolean func_176563_d(IBlockState p_176563_0_)
    {
        ...
        return block == Blocks.RAIL || block == Blocks.field_150318_D || block == Blocks.DETECTOR_RAIL || block == Blocks.ACTIVATOR_RAIL;
    }
    ...
    {
        BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = p_185496_1_.getBlock() == this ? (BlockRailBase.EnumRailDirection)p_185496_1_.get(this.getShapeProperty()) : null;
    ...
    {
        return p_176196_1_.getBlockState(p_176196_2_.down()).func_185896_q();
    }
    ...
    public void func_189540_a(IBlockState p_189540_1_, World p_189540_2_, BlockPos p_189540_3_, Block p_189540_4_, BlockPos p_189540_5_)
    {
        ...
        {
            BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = (BlockRailBase.EnumRailDirection)p_189540_1_.get(this.getShapeProperty());
            boolean flag = false;
            ...
            if (blockrailbase$enumraildirection == BlockRailBase.EnumRailDirection.ASCENDING_EAST && !p_189540_2_.getBlockState(p_189540_3_.east()).func_185896_q())
            {
                flag = true;
            }
            else if (blockrailbase$enumraildirection == BlockRailBase.EnumRailDirection.ASCENDING_WEST && !p_189540_2_.getBlockState(p_189540_3_.west()).func_185896_q())
            {
                flag = true;
            }
            else if (blockrailbase$enumraildirection == BlockRailBase.EnumRailDirection.ASCENDING_NORTH && !p_189540_2_.getBlockState(p_189540_3_.north()).func_185896_q())
            {
                flag = true;
            }
            else if (blockrailbase$enumraildirection == BlockRailBase.EnumRailDirection.ASCENDING_SOUTH && !p_189540_2_.getBlockState(p_189540_3_.south()).func_185896_q())
            {
                flag = true;
            }
    ...
    public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_)
    {
        ...
        if (((BlockRailBase.EnumRailDirection)p_180663_3_.get(this.getShapeProperty())).func_177018_c())
        {
    ...
    public class Rail
    {
        ...
        public Rail(World p_i45739_2_, BlockPos p_i45739_3_, IBlockState p_i45739_4_)
        {
            ...
            BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = (BlockRailBase.EnumRailDirection)p_i45739_4_.get(this.field_180365_d.getShapeProperty());
