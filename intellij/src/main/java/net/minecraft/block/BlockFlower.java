...
public abstract class BlockFlower extends BlockBush
{
    ...
    {
        this.setDefaultState(this.stateContainer.getBaseState().func_177226_a(this.func_176494_l(), this.func_176495_j() == BlockFlower.EnumFlowerColor.RED ? BlockFlower.EnumFlowerType.POPPY : BlockFlower.EnumFlowerType.DANDELION));
    }

    public AxisAlignedBB func_185496_a(IBlockState p_185496_1_, IBlockAccess p_185496_2_, BlockPos p_185496_3_)
    {
        return super.func_185496_a(p_185496_1_, p_185496_2_, p_185496_3_).offset(p_185496_1_.getOffset(p_185496_2_, p_185496_3_));
    }

    public int func_180651_a(IBlockState p_180651_1_)
    {
        return ((BlockFlower.EnumFlowerType)p_180651_1_.get(this.func_176494_l())).func_176968_b();
    }
    ...
    public void fillItemGroup(CreativeTabs group, NonNullList<ItemStack> items)
    {
        ...
        {
            items.add(new ItemStack(this, 1, blockflower$enumflowertype.func_176968_b()));
        }
    }

    public IBlockState func_176203_a(int p_176203_1_)
    {
        return this.getDefaultState().func_177226_a(this.func_176494_l(), BlockFlower.EnumFlowerType.func_176967_a(this.func_176495_j(), p_176203_1_));
    }
    ...
    public IProperty<BlockFlower.EnumFlowerType> func_176494_l()
    {
        ...
        {
            this.field_176496_a = PropertyEnum.<BlockFlower.EnumFlowerType>create("type", BlockFlower.EnumFlowerType.class, new Predicate<BlockFlower.EnumFlowerType>()
            {
    ...
    {
        return ((BlockFlower.EnumFlowerType)p_176201_1_.get(this.func_176494_l())).func_176968_b();
    }
