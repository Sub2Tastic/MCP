...
{
    public static final PropertyEnum<BlockPlanks.EnumType> field_176301_b = PropertyEnum.<BlockPlanks.EnumType>create("variant", BlockPlanks.EnumType.class, new Predicate<BlockPlanks.EnumType>()
    {
    ...
    public BlockOldLog()
    {
        this.setDefaultState(this.stateContainer.getBaseState().func_177226_a(field_176301_b, BlockPlanks.EnumType.OAK).func_177226_a(field_176299_a, BlockLog.EnumAxis.Y));
    }
    ...
    {
        BlockPlanks.EnumType blockplanks$enumtype = (BlockPlanks.EnumType)state.get(field_176301_b);
    ...
    {
        IBlockState iblockstate = this.getDefaultState().func_177226_a(field_176301_b, BlockPlanks.EnumType.func_176837_a((p_176203_1_ & 3) % 4));
    ...
    {
        int i = 0;
        i = i | ((BlockPlanks.EnumType)p_176201_1_.get(field_176301_b)).func_176839_a();
    ...
    {
        return new ItemStack(Item.getItemFromBlock(this), 1, ((BlockPlanks.EnumType)p_180643_1_.get(field_176301_b)).func_176839_a());
    }

    public int func_180651_a(IBlockState p_180651_1_)
    {
        return ((BlockPlanks.EnumType)p_180651_1_.get(field_176301_b)).func_176839_a();
    }
}
