...
{
    public static final PropertyEnum<BlockDirt.DirtType> field_176386_a = PropertyEnum.<BlockDirt.DirtType>create("variant", BlockDirt.DirtType.class);
    public static final PropertyBool field_176385_b = PropertyBool.create("snowy");

    protected BlockDirt()
    {
        super(Material.EARTH);
        this.setDefaultState(this.stateContainer.getBaseState().func_177226_a(field_176386_a, BlockDirt.DirtType.DIRT).func_177226_a(field_176385_b, Boolean.valueOf(false)));
    ...
    {
        return ((BlockDirt.DirtType)state.get(field_176386_a)).func_181066_d();
    }

    public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_)
    {
        if (p_176221_1_.get(field_176386_a) == BlockDirt.DirtType.PODZOL)
        {
            Block block = p_176221_2_.getBlockState(p_176221_3_.up()).getBlock();
            p_176221_1_ = p_176221_1_.func_177226_a(field_176385_b, Boolean.valueOf(block == Blocks.SNOW || block == Blocks.field_150431_aC));
        }
    ...
    {
        items.add(new ItemStack(this, 1, BlockDirt.DirtType.DIRT.func_176925_a()));
        items.add(new ItemStack(this, 1, BlockDirt.DirtType.COARSE_DIRT.func_176925_a()));
        items.add(new ItemStack(this, 1, BlockDirt.DirtType.PODZOL.func_176925_a()));
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(this, 1, ((BlockDirt.DirtType)state.get(field_176386_a)).func_176925_a());
    }

    public IBlockState func_176203_a(int p_176203_1_)
    {
        return this.getDefaultState().func_177226_a(field_176386_a, BlockDirt.DirtType.func_176924_a(p_176203_1_));
    }

    public int func_176201_c(IBlockState p_176201_1_)
    {
        return ((BlockDirt.DirtType)p_176201_1_.get(field_176386_a)).func_176925_a();
    }
    ...
    {
        BlockDirt.DirtType blockdirt$dirttype = (BlockDirt.DirtType)p_180651_1_.get(field_176386_a);
