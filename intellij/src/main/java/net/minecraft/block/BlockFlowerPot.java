...
public class BlockFlowerPot extends BlockContainer
{
    ...
    {
        return super.func_176196_c(p_176196_1_, p_176196_2_) && p_176196_1_.getBlockState(p_176196_2_.down()).func_185896_q();
    }
    ...
    public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_)
    {
        ...
        {
            spawnAsEntity(p_180663_1_, p_180663_2_, new ItemStack(tileentityflowerpot.func_145965_a(), 1, tileentityflowerpot.func_145966_b()));
        }
    ...
    public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_)
    {
        ...
        TileEntity tileentity = p_176221_2_ instanceof ChunkCache ? ((ChunkCache)p_176221_2_).func_190300_a(p_176221_3_, Chunk.EnumCreateEntityType.CHECK) : p_176221_2_.getTileEntity(p_176221_3_);
