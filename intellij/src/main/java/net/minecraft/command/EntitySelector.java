...
public class EntitySelector
{
    ...
    public static <T extends Entity> List<T> func_179656_b(ICommandSender p_179656_0_, String p_179656_1_, Class <? extends T > p_179656_2_) throws CommandException
    {
        ...
        if (matcher.matches() && p_179656_0_.func_70003_b(1, "@"))
        {
            ...
            else
            {
                ...
                Vec3d vec3d = func_189210_b(map, p_179656_0_.getPositionVector());
    ...
    private static List<World> func_179654_a(ICommandSender p_179654_0_, Map<String, String> p_179654_1_)
    {
        ...
        {
            list.add(p_179654_0_.getEntityWorld());
        }
        else
        {
            Collections.addAll(list, p_179654_0_.getServer().worlds);
        }
    ...
    private static <T extends Entity> boolean func_179655_b(ICommandSender p_179655_0_, Map<String, String> p_179655_1_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                p_179655_0_.sendMessage(textcomponenttranslation);
                return false;
            }
        }
    }
    ...
    private static List<Predicate<Entity>> func_184952_c(final ICommandSender p_184952_0_, Map<String, String> p_184952_1_)
    {
        ...
        return (map.isEmpty() ? Collections.emptyList() : Lists.newArrayList(new Predicate<Entity>()
        {
            public boolean apply(@Nullable Entity p_apply_1_)
            {
                ...
                {
                    Scoreboard scoreboard = p_184952_0_.getServer().getWorld(0).getScoreboard();
                    ...
                    for (Entry<String, Integer> entry : map.entrySet())
                    {
                        ...
                        String s1 = p_apply_1_ instanceof EntityPlayerMP ? p_apply_1_.func_70005_c_() : p_apply_1_.getCachedUniqueIdString();
        ...
        else
        {
            ...
            return Lists.newArrayList(new Predicate<Entity>()
            {
                public boolean apply(@Nullable Entity p_apply_1_)
                {
                    ...
                    {
                        double d6 = p_180698_1_.squareDistanceTo(p_apply_1_.posX, p_apply_1_.posY, p_apply_1_.posZ);
    ...
    private static List<Predicate<Entity>> func_179662_g(Map<String, String> p_179662_0_)
    {
        ...
        {
            final int i = MathHelper.wrapDegrees(func_179653_a(p_179662_0_, field_190844_r, 0));
            final int j = MathHelper.wrapDegrees(func_179653_a(p_179662_0_, field_190843_q, 359));
            list.add(new Predicate<Entity>()
            {
                public boolean apply(@Nullable Entity p_apply_1_)
                {
        ...
        {
            final int k = MathHelper.wrapDegrees(func_179653_a(p_179662_0_, field_190842_p, 0));
            final int l = MathHelper.wrapDegrees(func_179653_a(p_179662_0_, field_190841_o, 359));
            list.add(new Predicate<Entity>()
            {
                public boolean apply(@Nullable Entity p_apply_1_)
                {
    ...
    private static <T extends Entity> List<T> func_179660_a(Map<String, String> p_179660_0_, Class <? extends T > p_179660_1_, List<Predicate<Entity>> p_179660_2_, String p_179660_3_, World p_179660_4_, BlockPos p_179660_5_)
    {
        ...
        if (!p_179660_0_.containsKey(field_190838_l) && !p_179660_0_.containsKey(field_190839_m) && !p_179660_0_.containsKey(field_190840_n))
        {
            if (l >= 0)
            {
                AxisAlignedBB axisalignedbb1 = new AxisAlignedBB((double)(p_179660_5_.getX() - l), (double)(p_179660_5_.getY() - l), (double)(p_179660_5_.getZ() - l), (double)(p_179660_5_.getX() + l + 1), (double)(p_179660_5_.getY() + l + 1), (double)(p_179660_5_.getZ() + l + 1));
                ...
                {
                    list.addAll(p_179660_4_.getEntitiesWithinAABB(p_179660_1_, axisalignedbb1, predicate1));
                }
            }
        ...
        else
        {
            ...
            {
                list.addAll(p_179660_4_.getEntitiesWithinAABB(p_179660_1_, axisalignedbb, predicate1));
            }
        }
    ...
    private static <T extends Entity> List<T> func_179658_a(List<T> p_179658_0_, Map<String, String> p_179658_1_, ICommandSender p_179658_2_, Class <? extends T > p_179658_3_, String p_179658_4_, final Vec3d p_179658_5_)
    {
        ...
        else
        {
            Collections.sort(p_179658_0_, new Comparator<Entity>()
            {
                ...
                {
                    return ComparisonChain.start().compare(p_compare_1_.getDistanceSq(p_179658_5_.x, p_179658_5_.y, p_179658_5_.z), p_compare_2_.getDistanceSq(p_179658_5_.x, p_179658_5_.y, p_179658_5_.z)).result();
                }
            });
        }
    ...
    {
        return new BlockPos(func_179653_a(p_179664_0_, field_190835_i, p_179664_1_.getX()), func_179653_a(p_179664_0_, field_190836_j, p_179664_1_.getY()), func_179653_a(p_179664_0_, field_190837_k, p_179664_1_.getZ()));
    }

    private static Vec3d func_189210_b(Map<String, String> p_189210_0_, Vec3d p_189210_1_)
    {
        return new Vec3d(func_189211_a(p_189210_0_, field_190835_i, p_189210_1_.x, true), func_189211_a(p_189210_0_, field_190836_j, p_189210_1_.y, false), func_189211_a(p_189210_0_, field_190837_k, p_189210_1_.z, true));
    }
    ...
    {
        return p_189211_0_.containsKey(p_189211_1_) ? (double)MathHelper.getInt(p_189211_0_.get(p_189211_1_), MathHelper.floor(p_189211_2_)) + (p_189211_4_ ? 0.5D : 0.0D) : p_189211_2_;
    }
    ...
    {
        return p_179653_0_.containsKey(p_179653_1_) ? MathHelper.getInt(p_179653_0_.get(p_179653_1_), p_179653_2_) : p_179653_2_;
    }
    ...
    public static Map<String, Integer> func_96560_a(Map<String, String> p_96560_0_)
    {
        ...
        for (String s : p_96560_0_.keySet())
        {
            ...
            {
                map.put(s.substring("score_".length()), Integer.valueOf(MathHelper.getInt(p_96560_0_.get(s), 1)));
            }
        }
