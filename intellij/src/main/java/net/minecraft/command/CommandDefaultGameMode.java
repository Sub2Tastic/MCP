...
public class CommandDefaultGameMode extends CommandGameMode
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            func_152373_a(p_184881_2_, this, "commands.defaultgamemode.success", new Object[] {new TextComponentTranslation("gameMode." + gametype.getName(), new Object[0])});
        }
    }
    ...
    protected void func_184896_a(GameType p_184896_1_, MinecraftServer p_184896_2_)
    {
        ...
        {
            for (EntityPlayerMP entityplayermp : p_184896_2_.getPlayerList().getPlayers())
            {
