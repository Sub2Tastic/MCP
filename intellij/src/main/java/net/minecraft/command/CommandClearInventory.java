...
public class CommandClearInventory extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        if (p_184881_3_.length >= 5)
        {
            try
            {
                nbttagcompound = JsonToNBT.getTagFromJson(func_180529_a(p_184881_3_, 4));
            }
        ...
        else
        {
            ...
            else
            {
                if (j == 0)
                {
                    p_184881_2_.sendMessage(new TextComponentTranslation("commands.clear.testing", new Object[] {entityplayermp.func_70005_c_(), k}));
                }
                else
                {
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return p_184883_3_.length == 2 ? func_175762_a(p_184883_3_, Item.field_150901_e.keySet()) : Collections.emptyList();
        }
    }
