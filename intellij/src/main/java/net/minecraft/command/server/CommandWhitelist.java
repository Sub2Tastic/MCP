...
public class CommandWhitelist extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            {
                p_184881_1_.getPlayerList().setWhiteListEnabled(true);
                func_152373_a(p_184881_2_, this, "commands.whitelist.enabled", new Object[0]);
            }
            else if ("off".equals(p_184881_3_[0]))
            {
                p_184881_1_.getPlayerList().setWhiteListEnabled(false);
                func_152373_a(p_184881_2_, this, "commands.whitelist.disabled", new Object[0]);
            }
            else if ("list".equals(p_184881_3_[0]))
            {
                p_184881_2_.sendMessage(new TextComponentTranslation("commands.whitelist.list", new Object[] {p_184881_1_.getPlayerList().getWhitelistedPlayerNames().length, p_184881_1_.getPlayerList().func_72373_m().length}));
                String[] astring = p_184881_1_.getPlayerList().getWhitelistedPlayerNames();
                p_184881_2_.sendMessage(new TextComponentString(func_71527_a(astring)));
            }
            else if ("add".equals(p_184881_3_[0]))
            {
                ...
                GameProfile gameprofile = p_184881_1_.getPlayerProfileCache().getGameProfileForUsername(p_184881_3_[1]);
                ...
                p_184881_1_.getPlayerList().func_152601_d(gameprofile);
            ...
            else if ("remove".equals(p_184881_3_[0]))
            {
                ...
                GameProfile gameprofile1 = p_184881_1_.getPlayerList().getWhitelistedPlayers().func_152706_a(p_184881_3_[1]);
                ...
                p_184881_1_.getPlayerList().func_152597_c(gameprofile1);
            ...
            {
                p_184881_1_.getPlayerList().reloadWhitelist();
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        else
        {
            if (p_184883_3_.length == 2)
            {
                ...
                {
                    return func_71530_a(p_184883_3_, p_184883_1_.getPlayerList().getWhitelistedPlayerNames());
                }

                if ("add".equals(p_184883_3_[0]))
                {
                    return func_71530_a(p_184883_3_, p_184883_1_.getPlayerProfileCache().func_152654_a());
                }
            }
