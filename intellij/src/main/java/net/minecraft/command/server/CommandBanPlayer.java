...
public class CommandBanPlayer extends CommandBase
{
    ...
    {
        return p_184882_1_.getPlayerList().getBannedPlayers().isLanServer() && super.func_184882_a(p_184882_1_, p_184882_2_);
    }
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        {
            GameProfile gameprofile = p_184881_1_.getPlayerProfileCache().getGameProfileForUsername(p_184881_3_[0]);
            ...
            else
            {
                ...
                p_184881_1_.getPlayerList().getBannedPlayers().addEntry(userlistbansentry);
                EntityPlayerMP entityplayermp = p_184881_1_.getPlayerList().getPlayerByUsername(p_184881_3_[0]);
    ...
    {
        return p_184883_3_.length >= 1 ? func_71530_a(p_184883_3_, p_184883_1_.getOnlinePlayerNames()) : Collections.emptyList();
    }
}
