...
public class CommandBanIp extends CommandBase
{
    ...
    {
        return p_184882_1_.getPlayerList().getBannedIPs().isLanServer() && super.func_184882_a(p_184882_1_, p_184882_2_);
    }
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        if (p_184881_3_.length >= 1 && p_184881_3_[0].length() > 1)
        {
            ...
            else
            {
                ...
                this.func_184892_a(p_184881_1_, p_184881_2_, entityplayermp.getPlayerIP(), itextcomponent == null ? null : itextcomponent.func_150260_c());
            }
        }
        else
        {
