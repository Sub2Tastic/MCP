...
public class CommandFunction extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            FunctionObject functionobject = p_184881_1_.getFunctionManager().func_193058_a(resourcelocation);
            ...
            else
            {
                ...
                int i = p_184881_1_.getFunctionManager().func_194019_a(functionobject, CommandSenderWrapper.func_193998_a(p_184881_2_).func_194000_i().func_193999_a(2).func_194001_a(false));
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return p_184883_3_.length == 3 ? func_71530_a(p_184883_3_, p_184883_1_.getOnlinePlayerNames()) : Collections.emptyList();
        }
    }
}
