...
public class CommandSetSpawnpoint extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            BlockPos blockpos = p_184881_3_.length > 3 ? func_175757_a(p_184881_2_, p_184881_3_, 1, true) : entityplayermp.getPosition();

            if (entityplayermp.world != null)
            {
                entityplayermp.func_180473_a(blockpos, true);
                func_152373_a(p_184881_2_, this, "commands.spawnpoint.success", new Object[] {entityplayermp.func_70005_c_(), blockpos.getX(), blockpos.getY(), blockpos.getZ()});
            }
        }
    }
