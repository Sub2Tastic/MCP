...
public class CommandPlaySound extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                double d0 = p_184881_3_.length > i ? func_175761_b(vec3d.x, p_184881_3_[i++], true) : vec3d.x;
                double d1 = p_184881_3_.length > i ? func_175769_b(vec3d.y, p_184881_3_[i++], 0, 0, false) : vec3d.y;
                double d2 = p_184881_3_.length > i ? func_175761_b(vec3d.z, p_184881_3_[i++], true) : vec3d.z;
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return func_175762_a(p_184883_3_, SoundEvent.field_187505_a.keySet());
        }
