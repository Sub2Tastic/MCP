...
public class CommandDifficulty extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            p_184881_1_.setDifficultyForAllWorlds(enumdifficulty);
            func_152373_a(p_184881_2_, this, "commands.difficulty.success", new Object[] {new TextComponentTranslation(enumdifficulty.getTranslationKey(), new Object[0])});
        }
    }
    ...
    protected EnumDifficulty func_180531_e(String p_180531_1_) throws CommandException, NumberInvalidException
    {
        if (!"peaceful".equalsIgnoreCase(p_180531_1_) && !"p".equalsIgnoreCase(p_180531_1_))
        {
            if (!"easy".equalsIgnoreCase(p_180531_1_) && !"e".equalsIgnoreCase(p_180531_1_))
            {
                ...
                {
                    return !"hard".equalsIgnoreCase(p_180531_1_) && !"h".equalsIgnoreCase(p_180531_1_) ? EnumDifficulty.byId(func_175764_a(p_180531_1_, 0, 3)) : EnumDifficulty.HARD;
                }
                else
                {
