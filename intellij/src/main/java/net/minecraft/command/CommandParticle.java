...
public class CommandParticle extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                double d0 = (double)((float)func_175761_b(vec3d.x, p_184881_3_[1], true));
                double d1 = (double)((float)func_175761_b(vec3d.y, p_184881_3_[2], true));
                double d2 = (double)((float)func_175761_b(vec3d.z, p_184881_3_[3], true));
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return p_184883_3_.length == 11 ? func_71530_a(p_184883_3_, p_184883_1_.getOnlinePlayerNames()) : Collections.emptyList();
        }
    }
