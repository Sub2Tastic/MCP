...
public class CommandTime extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        if (p_184881_3_.length > 1)
        {
            ...
            if ("query".equals(p_184881_3_[0]))
            {
                ...
                {
                    int k = (int)(p_184881_2_.getEntityWorld().getDayTime() % 24000L);
                ...
                if ("day".equals(p_184881_3_[1]))
                {
                    int j = (int)(p_184881_2_.getEntityWorld().getDayTime() / 24000L % 2147483647L);
                ...
                {
                    int i = (int)(p_184881_2_.getEntityWorld().getGameTime() % 2147483647L);
    ...
    {
        for (int i = 0; i < p_184929_1_.worlds.length; ++i)
        {
            p_184929_1_.worlds[i].setDayTime((long)p_184929_2_);
        }
    }

    protected void func_184928_b(MinecraftServer p_184928_1_, int p_184928_2_)
    {
        for (int i = 0; i < p_184928_1_.worlds.length; ++i)
        {
            WorldServer worldserver = p_184928_1_.worlds[i];
            worldserver.setDayTime(worldserver.getDayTime() + (long)p_184928_2_);
        }
    }
}
