...
public class CommandEffect extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    potion = Potion.get(func_180528_a(p_184881_3_[1], 1));
                }
                ...
                else
                {
                    ...
                    if (j > 0)
                    {
                        ...
                        func_152373_a(p_184881_2_, this, "commands.effect.success", new Object[] {new TextComponentTranslation(potioneffect.getEffectName(), new Object[0]), Potion.getId(potion), k, entitylivingbase.func_70005_c_(), j});
                    }
                    else if (entitylivingbase.isPotionActive(potion))
                    {
                        entitylivingbase.func_184589_d(potion);
                        func_152373_a(p_184881_2_, this, "commands.effect.success.removed", new Object[] {new TextComponentTranslation(potion.getName(), new Object[0]), entitylivingbase.func_70005_c_()});
                    }
                    else
                    {
                        throw new CommandException("commands.effect.failure.notActive", new Object[] {new TextComponentTranslation(potion.getName(), new Object[0]), entitylivingbase.func_70005_c_()});
                    }
                }
            }
        }
    ...
    public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_)
    {
        ...
        {
            return func_175762_a(p_184883_3_, Potion.field_188414_b.keySet());
        }
        else
        {
