...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            double d0 = func_175761_b((double)blockpos.getX(), p_184881_3_[i++], true);
            double d1 = func_175761_b((double)blockpos.getZ(), p_184881_3_[i++], true);
            ...
            while (i < p_184881_3_.length)
            {
                ...
                {
                    EntityPlayer entityplayer = p_184881_1_.getPlayerList().getPlayerByUsername(s);
            ...
            {
                p_184881_2_.sendMessage(new TextComponentTranslation("commands.spreadplayers.spreading." + (flag ? "teams" : "players"), new Object[] {list.size(), d3, d0, d1, d2}));
                this.func_110669_a(p_184881_2_, list, new CommandSpreadPlayers.Position(d0, d1), d2, d3, (list.get(0)).world, flag);
            }
        }
    }
    ...
    private void func_110669_a(ICommandSender p_110669_1_, List<Entity> p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World p_110669_8_, boolean p_110669_9_) throws CommandException
    {
        ...
        {
            p_110669_1_.sendMessage(new TextComponentTranslation("commands.spreadplayers.info." + (p_110669_9_ ? "teams" : "players"), new Object[] {String.format("%.2f", d4), i}));
        }
    }
    ...
    private double func_110671_a(List<Entity> p_110671_1_, World p_110671_2_, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_)
    {
        ...
        for (int j = 0; j < p_110671_1_.size(); ++j)
        {
            ...
            entity.setPositionAndUpdate((double)((float)MathHelper.floor(commandspreadplayers$position.field_111101_a) + 0.5F), (double)commandspreadplayers$position.func_111092_a(p_110671_2_), (double)MathHelper.floor(commandspreadplayers$position.field_111100_b) + 0.5D);
    ...
    static class Position
    {
        ...
        public int func_111092_a(World p_111092_1_)
        {
            ...
            while (blockpos.getY() > 0)
            {
                ...
                if (p_111092_1_.getBlockState(blockpos).getMaterial() != Material.AIR)
                {
        ...
        public boolean func_111098_b(World p_111098_1_)
        {
            ...
            {
                blockpos = blockpos.down();
                Material material = p_111098_1_.getBlockState(blockpos).getMaterial();
        ...
        {
            this.field_111101_a = MathHelper.nextDouble(p_111097_1_, p_111097_2_, p_111097_6_);
            this.field_111100_b = MathHelper.nextDouble(p_111097_1_, p_111097_4_, p_111097_8_);
        }
    }
}
