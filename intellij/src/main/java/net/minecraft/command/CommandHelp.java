...
public class CommandHelp extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        {
            p_184881_2_.sendMessage((new TextComponentString("Searge says: ")).appendText(field_184901_a[this.field_184902_b.nextInt(field_184901_a.length) % field_184901_a.length]));
        }
        else
        {
            ...
            catch (NumberInvalidException numberinvalidexception)
            {
                ...
                if (MathHelper.getInt(p_184881_3_[0], -1) == -1 && MathHelper.getInt(p_184881_3_[0], -2) == -2)
                {
            ...
            for (int i1 = k * 7; i1 < l; ++i1)
            {
                ...
                textcomponenttranslation.getStyle().setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/" + icommand1.func_71517_b() + " "));
                p_184881_2_.sendMessage(textcomponenttranslation);
            }
            ...
            if (k == 0)
            {
                ...
                p_184881_2_.sendMessage(textcomponenttranslation2);
            }
        }
    }
