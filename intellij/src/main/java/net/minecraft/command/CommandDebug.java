...
public class CommandDebug extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            if ("start".equals(p_184881_3_[0]))
            {
                ...
                p_184881_1_.enableProfiling();
                this.field_147206_b = MinecraftServer.func_130071_aq();
                this.field_147207_c = p_184881_1_.getTickCounter();
            }
            else
            {
    ...
    {
        List<Profiler.Result> list = p_184895_4_.profiler.func_76321_b(p_184895_2_);
