...
public class ServerCommandManager extends CommandHandler implements ICommandListener
{
    ...
    public void func_152372_a(ICommandSender p_152372_1_, ICommand p_152372_2_, int p_152372_3_, String p_152372_4_, Object... p_152372_5_)
    {
        ...
        if (flag)
        {
            ...
            {
                if (entityplayer != p_152372_1_ && minecraftserver.getPlayerList().canSendCommands(entityplayer.getGameProfile()) && p_152372_2_.func_184882_a(this.field_184880_a, p_152372_1_))
                {
        ...
        if (p_152372_1_ != minecraftserver && minecraftserver.worlds[0].getGameRules().func_82766_b("logAdminCommands"))
        {
            minecraftserver.sendMessage(itextcomponent);
        }

        boolean flag3 = minecraftserver.worlds[0].getGameRules().func_82766_b("sendCommandFeedback");

        if (p_152372_1_ instanceof CommandBlockBaseLogic)
        {
            flag3 = ((CommandBlockBaseLogic)p_152372_1_).shouldTrackOutput();
        }

        if ((p_152372_3_ & 1) != 1 && flag3 || p_152372_1_ instanceof MinecraftServer)
        {
            p_152372_1_.sendMessage(new TextComponentTranslation(p_152372_4_, p_152372_5_));
        }
    }
