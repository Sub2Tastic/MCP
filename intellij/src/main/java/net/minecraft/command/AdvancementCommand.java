...
public class AdvancementCommand extends CommandBase
{
    ...
    private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_, EntityPlayerMP p_193516_4_, AdvancementCommand.ActionType p_193516_5_, AdvancementCommand.Mode p_193516_6_) throws CommandException
    {
        if (p_193516_6_ == AdvancementCommand.Mode.EVERYTHING)
        {
            ...
            {
                int j = p_193516_5_.func_193532_a(p_193516_4_, p_193516_1_.getAdvancementManager().func_192780_b());
        ...
        else
        {
            ...
            if (p_193516_6_ == AdvancementCommand.Mode.ONLY && p_193516_3_.length == 5)
            {
                ...
                {
                    throw new CommandException(p_193516_5_.field_193541_d + ".criterion.failed", new Object[] {advancement.getId(), p_193516_4_.func_70005_c_(), s});
                }

                func_152373_a(p_193516_2_, this, p_193516_5_.field_193541_d + ".criterion.success", new Object[] {advancement.getId(), p_193516_4_.func_70005_c_(), s});
            }
            else
            {
                ...
                if (i == 0)
                {
                    throw p_193516_6_.func_193543_a(p_193516_5_, advancement.getId(), p_193516_4_.func_70005_c_());
                }

                p_193516_6_.func_193546_a(p_193516_2_, this, p_193516_5_, advancement.getId(), p_193516_4_.func_70005_c_(), i);
            }
        }
    }
    ...
    private void func_192554_c(ICommandSender p_192554_1_, EntityPlayerMP p_192554_2_, Advancement p_192554_3_, String p_192554_4_) throws CommandException
    {
        ...
        {
            throw new CommandException("commands.advancement.test.criterion.notDone", new Object[] {p_192554_2_.func_70005_c_(), p_192554_3_.getId(), p_192554_4_});
        }
        else
        {
            func_152373_a(p_192554_1_, this, "commands.advancement.test.criterion.success", new Object[] {p_192554_2_.func_70005_c_(), p_192554_3_.getId(), p_192554_4_});
        }
    }
    ...
    private void func_192552_c(ICommandSender p_192552_1_, EntityPlayerMP p_192552_2_, Advancement p_192552_3_) throws CommandException
    {
        ...
        {
            throw new CommandException("commands.advancement.test.advancement.notDone", new Object[] {p_192552_2_.func_70005_c_(), p_192552_3_.getId()});
        }
        else
        {
            func_152373_a(p_192552_1_, this, "commands.advancement.test.advancement.success", new Object[] {p_192552_2_.func_70005_c_(), p_192552_3_.getId()});
        }
    }
        ...
        else
        {
            ...
            if (advancementcommand$actiontype != null)
            {
                ...
                if (advancementcommand$mode != null && advancementcommand$mode != AdvancementCommand.Mode.EVERYTHING)
                {
                    ...
                    {
                        Advancement advancement = p_184883_1_.getAdvancementManager().getAdvancement(new ResourceLocation(p_184883_3_[3]));

                        if (advancement != null)
                        {
                            return func_175762_a(p_184883_3_, advancement.getCriteria().keySet());
                        }
                    }
                }
            }
            ...
            if ("test".equals(p_184883_3_[0]))
            {
                ...
                if (p_184883_3_.length == 4)
                {
                    Advancement advancement1 = p_184883_1_.getAdvancementManager().getAdvancement(new ResourceLocation(p_184883_3_[2]));

                    if (advancement1 != null)
                    {
                        return func_175762_a(p_184883_3_, advancement1.getCriteria().keySet());
                    }
                }
            }
    ...
    private List<ResourceLocation> func_193517_a(MinecraftServer p_193517_1_)
    {
        ...
        for (Advancement advancement : p_193517_1_.getAdvancementManager().func_192780_b())
        {
    ...
    {
        Advancement advancement = p_192551_0_.getAdvancementManager().getAdvancement(new ResourceLocation(p_192551_1_));
