...
public class CommandXP extends CommandBase
{
    ...
    public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException
    {
        ...
        else
        {
            ...
            if (flag)
            {
                p_184881_2_.func_174794_a(CommandResultStats.Type.QUERY_RESULT, entityplayer.experienceLevel);
            ...
            {
                p_184881_2_.func_174794_a(CommandResultStats.Type.QUERY_RESULT, entityplayer.experienceTotal);
    ...
    {
        return p_184883_3_.length == 2 ? func_71530_a(p_184883_3_, p_184883_1_.getOnlinePlayerNames()) : Collections.emptyList();
    }
