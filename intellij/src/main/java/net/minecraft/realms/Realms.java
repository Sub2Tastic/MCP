...
public class Realms
{
    ...
    {
        return Minecraft.getInstance().func_110438_M().func_180601_a(p_downloadResourcePack_0_, p_downloadResourcePack_1_);
    }

    public static void clearResourcePack()
    {
        Minecraft.getInstance().func_110438_M().func_148529_f();
    }

    public static boolean getRealmsNotificationsEnabled()
    {
        return Minecraft.getInstance().gameSettings.func_74308_b(GameSettings.Options.REALMS_NOTIFICATIONS);
    }
