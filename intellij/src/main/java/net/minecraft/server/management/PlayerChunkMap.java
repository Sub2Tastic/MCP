...
public class PlayerChunkMap
{
    ...
    private static final Predicate<EntityPlayerMP> field_187309_b = new Predicate<EntityPlayerMP>()
    {
        public boolean apply(@Nullable EntityPlayerMP p_apply_1_)
        {
            return p_apply_1_ != null && (!p_apply_1_.isSpectator() || p_apply_1_.getServerWorld().getGameRules().func_82766_b("spectatorsGenerateChunks"));
        }
    };
    ...
    public PlayerChunkMap(WorldServer p_i1176_1_)
    {
        ...
        this.func_152622_a(p_i1176_1_.getServer().getPlayerList().getViewDistance());
    }
    ...
    {
        long i = this.field_72701_a.getGameTime();
        ...
        {
            WorldProvider worldprovider = this.field_72701_a.dimension;

            if (!worldprovider.canRespawnHere())
            {
                this.field_72701_a.getChunkProvider().func_73240_a();
            }
        }
    }
    ...
    public void func_180244_a(BlockPos p_180244_1_)
    {
        ...
        if (playerchunkmapentry != null)
        {
            playerchunkmapentry.func_187265_a(p_180244_1_.getX() & 15, p_180244_1_.getY(), p_180244_1_.getZ() & 15);
        }
    }
    ...
    public void func_72683_a(EntityPlayerMP p_72683_1_)
    {
        ...
        p_72683_1_.field_71131_d = p_72683_1_.posX;
        p_72683_1_.field_71132_e = p_72683_1_.posZ;
    ...
    public void func_72685_d(EntityPlayerMP p_72685_1_)
    {
        ...
        double d0 = p_72685_1_.field_71131_d - p_72685_1_.posX;
        double d1 = p_72685_1_.field_71132_e - p_72685_1_.posZ;
        ...
        if (d2 >= 64.0D)
        {
            ...
            if (j1 != 0 || k1 != 0)
            {
                ...
                p_72685_1_.field_71131_d = p_72685_1_.posX;
                p_72685_1_.field_71132_e = p_72685_1_.posZ;
                this.func_187306_e();
            }
        }
    }
    ...
    public void func_187305_b(PlayerChunkMapEntry p_187305_1_)
    {
        ...
        long i = func_187307_d(chunkpos.x, chunkpos.z);
        ...
        if (chunk != null)
        {
            this.func_72688_a().getChunkProvider().func_189549_a(chunk);
        }
    }
}
