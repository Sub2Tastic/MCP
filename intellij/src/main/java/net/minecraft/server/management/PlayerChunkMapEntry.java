...
public class PlayerChunkMapEntry
{
    ...
    public PlayerChunkMapEntry(PlayerChunkMap p_i1518_1_, int p_i1518_2_, int p_i1518_3_)
    {
        ...
        this.field_187286_f = p_i1518_1_.func_72688_a().getChunkProvider().func_186028_c(p_i1518_2_, p_i1518_3_);
    }
    ...
    public void func_187276_a(EntityPlayerMP p_187276_1_)
    {
        ...
        {
            field_187281_a.debug("Failed to add player. {} already is in chunk {}, {}", p_187276_1_, Integer.valueOf(this.field_187284_d.x), Integer.valueOf(this.field_187284_d.z));
        }
        else
        {
            if (this.field_187283_c.isEmpty())
            {
                this.field_187289_i = this.field_187282_b.func_72688_a().getGameTime();
            }
    ...
    public void func_187277_b(EntityPlayerMP p_187277_1_)
    {
        if (this.field_187283_c.contains(p_187277_1_))
        {
            if (this.field_187290_j)
            {
                p_187277_1_.connection.sendPacket(new SPacketUnloadChunk(this.field_187284_d.x, this.field_187284_d.z));
            }
    ...
    public boolean func_187268_a(boolean p_187268_1_)
    {
        ...
        else
        {
            if (p_187268_1_)
            {
                this.field_187286_f = this.field_187282_b.func_72688_a().getChunkProvider().func_186025_d(this.field_187284_d.x, this.field_187284_d.z);
            }
            else
            {
                this.field_187286_f = this.field_187282_b.func_72688_a().getChunkProvider().func_186028_c(this.field_187284_d.x, this.field_187284_d.z);
            }
    ...
    public void func_187278_c(EntityPlayerMP p_187278_1_)
    {
        if (this.field_187290_j)
        {
            p_187278_1_.connection.sendPacket(new SPacketChunkData(this.field_187286_f, 65535));
    ...
    {
        long i = this.field_187282_b.func_72688_a().getGameTime();

        if (this.field_187286_f != null)
        {
            this.field_187286_f.setInhabitedTime(this.field_187286_f.getInhabitedTime() + i - this.field_187289_i);
        }
    ...
    public void func_187267_a(Packet<?> p_187267_1_)
    {
        if (this.field_187290_j)
        {
            ...
            {
                (this.field_187283_c.get(i)).connection.sendPacket(p_187267_1_);
            }
        }
    }
    ...
    public void func_187280_d()
    {
        if (this.field_187290_j && this.field_187286_f != null)
        {
            if (this.field_187287_g != 0)
            {
                ...
                {
                    int i = (this.field_187285_e[0] >> 12 & 15) + this.field_187284_d.x * 16;
                    int j = this.field_187285_e[0] & 255;
                    int k = (this.field_187285_e[0] >> 8 & 15) + this.field_187284_d.z * 16;
                    BlockPos blockpos = new BlockPos(i, j, k);
                    this.func_187267_a(new SPacketBlockChange(this.field_187282_b.func_72688_a(), blockpos));

                    if (this.field_187282_b.func_72688_a().getBlockState(blockpos).getBlock().hasTileEntity())
                    {
                        this.func_187273_a(this.field_187282_b.func_72688_a().getTileEntity(blockpos));
                    }
                }
                ...
                else
                {
                    ...
                    {
                        int i1 = (this.field_187285_e[l] >> 12 & 15) + this.field_187284_d.x * 16;
                        int j1 = this.field_187285_e[l] & 255;
                        int k1 = (this.field_187285_e[l] >> 8 & 15) + this.field_187284_d.z * 16;
                        BlockPos blockpos1 = new BlockPos(i1, j1, k1);

                        if (this.field_187282_b.func_72688_a().getBlockState(blockpos1).getBlock().hasTileEntity())
                        {
                            this.func_187273_a(this.field_187282_b.func_72688_a().getTileEntity(blockpos1));
                        }
                    }
                }
