...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable
{
    ...
    public void tryAcceptPlayer()
    {
        ...
        String s = this.server.getPlayerList().func_148542_a(this.networkManager.getRemoteAddress(), this.loginGameProfile);
        ...
        else
        {
            ...
            {
                this.networkManager.func_179288_a(new SPacketEnableCompression(this.server.getNetworkCompressionThreshold()), new ChannelFutureListener()
                {
    ...
    {
        LOGGER.info("{} lost connection: {}", this.getConnectionInfo(), reason.func_150260_c());
    }
