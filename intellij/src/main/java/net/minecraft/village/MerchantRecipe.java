...
public class MerchantRecipe
{
    ...
    {
        this.field_77403_a = ItemStack.EMPTY;
        this.field_77401_b = ItemStack.EMPTY;
        this.field_77402_c = ItemStack.EMPTY;
    ...
    {
        return !this.field_77401_b.isEmpty();
    }
    ...
    {
        NBTTagCompound nbttagcompound = p_77390_1_.getCompound("buy");
        this.field_77403_a = new ItemStack(nbttagcompound);
        NBTTagCompound nbttagcompound1 = p_77390_1_.getCompound("sell");
        this.field_77402_c = new ItemStack(nbttagcompound1);

        if (p_77390_1_.contains("buyB", 10))
        {
            this.field_77401_b = new ItemStack(p_77390_1_.getCompound("buyB"));
        }

        if (p_77390_1_.contains("uses", 99))
        {
            this.field_77400_d = p_77390_1_.getInt("uses");
        }

        if (p_77390_1_.contains("maxUses", 99))
        {
            this.field_82786_e = p_77390_1_.getInt("maxUses");
        }
        else
        {
        ...
        if (p_77390_1_.contains("rewardExp", 1))
        {
    ...
    public NBTTagCompound func_77395_g()
    {
        ...
        nbttagcompound.func_74782_a("buy", this.field_77403_a.write(new NBTTagCompound()));
        nbttagcompound.func_74782_a("sell", this.field_77402_c.write(new NBTTagCompound()));

        if (!this.field_77401_b.isEmpty())
        {
            nbttagcompound.func_74782_a("buyB", this.field_77401_b.write(new NBTTagCompound()));
        }

        nbttagcompound.putInt("uses", this.field_77400_d);
        nbttagcompound.putInt("maxUses", this.field_82786_e);
        nbttagcompound.putBoolean("rewardExp", this.field_180323_f);
