...
public class VillageCollection extends WorldSavedData
{
    ...
    {
        super(func_176062_a(p_i1678_1_.dimension));
    ...
    public Village func_176056_a(BlockPos p_176056_1_, int p_176056_2_)
    {
        ...
        {
            double d1 = village1.func_180608_a().distanceSq(p_176056_1_);
    ...
    private void func_180609_b(BlockPos p_180609_1_)
    {
        ...
        for (int l = -16; l < 16; ++l)
        {
            for (int i1 = -4; i1 < 4; ++i1)
            {
                ...
                {
                    BlockPos blockpos = p_180609_1_.add(l, i1, j1);
    ...
    private VillageDoorInfo func_176055_c(BlockPos p_176055_1_)
    {
        ...
        {
            if (villagedoorinfo.func_179852_d().getX() == p_176055_1_.getX() && villagedoorinfo.func_179852_d().getZ() == p_176055_1_.getZ() && Math.abs(villagedoorinfo.func_179852_d().getY() - p_176055_1_.getY()) <= 1)
            {
    ...
    private int func_176061_a(BlockPos p_176061_1_, EnumFacing p_176061_2_, int p_176061_3_)
    {
        ...
        for (int j = 1; j <= 5; ++j)
        {
            if (this.field_75556_a.func_175678_i(p_176061_1_.offset(p_176061_2_, j)))
            {
                ++i;
    ...
    {
        IBlockState iblockstate = this.field_75556_a.getBlockState(p_176058_1_);
    ...
    {
        this.field_75553_e = nbt.getInt("Tick");
    ...
    {
        compound.putInt("Tick", this.field_75553_e);
        ...
        compound.func_74782_a("Villages", nbttaglist);
        return compound;
    }
