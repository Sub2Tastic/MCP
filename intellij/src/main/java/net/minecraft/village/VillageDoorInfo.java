...
public class VillageDoorInfo
{
    ...
    {
        int i = p_179850_1_.getX() - this.field_179859_a.getX();
        int j = p_179850_1_.getZ() - this.field_179859_a.getY();
        return i * this.field_179858_c.getXOffset() + j * this.field_179858_c.getZOffset() >= 0;
    }
    ...
    {
        return this.field_179858_c.getXOffset() * 2;
    }

    public int func_179855_g()
    {
        return this.field_179858_c.getZOffset() * 2;
    }
