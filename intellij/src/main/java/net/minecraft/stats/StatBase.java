...
public class StatBase
{
    ...
    public StatBase(String p_i45307_1_, ITextComponent p_i45307_2_, IStatType p_i45307_3_)
    {
        ...
        IScoreCriteria.INSTANCES.put(this.field_150957_c.getName(), this.field_150957_c);
    }
    ...
    {
        return this.formatter.func_75843_a(number);
    }

    public ITextComponent func_150951_e()
    {
        ITextComponent itextcomponent = this.field_75978_a.shallowCopy();
    ...
    {
        return "Stat{id=" + this.field_75975_e + ", nameId=" + this.field_75978_a + ", awardLocallyOnly=" + this.field_75972_f + ", formatter=" + this.formatter + ", objectiveCriteria=" + this.field_150957_c + '}';
    }
