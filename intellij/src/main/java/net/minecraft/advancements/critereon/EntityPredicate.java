...
public class EntityPredicate
{
    ...
    {
        this.type = p_i47541_1_;
        this.distance = p_i47541_2_;
        this.location = p_i47541_3_;
        this.effects = p_i47541_4_;
        this.nbt = p_i47541_5_;
    }
    ...
    public boolean test(EntityPlayerMP player, @Nullable Entity entity)
    {
        ...
        else if (this.type != null && !EntityList.func_180123_a(entity, this.type))
        {
            return false;
        }
