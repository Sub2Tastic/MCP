...
public class PotionUtils
{
    ...
    {
        ResourceLocation resourcelocation = PotionType.field_185176_a.getKey(potionIn);
    ...
    public static void addPotionTooltip(ItemStack itemIn, List<String> lores, float durationFactor)
    {
            ...
            for (PotionEffect potioneffect : list)
            {
                ...
                if (!map.isEmpty())
                {
                    for (Entry<IAttribute, AttributeModifier> entry : map.entrySet())
                    {
                        ...
                        AttributeModifier attributemodifier1 = new AttributeModifier(attributemodifier.getName(), potion.getAttributeModifierAmount(potioneffect.getAmplifier(), attributemodifier), attributemodifier.func_111169_c());
        ...
        if (!list1.isEmpty())
        {
            ...
            for (Tuple<String, AttributeModifier> tuple : list1)
            {
                ...
                if (d0 > 0.0D)
                {
                    lores.add(TextFormatting.BLUE + I18n.func_74837_a("attribute.modifier.plus." + attributemodifier2.func_111169_c(), ItemStack.DECIMALFORMAT.format(d1), I18n.func_74838_a("attribute.name." + (String)tuple.getA())));
                }
                else if (d0 < 0.0D)
                {
                    d1 = d1 * -1.0D;
                    lores.add(TextFormatting.RED + I18n.func_74837_a("attribute.modifier.take." + attributemodifier2.func_111169_c(), ItemStack.DECIMALFORMAT.format(d1), I18n.func_74838_a("attribute.name." + (String)tuple.getA())));
                }
            }
        }
    }
