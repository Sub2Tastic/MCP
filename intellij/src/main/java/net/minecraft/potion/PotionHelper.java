...
public class PotionHelper
{
    ...
    {
        func_193354_a(Items.POTION);
        func_193354_a(Items.SPLASH_POTION);
        func_193354_a(Items.LINGERING_POTION);
        func_193355_a(Items.POTION, Items.GUNPOWDER, Items.SPLASH_POTION);
        ...
        func_193356_a(PotionTypes.AWKWARD, Ingredient.fromStacks(new ItemStack(Items.field_151115_aP, 1, ItemFishFood.FishType.PUFFERFISH.func_150976_a())), PotionTypes.WATER_BREATHING);
    ...
    {
        func_193356_a(potionEntry, Ingredient.func_193368_a(potionIngredient), potionResult);
    }
