...
public class ItemSword extends Item
{
    ...
    public ItemSword(Item.ToolMaterial p_i45356_1_)
    {
        ...
        this.attackDamage = 3.0F + p_i45356_1_.func_78000_c();
    }
    ...
    {
        return blockIn.getBlock() == Blocks.field_150321_G;
    }
    ...
    {
        return this.field_150933_b.func_150995_f() == repair.getItem() ? true : super.getIsRepairable(toRepair, repair);
    }
