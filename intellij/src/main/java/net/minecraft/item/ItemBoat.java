...
public class ItemBoat extends Item
{
    ...
    public ItemBoat(EntityBoat.Type p_i46748_1_)
    {
        ...
        this.func_77655_b("boat." + p_i46748_1_.getName());
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            {
                Block block = worldIn.getBlockState(raytraceresult.func_178782_a()).getBlock();
                boolean flag1 = block == Blocks.WATER || block == Blocks.field_150358_i;
                ...
                if (!worldIn.func_184144_a(entityboat, entityboat.getBoundingBox().grow(-0.1D)).isEmpty())
                {
