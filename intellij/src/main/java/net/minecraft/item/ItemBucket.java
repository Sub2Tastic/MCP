...
public class ItemBucket extends Item
{
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            {
                if (!playerIn.canPlayerEdit(blockpos.offset(raytraceresult.field_178784_b), raytraceresult.field_178784_b, itemstack))
                {
                    return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
                }
                else
            ...
            else
            {
                ...
                BlockPos blockpos1 = flag1 && raytraceresult.field_178784_b == EnumFacing.UP ? blockpos : blockpos.offset(raytraceresult.field_178784_b);

                if (!playerIn.canPlayerEdit(blockpos1, raytraceresult.field_178784_b, itemstack))
                {
                    return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
                }
    ...
    public boolean tryPlaceContainedLiquid(@Nullable EntityPlayer player, World worldIn, BlockPos posIn)
    {
        ...
        else
        {
            ...
            boolean flag1 = iblockstate.getBlock().func_176200_f(worldIn, posIn);
            ...
            {
                if (worldIn.dimension.doesWaterVaporize() && this.containedBlock == Blocks.field_150358_i)
                {
                    int l = posIn.getX();
                    int i = posIn.getY();
                    int j = posIn.getZ();
                ...
                else
                {
                    ...
                    SoundEvent soundevent = this.containedBlock == Blocks.field_150356_k ? SoundEvents.ITEM_BUCKET_EMPTY_LAVA : SoundEvents.ITEM_BUCKET_EMPTY;
