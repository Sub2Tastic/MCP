...
public class ItemFishFood extends ItemFood
{
    ...
    protected void func_77849_c(ItemStack p_77849_1_, World p_77849_2_, EntityPlayer p_77849_3_)
    {
        ...
        {
            p_77849_3_.func_70690_d(new PotionEffect(MobEffects.POISON, 1200, 3));
            p_77849_3_.func_70690_d(new PotionEffect(MobEffects.HUNGER, 300, 2));
            p_77849_3_.func_70690_d(new PotionEffect(MobEffects.NAUSEA, 300, 1));
        }
    ...
    public String getTranslationKey(ItemStack stack)
    {
        ...
        return this.getTranslationKey() + "." + itemfishfood$fishtype.func_150972_b() + "." + (this.field_150907_b && itemfishfood$fishtype.func_150973_i() ? "cooked" : "raw");
    }
    ...
    public static enum FishType
    {
        ...
        {
            return p_150978_0_.getItem() instanceof ItemFishFood ? func_150974_a(p_150978_0_.func_77960_j()) : COD;
        }
