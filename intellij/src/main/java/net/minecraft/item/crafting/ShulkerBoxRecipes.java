        ...
        public ItemStack getCraftingResult(InventoryCrafting inv)
        {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i)
            {
                ...
                if (!itemstack2.isEmpty())
                {
                    ...
                    else if (itemstack2.getItem() == Items.field_151100_aR)
                    {
            ...
            ItemStack itemstack3 = BlockShulkerBox.getColoredItemStack(EnumDyeColor.func_176766_a(itemstack1.func_77960_j()));
