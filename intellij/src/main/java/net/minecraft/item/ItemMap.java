...
public class ItemMap extends ItemMapBase
{
    ...
    {
        ItemStack itemstack = new ItemStack(Items.FILLED_MAP, 1, p_190906_0_.func_72841_b("map"));
        ...
        mapdata.dimension = (byte)p_190906_0_.dimension.getType().getId();
    ...
    public MapData func_77873_a(ItemStack p_77873_1_, World p_77873_2_)
    {
        ...
        if (mapdata == null && !p_77873_2_.isRemote)
        {
            ...
            mapdata.dimension = (byte)p_77873_2_.dimension.getType().getId();
            mapdata.markDirty();
                        ...
                        if (k1 >= 0 && l1 >= -1 && k1 < 128 && l1 < 128)
                        {
                            ...
                            if (!chunk.isEmpty())
                            {
                                ...
                                if (worldIn.dimension.isNether())
                                {
                                    ...
                                    if ((l3 >> 20 & 1) == 0)
                                    {
                                        multiset.add(Blocks.DIRT.getDefaultState().func_177226_a(BlockDirt.field_176386_a, BlockDirt.DirtType.DIRT).getMaterialColor(worldIn, BlockPos.ZERO), 10);
                                    }
                                    else
                                    {
                                        multiset.add(Blocks.STONE.getDefaultState().func_177226_a(BlockStone.field_176247_a, BlockStone.EnumType.STONE).getMaterialColor(worldIn, BlockPos.ZERO), 100);
                                    }
                                            ...
                                            else
                                            {
                                                label175:
                                                {
                                                    while (true)
                                                    {
                                                        ...
                                                        blockpos$mutableblockpos.setPos((chunk.field_76635_g << 4) + i4 + i3, k4, (chunk.field_76647_h << 4) + j4 + j3);
    ...
    public static void func_190905_a(World p_190905_0_, ItemStack p_190905_1_)
    {
        ...
        {
            MapData mapdata = Items.FILLED_MAP.func_77873_a(p_190905_1_, p_190905_0_);

            if (mapdata != null)
            {
                if (p_190905_0_.dimension.getType().getId() == mapdata.dimension)
                {
