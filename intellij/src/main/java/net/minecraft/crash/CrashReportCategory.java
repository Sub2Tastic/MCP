...
public class CrashReportCategory
{
    ...
    public static void func_180523_a(CrashReportCategory p_180523_0_, final BlockPos p_180523_1_, final Block p_180523_2_, final int p_180523_3_)
    {
        ...
        p_180523_0_.addDetail("Block type", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
                try
                {
                    return String.format("ID #%d (%s // %s)", i, p_180523_2_.getTranslationKey(), p_180523_2_.getClass().getCanonicalName());
                }
        ...
        p_180523_0_.addDetail("Block data value", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
                if (p_180523_3_ < 0)
        ...
        p_180523_0_.addDetail("Block location", new ICrashReportDetail<String>()
        {
            public String call() throws Exception
            {
                return CrashReportCategory.getCoordinateInfo(p_180523_1_);
            }
        });
    }
