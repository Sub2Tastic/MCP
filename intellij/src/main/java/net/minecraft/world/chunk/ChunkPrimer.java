...
{
    private static final IBlockState field_177859_b = Blocks.AIR.getDefaultState();
    ...
    {
        IBlockState iblockstate = Block.BLOCK_STATE_IDS.getByValue(this.field_177860_a[func_186137_b(p_177856_1_, p_177856_2_, p_177856_3_)]);
    ...
    {
        this.field_177860_a[func_186137_b(p_177855_1_, p_177855_2_, p_177855_3_)] = (char)Block.BLOCK_STATE_IDS.get(p_177855_4_);
    }
    ...
    public int func_186138_a(int p_186138_1_, int p_186138_2_)
    {
        ...
        for (int j = 255; j >= 0; --j)
        {
            IBlockState iblockstate = Block.BLOCK_STATE_IDS.getByValue(this.field_177860_a[i + j]);
