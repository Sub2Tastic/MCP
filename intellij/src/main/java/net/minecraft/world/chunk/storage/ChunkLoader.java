...
public class ChunkLoader
{
    ...
    public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData converterData, NBTTagCompound compound, BiomeProvider provider)
    {
        ...
        compound.func_74782_a("Sections", nbttaglist);
        ...
        for (int l2 = 0; l2 < 16; ++l2)
        {
            for (int i3 = 0; i3 < 16; ++i3)
            {
                ...
                abyte[i3 << 4 | l2] = (byte)(Biome.func_185362_a(provider.func_180300_a(blockpos$mutableblockpos, Biomes.DEFAULT)) & 255);
            }
        }

        compound.putByteArray("Biomes", abyte);
        compound.func_74782_a("Entities", converterData.entities);
        compound.func_74782_a("TileEntities", converterData.tileEntities);

        if (converterData.tileTicks != null)
        {
            compound.func_74782_a("TileTicks", converterData.tileTicks);
        }
    }
