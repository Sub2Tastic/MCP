...
public class WorldProviderEnd extends WorldProvider
{
    ...
    {
        this.field_76578_c = new BiomeProviderSingle(Biomes.THE_END);
    ...
    {
        return this.world.getGroundAboveSeaLevel(new BlockPos(p_76566_1_, 0, p_76566_2_)).getMaterial().blocksMovement();
    }
    ...
    public void onWorldSave()
    {
        ...
        {
            nbttagcompound.func_74782_a("DragonFight", this.dragonFightManager.write());
        }
