...
public class MapStorage
{
    ...
    private void func_75747_a(WorldSavedData p_75747_1_)
    {
        if (this.field_75751_a != null)
        {
            try
            {
                File file1 = this.field_75751_a.func_75758_b(p_75747_1_.name);

                if (file1 != null)
                {
                    NBTTagCompound nbttagcompound = new NBTTagCompound();
                    nbttagcompound.func_74782_a("data", p_75747_1_.write(new NBTTagCompound()));
        ...
        else
        {
            try
            {
                ...
                if (file1 != null)
                {
                    ...
                    {
                        nbttagcompound.putShort(s, ((Short)this.field_75748_d.get(s)).shortValue());
                    }
