...
public class DragonFightManager
{
    ...
    public DragonFightManager(WorldServer worldIn, NBTTagCompound compound)
    {
        ...
        if (compound.contains("Gateways", 9))
        {
            ...
            {
                this.gateways.add(Integer.valueOf(nbttaglist.getInt(i)));
            }
        }
        else
        {
    ...
    public NBTTagCompound write()
    {
        ...
        {
            nbttagcompound.putUniqueId("DragonUUID", this.dragonUniqueId);
        }
        ...
        {
            nbttagcompound.func_74782_a("ExitPortalLocation", NBTUtil.writeBlockPos(this.exitPortalLocation));
        }
    ...
    public void tick()
    {
        ...
        if (!this.bossInfo.getPlayers().isEmpty())
        {
            if (this.scanForLegacyFight)
            {
                ...
                List<EntityDragon> list = this.world.func_175644_a(EntityDragon.class, EntitySelectors.IS_ALIVE);
            ...
            if (!this.dragonKilled)
            {
                ...
                {
                    this.func_186103_i();
                    List<EntityDragon> list1 = this.world.func_175644_a(EntityDragon.class, EntitySelectors.IS_ALIVE);
    ...
    private BlockPattern.PatternHelper findExitPortal()
    {
        ...
        int k = this.world.func_175645_m(WorldGenEndPodium.END_PODIUM_LOCATION).getY();
    ...
    private void findAliveCrystals()
    {
        ...
        {
            this.aliveCrystals += this.world.func_72872_a(EntityEnderCrystal.class, worldgenspikes$endspike.getTopBoundingBox()).size();
        }
    ...
    public void processDragonDeath(EntityDragon dragon)
    {
        if (dragon.getUniqueID().equals(this.dragonUniqueId))
        {
            ...
            {
                this.world.setBlockState(this.world.func_175645_m(WorldGenEndPodium.END_PODIUM_LOCATION), Blocks.DRAGON_EGG.getDefaultState());
            }
    ...
    private void generateGateway(BlockPos pos)
    {
        ...
        (new WorldGenEndGateway()).func_180709_b(this.world, new Random(), pos);
    }
    ...
    private void generatePortal(boolean active)
    {
        ...
        if (this.exitPortalLocation == null)
        {
            for (this.exitPortalLocation = this.world.func_175672_r(WorldGenEndPodium.END_PODIUM_LOCATION).down(); this.world.getBlockState(this.exitPortalLocation).getBlock() == Blocks.BEDROCK && this.exitPortalLocation.getY() > this.world.getSeaLevel(); this.exitPortalLocation = this.exitPortalLocation.down())
            {
                ;
            }
        }
    ...
    private EntityDragon createNewDragon()
    {
        ...
        this.world.addEntity0(entitydragon);
        this.dragonUniqueId = entitydragon.getUniqueID();
        return entitydragon;
    }
    ...
    public void tryRespawnDragon()
    {
        if (this.dragonKilled && this.respawnState == null)
        {
            ...
            {
                List<EntityEnderCrystal> list = this.world.func_72872_a(EntityEnderCrystal.class, new AxisAlignedBB(blockpos1.offset(enumfacing, 2)));
    ...
    public void resetSpikeCrystals()
    {
        for (WorldGenSpikes.EndSpike worldgenspikes$endspike : BiomeEndDecorator.func_185426_a(this.world))
        {
            for (EntityEnderCrystal entityendercrystal : this.world.func_72872_a(EntityEnderCrystal.class, worldgenspikes$endspike.getTopBoundingBox()))
            {
