...
public class BiomeTaiga extends Biome
{
    ...
    public void func_180624_a(World p_180624_1_, Random p_180624_2_, BlockPos p_180624_3_)
    {
        if (this.field_150644_aH == BiomeTaiga.Type.MEGA || this.field_150644_aH == BiomeTaiga.Type.MEGA_SPRUCE)
        {
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                BlockPos blockpos = p_180624_1_.func_175645_m(p_180624_3_.add(k, 0, l));
    ...
    public void func_180622_a(World p_180622_1_, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_)
    {
        if (this.field_150644_aH == BiomeTaiga.Type.MEGA || this.field_150644_aH == BiomeTaiga.Type.MEGA_SPRUCE)
        {
            ...
            {
                this.field_76752_A = Blocks.DIRT.getDefaultState().func_177226_a(BlockDirt.field_176386_a, BlockDirt.DirtType.COARSE_DIRT);
            }
            else if (p_180622_6_ > -0.95D)
            {
                this.field_76752_A = Blocks.DIRT.getDefaultState().func_177226_a(BlockDirt.field_176386_a, BlockDirt.DirtType.PODZOL);
            }
        }
