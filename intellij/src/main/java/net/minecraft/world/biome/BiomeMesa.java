...
{
    protected static final IBlockState field_185385_y = Blocks.DIRT.getDefaultState().func_177226_a(BlockDirt.field_176386_a, BlockDirt.DirtType.COARSE_DIRT);
    protected static final IBlockState field_185386_z = Blocks.GRASS.getDefaultState();
    protected static final IBlockState field_185381_A = Blocks.TERRACOTTA.getDefaultState();
    protected static final IBlockState field_185382_B = Blocks.field_150406_ce.getDefaultState();
    ...
    protected static final IBlockState field_185384_D = Blocks.SAND.getDefaultState().func_177226_a(BlockSand.field_176504_a, BlockSand.EnumType.RED_SAND);
    ...
    {
        if (this.field_150621_aC == null || this.field_150622_aD != p_180622_1_.getSeed())
        {
            this.func_150619_a(p_180622_1_.getSeed());
        }

        if (this.field_150623_aE == null || this.field_150624_aF == null || this.field_150622_aD != p_180622_1_.getSeed())
        {
        ...
        this.field_150622_aD = p_180622_1_.getSeed();
        double d4 = 0.0D;
        ...
        int i2 = p_180622_1_.getSeaLevel();
        ...
        {
            if (p_180622_3_.func_177856_a(l1, j1, k1).getMaterial() == Material.AIR && j1 < (int)d4)
            {
