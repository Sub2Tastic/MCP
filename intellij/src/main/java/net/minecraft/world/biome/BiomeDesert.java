...
public class BiomeDesert extends Biome
{
    public BiomeDesert(Biome.BiomeProperties p_i46711_1_)
    {
        ...
        this.field_76752_A = Blocks.SAND.getDefaultState();
        this.field_76753_B = Blocks.SAND.getDefaultState();
    ...
    public void func_180624_a(World p_180624_1_, Random p_180624_2_, BlockPos p_180624_3_)
    {
        ...
        if (p_180624_2_.nextInt(1000) == 0)
        {
            ...
            BlockPos blockpos = p_180624_1_.func_175645_m(p_180624_3_.add(i, 0, j)).up();
