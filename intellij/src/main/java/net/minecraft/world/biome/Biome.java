...
public abstract class Biome
{
    ...
    {
        return field_185377_q.getId(p_185362_0_);
    }
    ...
    {
        return MUTATION_TO_BASE_ID_MAP.getByValue(func_185362_a(biome));
    }
     ...
     */
    public final float getTemperatureRaw(BlockPos pos)
    {
        if (pos.getY() > 64)
        {
            float f = (float)(TEMPERATURE_NOISE.func_151601_a((double)((float)pos.getX() / 8.0F), (double)((float)pos.getZ() / 8.0F)) * 4.0D);
    ...
    {
        double d0 = (double)MathHelper.clamp(this.getTemperatureRaw(p_180627_1_), 0.0F, 1.0F);
        double d1 = (double)MathHelper.clamp(this.getDownfall(), 0.0F, 1.0F);
        return ColorizerGrass.get(d0, d1);
    }

    public int func_180625_c(BlockPos p_180625_1_)
    {
        double d0 = (double)MathHelper.clamp(this.getTemperatureRaw(p_180625_1_), 0.0F, 1.0F);
        double d1 = (double)MathHelper.clamp(this.getDownfall(), 0.0F, 1.0F);
        return ColorizerFoliage.get(d0, d1);
    }
            ...
            else
            {
                ...
                else if (iblockstate2.getBlock() == Blocks.STONE)
                {
                    if (j == -1)
                    {
                        ...
                        {
                            if (this.getTemperatureRaw(blockpos$mutableblockpos.setPos(p_180628_4_, j1, p_180628_5_)) < 0.15F)
                            {
    ...
    private static void func_185354_a(int p_185354_0_, String p_185354_1_, Biome p_185354_2_)
    {
        ...
        {
            MUTATION_TO_BASE_ID_MAP.put(p_185354_2_, func_185362_a(field_185377_q.getOrDefault(new ResourceLocation(p_185354_2_.parent))));
        }
    }
