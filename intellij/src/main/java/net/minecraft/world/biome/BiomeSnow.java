...
public class BiomeSnow extends Biome
{
    ...
    public BiomeSnow(boolean p_i46706_1_, Biome.BiomeProperties p_i46706_2_)
    {
        ...
        if (p_i46706_1_)
        {
            this.field_76752_A = Blocks.SNOW.getDefaultState();
        }
    ...
    public void func_180624_a(World p_180624_1_, Random p_180624_2_, BlockPos p_180624_3_)
    {
        if (this.field_150615_aC)
        {
            for (int i = 0; i < 3; ++i)
            {
                ...
                this.field_150616_aD.func_180709_b(p_180624_1_, p_180624_2_, p_180624_1_.func_175645_m(p_180624_3_.add(j, 0, k)));
            }
            ...
            for (int l = 0; l < 2; ++l)
            {
                ...
                this.field_150617_aE.func_180709_b(p_180624_1_, p_180624_2_, p_180624_1_.func_175645_m(p_180624_3_.add(i1, 0, j1)));
            }
        }
