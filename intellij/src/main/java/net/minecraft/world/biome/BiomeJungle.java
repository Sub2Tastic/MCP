...
public class BiomeJungle extends Biome
{
    ...
    private static final IBlockState field_181620_aE = Blocks.field_150364_r.getDefaultState().func_177226_a(BlockOldLog.field_176301_b, BlockPlanks.EnumType.JUNGLE);
    private static final IBlockState field_181621_aF = Blocks.field_150362_t.getDefaultState().func_177226_a(BlockOldLeaf.field_176239_P, BlockPlanks.EnumType.JUNGLE).func_177226_a(BlockLeaves.field_176236_b, Boolean.valueOf(false));
    private static final IBlockState field_181622_aG = Blocks.field_150362_t.getDefaultState().func_177226_a(BlockOldLeaf.field_176239_P, BlockPlanks.EnumType.OAK).func_177226_a(BlockLeaves.field_176236_b, Boolean.valueOf(false));
    ...
    public void func_180624_a(World p_180624_1_, Random p_180624_2_, BlockPos p_180624_3_)
    {
        ...
        int k = p_180624_2_.nextInt(p_180624_1_.func_175645_m(p_180624_3_.add(i, 0, j)).getY() * 2);
        (new WorldGenMelon()).func_180709_b(p_180624_1_, p_180624_2_, p_180624_3_.add(i, k, j));
        ...
        for (int j1 = 0; j1 < 50; ++j1)
        {
            ...
            worldgenvines.func_180709_b(p_180624_1_, p_180624_2_, p_180624_3_.add(k, 128, i1));
        }
    }
}
