...
public class BiomeDecorator
{
    ...
    protected WorldGenerator field_76810_g = new WorldGenSand(Blocks.SAND, 7);
    protected WorldGenerator field_76822_h = new WorldGenSand(Blocks.GRAVEL, 6);
    ...
    protected WorldGenerator field_76828_s = new WorldGenBush(Blocks.BROWN_MUSHROOM);
    protected WorldGenerator field_76827_t = new WorldGenBush(Blocks.RED_MUSHROOM);
