...
public class BiomePlains extends Biome
{
    ...
    {
        double d0 = INFO_NOISE.func_151601_a((double)p_180623_2_.getX() / 200.0D, (double)p_180623_2_.getZ() / 200.0D);
    ...
    {
        double d0 = INFO_NOISE.func_151601_a((double)(p_180624_3_.getX() + 8) / 200.0D, (double)(p_180624_3_.getZ() + 8) / 200.0D);
