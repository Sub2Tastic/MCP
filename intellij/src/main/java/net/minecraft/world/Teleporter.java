...
public class Teleporter
{
    ...
    public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_)
    {
        ...
        if (this.field_85191_c.containsKey(l))
        {
            ...
            teleporter$portalposition.field_85087_d = this.world.getGameTime();
            flag = false;
        }
        else
        {
        ...
        if (d0 >= 0.0D)
        {
            if (flag)
            {
                this.field_85191_c.put(l, new Teleporter.PortalPosition(blockpos, this.world.getGameTime()));
            }
    ...
    public boolean makePortal(Entity entityIn)
    {
        ...
        IBlockState iblockstate = Blocks.NETHER_PORTAL.getDefaultState().func_177226_a(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
        ...
        for (int i8 = 0; i8 < 4; ++i8)
        {
            ...
            for (int i9 = 0; i9 < 4; ++i9)
            {
                for (int i10 = -1; i10 < 4; ++i10)
                {
                    ...
                    this.world.func_175685_c(blockpos, this.world.getBlockState(blockpos).getBlock(), false);
                }
            }
        }
