...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    {
        if (this.world.dimension.func_186056_c(p_189549_1_.field_76635_g, p_189549_1_.field_76647_h))
        {
            this.field_73248_b.add(Long.valueOf(ChunkPos.asLong(p_189549_1_.field_76635_g, p_189549_1_.field_76647_h)));
    ...
    {
        long i = ChunkPos.asLong(p_186026_1_, p_186026_2_);
    ...
    public Chunk func_186028_c(int p_186028_1_, int p_186028_2_)
    {
        ...
        if (chunk == null)
        {
            ...
            if (chunk != null)
            {
                this.field_73244_f.put(ChunkPos.asLong(p_186028_1_, p_186028_2_), chunk);
                chunk.func_76631_c();
                chunk.func_186030_a(this, this.generator);
            }
        }
    ...
    public Chunk func_186025_d(int p_186025_1_, int p_186025_2_)
    {
        ...
        if (chunk == null)
        {
            ...
            try
            {
                chunk = this.generator.func_185932_a(p_186025_1_, p_186025_2_);
            }
            catch (Throwable throwable)
            {
                CrashReport crashreport = CrashReport.makeCrashReport(throwable, "Exception generating new chunk");
                CrashReportCategory crashreportcategory = crashreport.makeCategory("Chunk to be generated");
                crashreportcategory.addDetail("Location", String.format("%d,%d", p_186025_1_, p_186025_2_));
    ...
    private Chunk func_73239_e(int p_73239_1_, int p_73239_2_)
    {
        try
        {
            Chunk chunk = this.field_73247_e.func_75815_a(this.world, p_73239_1_, p_73239_2_);

            if (chunk != null)
            {
                chunk.setLastSaveTime(this.world.getGameTime());
                this.generator.func_180514_a(chunk, p_73239_1_, p_73239_2_);
            }
    ...
    private void func_73243_a(Chunk p_73243_1_)
    {
        try
        {
            this.field_73247_e.func_75819_b(this.world, p_73243_1_);
        }
        catch (Exception exception)
        {
    ...
    private void func_73242_b(Chunk p_73242_1_)
    {
        try
        {
            p_73242_1_.setLastSaveTime(this.world.getGameTime());
            this.field_73247_e.func_75816_a(this.world, p_73242_1_);
        }
    ...
    {
        return this.generator.getPossibleCreatures(creatureType, pos);
    }

    @Nullable
    public BlockPos func_180513_a(World p_180513_1_, String p_180513_2_, BlockPos p_180513_3_, boolean p_180513_4_)
    {
        return this.generator.func_180513_a(p_180513_1_, p_180513_2_, p_180513_3_, p_180513_4_);
    }

    public boolean func_193413_a(World p_193413_1_, String p_193413_2_, BlockPos p_193413_3_)
    {
        return this.generator.func_193414_a(p_193413_1_, p_193413_2_, p_193413_3_);
    }
    ...
    {
        return this.field_73244_f.containsKey(ChunkPos.asLong(x, z));
    }

    public boolean func_191062_e(int p_191062_1_, int p_191062_2_)
    {
        return this.field_73244_f.containsKey(ChunkPos.asLong(p_191062_1_, p_191062_2_)) || this.field_73247_e.func_191063_a(p_191062_1_, p_191062_2_);
    }
}
