...
public class ChunkGeneratorOverworld implements IChunkGenerator
{
    ...
    public ChunkGeneratorOverworld(World p_i46668_1_, long p_i46668_2_, boolean p_i46668_4_, String p_i46668_5_)
    {
        ...
        this.field_185997_p = p_i46668_1_.getWorldInfo().getGenerator();
        ...
        if (p_i46668_5_ != null)
        {
            ...
            this.field_186001_t = this.field_186000_s.field_177778_E ? Blocks.LAVA.getDefaultState() : Blocks.WATER.getDefaultState();
    ...
    {
        this.field_185989_h = this.depthNoise.func_76305_a(this.field_185989_h, p_185978_1_, p_185978_3_, 5, 5, (double)this.field_186000_s.field_177808_e, (double)this.field_186000_s.field_177803_f, (double)this.field_186000_s.field_177804_g);
            ...
            for (int l = 0; l < 5; ++l)
            {
                ...
                for (int j1 = -2; j1 <= 2; ++j1)
                {
                    for (int k1 = -2; k1 <= 2; ++k1)
                    {
                        ...
                        float f5 = this.field_186000_s.field_177813_n + biome1.getDepth() * this.field_186000_s.field_177819_m;
                        float f6 = this.field_186000_s.field_177843_p + biome1.getScale() * this.field_186000_s.field_177815_o;
    ...
    public void func_185931_b(int p_185931_1_, int p_185931_2_)
    {
        ...
        Biome biome = this.field_185995_n.func_180494_b(blockpos.add(16, 0, 16));
        ...
        if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.field_186000_s.field_177781_A && !flag && this.field_185990_i.nextInt(this.field_186000_s.field_177782_B) == 0)
        {
        ...
        if (!flag && this.field_185990_i.nextInt(this.field_186000_s.field_177777_D / 10) == 0 && this.field_186000_s.field_177783_C)
        {
            ...
            if (l2 < this.field_185995_n.getSeaLevel() || this.field_185990_i.nextInt(this.field_186000_s.field_177777_D / 8) == 0)
            {
    ...
    public boolean func_185933_a(Chunk p_185933_1_, int p_185933_2_, int p_185933_3_)
    {
        ...
        if (this.field_186000_s.field_177852_y && this.field_185996_o && p_185933_1_.getInhabitedTime() < 3600L)
        {
    ...
    {
        Biome biome = this.field_185995_n.func_180494_b(pos);
        ...
        if (this.field_185996_o)
        {
            ...
            if (creatureType == EnumCreatureType.MONSTER && this.field_186000_s.field_177852_y && this.field_185980_B.isPositionInStructure(this.field_185995_n, pos))
            {
