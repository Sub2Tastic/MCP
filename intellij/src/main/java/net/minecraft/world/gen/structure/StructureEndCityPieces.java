...
public class StructureEndCityPieces
{
    ...
    private static final PlacementSettings INSERT = (new PlacementSettings()).setIgnoreEntities(true).func_186225_a(Blocks.AIR);
    ...
    public static class CityTemplate extends StructureComponentTemplate
    {
        ...
        protected void func_143012_a(NBTTagCompound p_143012_1_)
        {
            ...
            p_143012_1_.putString("Template", this.pieceName);
            p_143012_1_.putString("Rot", this.rotation.name());
            p_143012_1_.putBoolean("OW", this.overwrite);
        }
