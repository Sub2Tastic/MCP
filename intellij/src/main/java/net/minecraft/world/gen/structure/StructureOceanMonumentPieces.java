...
public class StructureOceanMonumentPieces
{
    ...
    public static class DoubleXRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            {
                this.generateDefaultFloor(p_74875_1_, p_74875_3_, 8, 0, structureoceanmonumentpieces$roomdefinition.hasOpening[EnumFacing.DOWN.getIndex()]);
                this.generateDefaultFloor(p_74875_1_, p_74875_3_, 0, 0, structureoceanmonumentpieces$roomdefinition1.hasOpening[EnumFacing.DOWN.getIndex()]);
            }
    ...
    public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            if (this.roomDefinition.index / 25 > 0)
            {
                this.generateDefaultFloor(p_74875_1_, p_74875_3_, 0, 8, structureoceanmonumentpieces$roomdefinition.hasOpening[EnumFacing.DOWN.getIndex()]);
                this.generateDefaultFloor(p_74875_1_, p_74875_3_, 0, 0, structureoceanmonumentpieces$roomdefinition1.hasOpening[EnumFacing.DOWN.getIndex()]);
            }
    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            for (StructureOceanMonumentPieces.Piece structureoceanmonumentpieces$piece : this.childPieces)
            {
                if (structureoceanmonumentpieces$piece.getBoundingBox().intersectsWith(p_74875_3_))
                {
    ...
    {
        protected static final IBlockState ROUGH_PRISMARINE = Blocks.PRISMARINE.func_176203_a(BlockPrismarine.field_176331_b);
        protected static final IBlockState BRICKS_PRISMARINE = Blocks.PRISMARINE.func_176203_a(BlockPrismarine.field_176333_M);
        protected static final IBlockState DARK_PRISMARINE = Blocks.PRISMARINE.func_176203_a(BlockPrismarine.field_176334_N);
        ...
        protected boolean spawnElder(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_)
        {
            ...
            if (p_175817_2_.isVecInside(new BlockPos(i, j, k)))
            {
                ...
                entityelderguardian.func_180482_a(worldIn.getDifficultyForLocation(new BlockPos(entityelderguardian)), (IEntityLivingData)null);
            ...
            for (int i = 1; i <= 6; ++i)
            {
                for (int j = 1; j <= 6; ++j)
                {
                    if (p_74875_2_.nextInt(3) != 0)
                    {
                        ...
                        this.fillWithBlocks(p_74875_1_, p_74875_3_, i, k, j, i, 3, j, Blocks.SPONGE.func_176203_a(1), Blocks.SPONGE.func_176203_a(1), false);
                    }
                }
            }
