...
{
    private static final IBlockState field_181640_a = Blocks.field_150363_s.getDefaultState().func_177226_a(BlockNewLog.field_176300_b, BlockPlanks.EnumType.DARK_OAK);
    private static final IBlockState field_181641_b = Blocks.field_150361_u.getDefaultState().func_177226_a(BlockNewLeaf.field_176240_P, BlockPlanks.EnumType.DARK_OAK).func_177226_a(BlockLeaves.field_176236_b, Boolean.valueOf(false));
    ...
    public boolean func_180709_b(World p_180709_1_, Random p_180709_2_, BlockPos p_180709_3_)
    {
        ...
        if (k >= 1 && k + i + 1 < 256)
        {
            ...
            else
            {
                ...
                this.func_175921_a(p_180709_1_, blockpos.east());
                this.func_175921_a(p_180709_1_, blockpos.south());
                this.func_175921_a(p_180709_1_, blockpos.south().east());
                ...
                for (int j2 = 0; j2 < i; ++j2)
                {
                    ...
                    Material material = p_180709_1_.getBlockState(blockpos1).getMaterial();
    ...
    private boolean func_181638_a(World p_181638_1_, BlockPos p_181638_2_, int p_181638_3_)
    {
        ...
        for (int l = 0; l <= p_181638_3_ + 1; ++l)
        {
            ...
            for (int j1 = -i1; j1 <= i1; ++j1)
            {
                ...
                {
                    if (!this.func_150523_a(p_181638_1_.getBlockState(blockpos$mutableblockpos.setPos(i + j1, j + l, k + k1)).getBlock()))
                    {
                        return false;
                    }
                }
    ...
    private void func_150526_a(World p_150526_1_, int p_150526_2_, int p_150526_3_, int p_150526_4_)
    {
        ...
        Material material = p_150526_1_.getBlockState(blockpos).getMaterial();
