...
public class ChunkGeneratorHell implements IChunkGenerator
{
    ...
    public void func_185931_b(int p_185931_1_, int p_185931_2_)
    {
        ...
        Biome biome = this.field_185952_n.func_180494_b(blockpos.add(16, 0, 16));
        ...
        {
            this.field_177473_x.func_180709_b(this.field_185952_n, this.field_185954_p, blockpos.add(this.field_185954_p.nextInt(16), this.field_185954_p.nextInt(108) + 10, this.field_185954_p.nextInt(16)));
        }
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        ...
        Biome biome = this.field_185952_n.func_180494_b(pos);
