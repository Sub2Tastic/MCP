...
{
    protected static final IBlockState field_186126_a = Blocks.LAVA.getDefaultState();
    protected static final IBlockState field_186127_b = Blocks.AIR.getDefaultState();
    protected static final IBlockState field_186128_c = Blocks.SANDSTONE.getDefaultState();
    protected static final IBlockState field_186129_d = Blocks.RED_SANDSTONE.getDefaultState();
                        ...
                        for (int k1 = i3; !flag3 && k1 < i1; ++k1)
                        {
                            for (int l1 = l + 1; !flag3 && l1 >= l2 - 1; --l1)
                            {
                                if (l1 >= 0 && l1 < 256)
                                {
                                    ...
                                    if (iblockstate.getBlock() == Blocks.field_150358_i || iblockstate.getBlock() == Blocks.WATER)
                                    {
                                        flag3 = true;
                                    }
                                        ...
                                        if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D)
                                        {
                                            ...
                                            if (this.func_175793_a(iblockstate1, iblockstate2))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (flag1 && p_180702_5_.func_177856_a(j3, j2 - 1, i2).getBlock() == Blocks.DIRT)
                                                    {
                                                        blockpos$mutableblockpos.setPos(j3 + p_180702_3_ * 16, 0, i2 + p_180702_4_ * 16);
                                                        p_180702_5_.func_177855_a(j3, j2 - 1, i2, this.field_75039_c.func_180494_b(blockpos$mutableblockpos).field_76752_A.getBlock().getDefaultState());
                                                    }
                                                }
                                            }
                                        }
    ...
    protected boolean func_175793_a(IBlockState p_175793_1_, IBlockState p_175793_2_)
    {
        ...
        else if (p_175793_1_.getBlock() == Blocks.field_150406_ce)
        {
            return true;
        }
        ...
        else if (p_175793_1_.getBlock() == Blocks.field_150431_aC)
        {
            return true;
        }
        else
