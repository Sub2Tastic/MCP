...
public class ChunkGeneratorEnd implements IChunkGenerator
{
    ...
    protected static final IBlockState field_185965_b = Blocks.AIR.getDefaultState();
    ...
    public void func_185931_b(int p_185931_1_, int p_185931_2_)
    {
        ...
        this.field_73230_p.func_180494_b(blockpos.add(16, 0, 16)).func_180624_a(this.field_73230_p, this.field_73230_p.rand, blockpos);
    ...
    {
        return this.field_73230_p.func_180494_b(pos).getSpawns(creatureType);
    }
