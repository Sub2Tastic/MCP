...
public class WorldGenFlowers extends WorldGenerator
{
    ...
    public void func_175914_a(BlockFlower p_175914_1_, BlockFlower.EnumFlowerType p_175914_2_)
    {
        ...
        this.field_175915_b = p_175914_1_.getDefaultState().func_177226_a(p_175914_1_.func_176494_l(), p_175914_2_);
    }
    ...
    public boolean func_180709_b(World p_180709_1_, Random p_180709_2_, BlockPos p_180709_3_)
    {
        for (int i = 0; i < 64; ++i)
        {
            ...
            if (p_180709_1_.isAirBlock(blockpos) && (!p_180709_1_.dimension.isNether() || blockpos.getY() < 255) && this.field_150552_a.func_180671_f(p_180709_1_, blockpos, this.field_175915_b))
            {
                p_180709_1_.setBlockState(blockpos, this.field_175915_b, 2);
            }
        }
