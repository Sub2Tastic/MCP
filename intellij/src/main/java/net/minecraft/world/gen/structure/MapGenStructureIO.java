...
public class MapGenStructureIO
{
    ...
    public static StructureStart func_143035_a(NBTTagCompound p_143035_0_, World p_143035_1_)
    {
        ...
        try
        {
            Class <? extends StructureStart > oclass = (Class)field_143040_a.get(p_143035_0_.getString("id"));
        ...
        {
            LOGGER.warn("Failed Start with id {}", (Object)p_143035_0_.getString("id"));
        ...
        {
            LOGGER.warn("Skipping Structure with id {}", (Object)p_143035_0_.getString("id"));
        }
    ...
    public static StructureComponent func_143032_b(NBTTagCompound p_143032_0_, World p_143032_1_)
    {
        ...
        try
        {
            Class <? extends StructureComponent > oclass = (Class)field_143039_c.get(p_143032_0_.getString("id"));
