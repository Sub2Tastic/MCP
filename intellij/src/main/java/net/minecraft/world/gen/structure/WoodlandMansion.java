    ...
    public static class Start extends StructureStart
    {
        ...
        private void func_191092_a(World p_191092_1_, ChunkGeneratorOverworld p_191092_2_, Random p_191092_3_, int p_191092_4_, int p_191092_5_)
        {
            ...
            else
            {
                ...
                WoodlandMansionPieces.generateMansion(p_191092_1_.func_72860_G().getStructureTemplateManager(), blockpos, rotation, list, p_191092_3_);
        ...
        public void func_75068_a(World p_75068_1_, Random p_75068_2_, StructureBoundingBox p_75068_3_)
        {
            ...
            for (int j = p_75068_3_.minX; j <= p_75068_3_.maxX; ++j)
            {
                for (int k = p_75068_3_.minZ; k <= p_75068_3_.maxZ; ++k)
                {
                    ...
                    if (!p_75068_1_.isAirBlock(blockpos) && this.bounds.isVecInside(blockpos))
                    {
                        boolean flag = false;
