...
public class WorldGenMinable extends WorldGenerator
{
    ...
    public boolean func_180709_b(World p_180709_1_, Random p_180709_2_, BlockPos p_180709_3_)
    {
        ...
        double d0 = (double)((float)(p_180709_3_.getX() + 8) + MathHelper.sin(f) * (float)this.field_76541_b / 8.0F);
        double d1 = (double)((float)(p_180709_3_.getX() + 8) - MathHelper.sin(f) * (float)this.field_76541_b / 8.0F);
        double d2 = (double)((float)(p_180709_3_.getZ() + 8) + MathHelper.cos(f) * (float)this.field_76541_b / 8.0F);
        double d3 = (double)((float)(p_180709_3_.getZ() + 8) - MathHelper.cos(f) * (float)this.field_76541_b / 8.0F);
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int j2 = l; j2 <= k1; ++j2)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    ...
                                    if (this.field_175919_c.apply(p_180709_1_.getBlockState(blockpos)))
                                    {
                                        p_180709_1_.setBlockState(blockpos, this.field_175920_a, 2);
                                    }
                                }
                            }
                        }
    ...
    static class StonePredicate implements Predicate<IBlockState>
    {
        ...
        public boolean apply(IBlockState p_apply_1_)
        {
            ...
            {
                BlockStone.EnumType blockstone$enumtype = (BlockStone.EnumType)p_apply_1_.get(BlockStone.field_176247_a);
