        ...
        if (p_76308_9_ == 1)
        {
            ...
            for (int j2 = 0; j2 < p_76308_8_; ++j2)
            {
                ...
                for (int j6 = 0; j6 < p_76308_10_; ++j6)
                {
                    ...
                    d14 = this.func_76311_b(d18, this.func_76309_a(this.permutations[j5], d17, d19), this.func_76310_a(this.permutations[k5], d17 - 1.0D, 0.0D, d19));
                    d15 = this.func_76311_b(d18, this.func_76310_a(this.permutations[j5 + 1], d17, 0.0D, d19 - 1.0D), this.func_76310_a(this.permutations[k5 + 1], d17 - 1.0D, 0.0D, d19 - 1.0D));
                ...
                for (int k3 = 0; k3 < p_76308_10_; ++k3)
                {
                    ...
                    for (int j4 = 0; j4 < p_76308_9_; ++j4)
                    {
                        ...
                        if (j4 == 0 || l4 != k)
                        {
                            ...
                            d1 = this.func_76311_b(d6, this.func_76310_a(this.permutations[i1], d5, d9, d7), this.func_76310_a(this.permutations[l1], d5 - 1.0D, d9, d7));
                            d2 = this.func_76311_b(d6, this.func_76310_a(this.permutations[j1], d5, d9 - 1.0D, d7), this.func_76310_a(this.permutations[i2], d5 - 1.0D, d9 - 1.0D, d7));
                            d3 = this.func_76311_b(d6, this.func_76310_a(this.permutations[i1 + 1], d5, d9, d7 - 1.0D), this.func_76310_a(this.permutations[l1 + 1], d5 - 1.0D, d9, d7 - 1.0D));
                            d4 = this.func_76311_b(d6, this.func_76310_a(this.permutations[j1 + 1], d5, d9 - 1.0D, d7 - 1.0D), this.func_76310_a(this.permutations[i2 + 1], d5 - 1.0D, d9 - 1.0D, d7 - 1.0D));
                        }
