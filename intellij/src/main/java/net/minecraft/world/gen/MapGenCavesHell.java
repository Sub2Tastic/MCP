...
{
    protected static final IBlockState field_186130_a = Blocks.AIR.getDefaultState();
                    ...
                    for (int j1 = j2; !flag2 && j1 < k; ++j1)
                    {
                        for (int k1 = l2; !flag2 && k1 < i1; ++k1)
                        {
                            for (int l1 = l + 1; !flag2 && l1 >= k2 - 1; --l1)
                            {
                                if (l1 >= 0 && l1 < 128)
                                {
                                    IBlockState iblockstate = p_180704_5_.func_177856_a(j1, l1, k1);

                                    if (iblockstate.getBlock() == Blocks.field_150356_k || iblockstate.getBlock() == Blocks.LAVA)
                                    {
                                        flag2 = true;
                                    }
    ...
    {
        int i = this.field_75038_b.nextInt(this.field_75038_b.nextInt(this.field_75038_b.nextInt(10) + 1) + 1);
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            {
                this.func_180705_a(this.field_75038_b.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, d0, d1, d2);
            ...
            for (int l = 0; l < k; ++l)
            {
                ...
                this.func_180704_a(this.field_75038_b.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, d0, d1, d2, f2 * 2.0F, f, f1, 0, 0, 0.5D);
            }
        }
    }
}
