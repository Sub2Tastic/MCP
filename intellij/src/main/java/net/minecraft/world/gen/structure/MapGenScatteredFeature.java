...
{
    private static final List<Biome> field_75061_e = Arrays.<Biome>asList(Biomes.DESERT, Biomes.DESERT_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_HILLS, Biomes.SWAMP, Biomes.SNOWY_TUNDRA, Biomes.SNOWY_TAIGA);
    ...
    public MapGenScatteredFeature(Map<String, String> p_i2061_1_)
    {
        ...
        for (Entry<String, String> entry : p_i2061_1_.entrySet())
        {
            ...
            {
                this.field_82669_g = MathHelper.getInt(entry.getValue(), this.field_82669_g, 9);
            }
        }
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World p_i47072_1_, Random p_i47072_2_, int p_i47072_3_, int p_i47072_4_, Biome p_i47072_5_)
        {
            ...
            if (p_i47072_5_ != Biomes.JUNGLE && p_i47072_5_ != Biomes.JUNGLE_HILLS)
            {
                ...
                {
                    if (p_i47072_5_ == Biomes.SNOWY_TUNDRA || p_i47072_5_ == Biomes.SNOWY_TAIGA)
                    {
