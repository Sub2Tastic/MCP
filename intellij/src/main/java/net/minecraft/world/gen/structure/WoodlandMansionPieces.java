...
public class WoodlandMansionPieces
{
    ...
    static class Grid
    {
        ...
        private void recursiveCorridor(WoodlandMansionPieces.SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, EnumFacing p_191110_4_, int p_191110_5_)
        {
            if (p_191110_5_ > 0)
            {
                ...
                p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset(), 0, 1);
                ...
                p_191110_1_.func_191141_a(p_191110_2_ + enumfacing1.getXOffset(), p_191110_3_ + enumfacing1.getZOffset(), 0, 2);
                p_191110_1_.func_191141_a(p_191110_2_ + enumfacing2.getXOffset(), p_191110_3_ + enumfacing2.getZOffset(), 0, 2);
                p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getXOffset() + enumfacing1.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset() + enumfacing1.getZOffset(), 0, 2);
                p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getXOffset() + enumfacing2.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset() + enumfacing2.getZOffset(), 0, 2);
                p_191110_1_.func_191141_a(p_191110_2_ + p_191110_4_.getXOffset() * 2, p_191110_3_ + p_191110_4_.getZOffset() * 2, 0, 2);
                p_191110_1_.func_191141_a(p_191110_2_ + enumfacing1.getXOffset() * 2, p_191110_3_ + enumfacing1.getZOffset() * 2, 0, 2);
                p_191110_1_.func_191141_a(p_191110_2_ + enumfacing2.getXOffset() * 2, p_191110_3_ + enumfacing2.getZOffset() * 2, 0, 2);
            }
        }
    ...
    public static class MansionTemplate extends StructureComponentTemplate
    {
        ...
        {
            Template template = p_191081_1_.func_186237_a((MinecraftServer)null, new ResourceLocation("mansion/" + this.templateName));
        ...
        protected void func_143012_a(NBTTagCompound p_143012_1_)
        {
            ...
            p_143012_1_.putString("Template", this.templateName);
            p_143012_1_.putString("Rot", this.placeSettings.getRotation().name());
            p_143012_1_.putString("Mi", this.placeSettings.getMirror().name());
        }
        ...
        protected void handleDataMarker(String function, BlockPos pos, World worldIn, Random rand, StructureBoundingBox sbb)
        {
            if (function.startsWith("Chest"))
            {
                ...
                {
                    iblockstate = iblockstate.func_177226_a(BlockChest.FACING, rotation.rotate(EnumFacing.WEST));
                }
                else if ("ChestEast".equals(function))
                {
                    iblockstate = iblockstate.func_177226_a(BlockChest.FACING, rotation.rotate(EnumFacing.EAST));
                }
                else if ("ChestSouth".equals(function))
                {
                    iblockstate = iblockstate.func_177226_a(BlockChest.FACING, rotation.rotate(EnumFacing.SOUTH));
                }
                else if ("ChestNorth".equals(function))
                {
                    iblockstate = iblockstate.func_177226_a(BlockChest.FACING, rotation.rotate(EnumFacing.NORTH));
                }
            ...
            else if ("Warrior".equals(function))
            {
                ...
                entityvindicator.func_180482_a(worldIn.getDifficultyForLocation(new BlockPos(entityvindicator)), (IEntityLivingData)null);
