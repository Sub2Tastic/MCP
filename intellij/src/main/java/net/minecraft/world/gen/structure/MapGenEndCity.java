...
public class MapGenEndCity extends MapGenStructure
{
    ...
    protected boolean func_75047_a(int p_75047_1_, int p_75047_2_)
    {
        ...
        {
            int i1 = getYPosForStructure(i, j, this.field_186133_d);
            return i1 >= 60;
        }
        else
        {
    ...
    private static int getYPosForStructure(int chunkX, int chunkY, ChunkGeneratorEnd generatorIn)
    {
        ...
        generatorIn.func_180518_a(chunkX, chunkY, chunkprimer);
        int i = 5;
        int j = 5;
    ...
    public static class Start extends StructureStart
    {
        ...
        private void func_186162_a(World p_186162_1_, ChunkGeneratorEnd p_186162_2_, Random p_186162_3_, int p_186162_4_, int p_186162_5_)
        {
            ...
            Rotation rotation = Rotation.values()[random.nextInt(Rotation.values().length)];
            int i = MapGenEndCity.getYPosForStructure(p_186162_4_, p_186162_5_, p_186162_2_);
            ...
            else
            {
                ...
                StructureEndCityPieces.startHouseTower(p_186162_1_.func_72860_G().getStructureTemplateManager(), blockpos, rotation, this.components, p_186162_3_);
                this.func_75072_c();
