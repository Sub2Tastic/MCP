    ...
    public static class StartMonument extends StructureStart
    {
        ...
        public void func_75068_a(World p_75068_1_, Random p_75068_2_, StructureBoundingBox p_75068_3_)
        {
            if (!this.wasCreated)
            {
                ...
                this.func_175789_b(p_75068_1_, p_75068_2_, this.getChunkPosX(), this.getChunkPosZ());
            }
        ...
        public void func_143017_b(NBTTagCompound p_143017_1_)
        {
            ...
            {
                NBTTagList nbttaglist = p_143017_1_.getList("Processed", 10);

                for (int i = 0; i < nbttaglist.func_74745_c(); ++i)
                {
                    NBTTagCompound nbttagcompound = nbttaglist.getCompound(i);
                    this.field_175791_c.add(new ChunkPos(nbttagcompound.getInt("X"), nbttagcompound.getInt("Z")));
                }
            }
        }
    }
