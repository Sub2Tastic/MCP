...
public class StructureMineshaftPieces
{
    ...
    public static class Corridor extends StructureMineshaftPieces.Peice
    {
        ...
        protected void func_143012_a(NBTTagCompound p_143012_1_)
        {
            ...
            p_143012_1_.putBoolean("hr", this.hasRails);
            p_143012_1_.putBoolean("sc", this.hasSpiders);
            p_143012_1_.putBoolean("hps", this.spawnerPlaced);
            p_143012_1_.putInt("Num", this.sectionCount);
        }
        ...
        protected boolean generateChest(World worldIn, StructureBoundingBox structurebb, Random randomIn, int x, int y, int z, ResourceLocation loot)
        {
            ...
            {
                IBlockState iblockstate = Blocks.RAIL.getDefaultState().func_177226_a(BlockRail.SHAPE, randomIn.nextBoolean() ? BlockRailBase.EnumRailDirection.NORTH_SOUTH : BlockRailBase.EnumRailDirection.EAST_WEST);
        ...
        public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            else
            {
                ...
                this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 0, 0, 2, 1, i1, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
                this.generateMaybeBox(p_74875_1_, p_74875_3_, p_74875_2_, 0.8F, 0, 2, 0, 2, 2, i1, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);

                if (this.hasSpiders)
                {
                    this.generateMaybeBox(p_74875_1_, p_74875_3_, p_74875_2_, 0.6F, 0, 0, 0, 2, 1, i1, Blocks.field_150321_G.getDefaultState(), Blocks.AIR.getDefaultState(), false, 8);
                }
                ...
                for (int j1 = 0; j1 < this.sectionCount; ++j1)
                {
                    ...
                    if (this.hasSpiders && !this.spawnerPlaced)
                    {
                        ...
                        if (p_74875_3_.isVecInside(blockpos) && this.getSkyBrightness(p_74875_1_, 1, 0, i2, p_74875_3_) < 8)
                        {
                ...
                for (int l2 = 0; l2 <= 2; ++l2)
                {
                    for (int i3 = 0; i3 <= i1; ++i3)
                    {
                        ...
                        if (iblockstate3.getMaterial() == Material.AIR && this.getSkyBrightness(p_74875_1_, l2, -1, i3, p_74875_3_) < 8)
                        {
                            int l3 = -1;
                ...
                if (this.hasRails)
                {
                    IBlockState iblockstate1 = Blocks.RAIL.getDefaultState().func_177226_a(BlockRail.SHAPE, BlockRailBase.EnumRailDirection.NORTH_SOUTH);

                    for (int j3 = 0; j3 <= i1; ++j3)
                    {
                        IBlockState iblockstate2 = this.getBlockStateFromPos(p_74875_1_, 1, -1, j3, p_74875_3_);

                        if (iblockstate2.getMaterial() != Material.AIR && iblockstate2.func_185913_b())
                        {
                            float f = this.getSkyBrightness(p_74875_1_, 1, 0, j3, p_74875_3_) > 8 ? 0.9F : 0.7F;
        ...
        private void placeSupport(World p_189921_1_, StructureBoundingBox p_189921_2_, int p_189921_3_, int p_189921_4_, int p_189921_5_, int p_189921_6_, int p_189921_7_, Random p_189921_8_)
        {
            if (this.isSupportingBox(p_189921_1_, p_189921_2_, p_189921_3_, p_189921_7_, p_189921_6_, p_189921_5_))
            {
                ...
                else
                {
                    ...
                    this.randomlyPlaceBlock(p_189921_1_, p_189921_2_, p_189921_8_, 0.05F, p_189921_3_ + 1, p_189921_6_, p_189921_5_ - 1, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.NORTH));
                    this.randomlyPlaceBlock(p_189921_1_, p_189921_2_, p_189921_8_, 0.05F, p_189921_3_ + 1, p_189921_6_, p_189921_5_ + 1, Blocks.TORCH.getDefaultState().func_177226_a(BlockTorch.field_176596_a, EnumFacing.SOUTH));
                }
            }
        }
        ...
        private void placeCobWeb(World p_189922_1_, StructureBoundingBox p_189922_2_, Random p_189922_3_, float p_189922_4_, int p_189922_5_, int p_189922_6_, int p_189922_7_)
        {
            ...
            {
                this.randomlyPlaceBlock(p_189922_1_, p_189922_2_, p_189922_3_, p_189922_4_, p_189922_5_, p_189922_6_, p_189922_7_, Blocks.field_150321_G.getDefaultState());
            }
        }
    }
    ...
    public static class Cross extends StructureMineshaftPieces.Peice
    {
        ...
        {
            super.func_143012_a(p_143012_1_);
            p_143012_1_.putBoolean("tf", this.isMultipleFloors);
            p_143012_1_.putInt("D", this.corridorDirection.getHorizontalIndex());
        }
        ...
        public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            else
            {
                ...
                for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i)
                {
                    ...
                    {
                        if (this.getBlockStateFromPos(p_74875_1_, i, this.boundingBox.minY - 1, j, p_74875_3_).getMaterial() == Material.AIR && this.getSkyBrightness(p_74875_1_, i, this.boundingBox.minY - 1, j, p_74875_3_) < 8)
                        {
    ...
    abstract static class Peice extends StructureComponent
    {
        ...
        protected void func_143012_a(NBTTagCompound p_143012_1_)
        {
            p_143012_1_.putInt("MST", this.mineShaftType.ordinal());
        }
        ...
        protected IBlockState getPlanksBlock()
        {
            switch (this.mineShaftType)
            {
                case NORMAL:
                default:
                    return Blocks.field_150344_f.getDefaultState();

                case MESA:
                    return Blocks.field_150344_f.getDefaultState().func_177226_a(BlockPlanks.field_176383_a, BlockPlanks.EnumType.DARK_OAK);
            }
        }
    ...
    public static class Room extends StructureMineshaftPieces.Peice
    {
        ...
        public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            {
                this.fillWithBlocks(p_74875_1_, p_74875_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.minY, this.boundingBox.maxZ, Blocks.DIRT.getDefaultState(), Blocks.AIR.getDefaultState(), true);
                ...
                {
                    this.fillWithBlocks(p_74875_1_, p_74875_3_, structureboundingbox.minX, structureboundingbox.maxY - 2, structureboundingbox.minZ, structureboundingbox.maxX, structureboundingbox.maxY, structureboundingbox.maxZ, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
                }
