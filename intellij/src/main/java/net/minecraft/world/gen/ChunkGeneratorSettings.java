...
public class ChunkGeneratorSettings
{
    ...
    public static class Factory
    {
        ...
        public static ChunkGeneratorSettings.Factory func_177865_a(String p_177865_0_)
        {
            ...
            else
            {
                try
                {
                    return (ChunkGeneratorSettings.Factory)JsonUtils.fromJson(field_177901_a, p_177865_0_, ChunkGeneratorSettings.Factory.class);
                }
    ...
    public static class Serializer implements JsonDeserializer<ChunkGeneratorSettings.Factory>, JsonSerializer<ChunkGeneratorSettings.Factory>
    {
        public ChunkGeneratorSettings.Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            try
            {
                chunkgeneratorsettings$factory.field_177899_b = JsonUtils.getFloat(jsonobject, "coordinateScale", chunkgeneratorsettings$factory.field_177899_b);
                chunkgeneratorsettings$factory.field_177900_c = JsonUtils.getFloat(jsonobject, "heightScale", chunkgeneratorsettings$factory.field_177900_c);
                chunkgeneratorsettings$factory.field_177898_e = JsonUtils.getFloat(jsonobject, "lowerLimitScale", chunkgeneratorsettings$factory.field_177898_e);
                chunkgeneratorsettings$factory.field_177896_d = JsonUtils.getFloat(jsonobject, "upperLimitScale", chunkgeneratorsettings$factory.field_177896_d);
                chunkgeneratorsettings$factory.field_177893_f = JsonUtils.getFloat(jsonobject, "depthNoiseScaleX", chunkgeneratorsettings$factory.field_177893_f);
                chunkgeneratorsettings$factory.field_177894_g = JsonUtils.getFloat(jsonobject, "depthNoiseScaleZ", chunkgeneratorsettings$factory.field_177894_g);
                chunkgeneratorsettings$factory.field_177915_h = JsonUtils.getFloat(jsonobject, "depthNoiseScaleExponent", chunkgeneratorsettings$factory.field_177915_h);
                chunkgeneratorsettings$factory.field_177917_i = JsonUtils.getFloat(jsonobject, "mainNoiseScaleX", chunkgeneratorsettings$factory.field_177917_i);
                chunkgeneratorsettings$factory.field_177911_j = JsonUtils.getFloat(jsonobject, "mainNoiseScaleY", chunkgeneratorsettings$factory.field_177911_j);
                chunkgeneratorsettings$factory.field_177913_k = JsonUtils.getFloat(jsonobject, "mainNoiseScaleZ", chunkgeneratorsettings$factory.field_177913_k);
                chunkgeneratorsettings$factory.field_177907_l = JsonUtils.getFloat(jsonobject, "baseSize", chunkgeneratorsettings$factory.field_177907_l);
                chunkgeneratorsettings$factory.field_177909_m = JsonUtils.getFloat(jsonobject, "stretchY", chunkgeneratorsettings$factory.field_177909_m);
                chunkgeneratorsettings$factory.field_177903_n = JsonUtils.getFloat(jsonobject, "biomeDepthWeight", chunkgeneratorsettings$factory.field_177903_n);
                chunkgeneratorsettings$factory.field_177905_o = JsonUtils.getFloat(jsonobject, "biomeDepthOffset", chunkgeneratorsettings$factory.field_177905_o);
                chunkgeneratorsettings$factory.field_177933_p = JsonUtils.getFloat(jsonobject, "biomeScaleWeight", chunkgeneratorsettings$factory.field_177933_p);
                chunkgeneratorsettings$factory.field_177931_q = JsonUtils.getFloat(jsonobject, "biomeScaleOffset", chunkgeneratorsettings$factory.field_177931_q);
                chunkgeneratorsettings$factory.field_177929_r = JsonUtils.getInt(jsonobject, "seaLevel", chunkgeneratorsettings$factory.field_177929_r);
                chunkgeneratorsettings$factory.field_177927_s = JsonUtils.getBoolean(jsonobject, "useCaves", chunkgeneratorsettings$factory.field_177927_s);
                chunkgeneratorsettings$factory.field_177925_t = JsonUtils.getBoolean(jsonobject, "useDungeons", chunkgeneratorsettings$factory.field_177925_t);
                chunkgeneratorsettings$factory.field_177923_u = JsonUtils.getInt(jsonobject, "dungeonChance", chunkgeneratorsettings$factory.field_177923_u);
                chunkgeneratorsettings$factory.field_177921_v = JsonUtils.getBoolean(jsonobject, "useStrongholds", chunkgeneratorsettings$factory.field_177921_v);
                chunkgeneratorsettings$factory.field_177919_w = JsonUtils.getBoolean(jsonobject, "useVillages", chunkgeneratorsettings$factory.field_177919_w);
                chunkgeneratorsettings$factory.field_177944_x = JsonUtils.getBoolean(jsonobject, "useMineShafts", chunkgeneratorsettings$factory.field_177944_x);
                chunkgeneratorsettings$factory.field_177942_y = JsonUtils.getBoolean(jsonobject, "useTemples", chunkgeneratorsettings$factory.field_177942_y);
                chunkgeneratorsettings$factory.field_177940_z = JsonUtils.getBoolean(jsonobject, "useMonuments", chunkgeneratorsettings$factory.field_177940_z);
                ...
                chunkgeneratorsettings$factory.field_177870_A = JsonUtils.getBoolean(jsonobject, "useRavines", chunkgeneratorsettings$factory.field_177870_A);
                chunkgeneratorsettings$factory.field_177871_B = JsonUtils.getBoolean(jsonobject, "useWaterLakes", chunkgeneratorsettings$factory.field_177871_B);
                chunkgeneratorsettings$factory.field_177872_C = JsonUtils.getInt(jsonobject, "waterLakeChance", chunkgeneratorsettings$factory.field_177872_C);
                chunkgeneratorsettings$factory.field_177866_D = JsonUtils.getBoolean(jsonobject, "useLavaLakes", chunkgeneratorsettings$factory.field_177866_D);
                chunkgeneratorsettings$factory.field_177867_E = JsonUtils.getInt(jsonobject, "lavaLakeChance", chunkgeneratorsettings$factory.field_177867_E);
                chunkgeneratorsettings$factory.field_177868_F = JsonUtils.getBoolean(jsonobject, "useLavaOceans", chunkgeneratorsettings$factory.field_177868_F);
                chunkgeneratorsettings$factory.field_177869_G = JsonUtils.getInt(jsonobject, "fixedBiome", chunkgeneratorsettings$factory.field_177869_G);

                if (chunkgeneratorsettings$factory.field_177869_G < 38 && chunkgeneratorsettings$factory.field_177869_G >= -1)
                {
                    if (chunkgeneratorsettings$factory.field_177869_G >= Biome.func_185362_a(Biomes.NETHER))
                    {
                ...
                chunkgeneratorsettings$factory.field_177877_H = JsonUtils.getInt(jsonobject, "biomeSize", chunkgeneratorsettings$factory.field_177877_H);
                chunkgeneratorsettings$factory.field_177878_I = JsonUtils.getInt(jsonobject, "riverSize", chunkgeneratorsettings$factory.field_177878_I);
                chunkgeneratorsettings$factory.field_177879_J = JsonUtils.getInt(jsonobject, "dirtSize", chunkgeneratorsettings$factory.field_177879_J);
                chunkgeneratorsettings$factory.field_177880_K = JsonUtils.getInt(jsonobject, "dirtCount", chunkgeneratorsettings$factory.field_177880_K);
                chunkgeneratorsettings$factory.field_177873_L = JsonUtils.getInt(jsonobject, "dirtMinHeight", chunkgeneratorsettings$factory.field_177873_L);
                chunkgeneratorsettings$factory.field_177874_M = JsonUtils.getInt(jsonobject, "dirtMaxHeight", chunkgeneratorsettings$factory.field_177874_M);
                chunkgeneratorsettings$factory.field_177875_N = JsonUtils.getInt(jsonobject, "gravelSize", chunkgeneratorsettings$factory.field_177875_N);
                chunkgeneratorsettings$factory.field_177876_O = JsonUtils.getInt(jsonobject, "gravelCount", chunkgeneratorsettings$factory.field_177876_O);
                chunkgeneratorsettings$factory.field_177886_P = JsonUtils.getInt(jsonobject, "gravelMinHeight", chunkgeneratorsettings$factory.field_177886_P);
                chunkgeneratorsettings$factory.field_177885_Q = JsonUtils.getInt(jsonobject, "gravelMaxHeight", chunkgeneratorsettings$factory.field_177885_Q);
                chunkgeneratorsettings$factory.field_177888_R = JsonUtils.getInt(jsonobject, "graniteSize", chunkgeneratorsettings$factory.field_177888_R);
                chunkgeneratorsettings$factory.field_177887_S = JsonUtils.getInt(jsonobject, "graniteCount", chunkgeneratorsettings$factory.field_177887_S);
                chunkgeneratorsettings$factory.field_177882_T = JsonUtils.getInt(jsonobject, "graniteMinHeight", chunkgeneratorsettings$factory.field_177882_T);
                chunkgeneratorsettings$factory.field_177881_U = JsonUtils.getInt(jsonobject, "graniteMaxHeight", chunkgeneratorsettings$factory.field_177881_U);
                chunkgeneratorsettings$factory.field_177884_V = JsonUtils.getInt(jsonobject, "dioriteSize", chunkgeneratorsettings$factory.field_177884_V);
                chunkgeneratorsettings$factory.field_177883_W = JsonUtils.getInt(jsonobject, "dioriteCount", chunkgeneratorsettings$factory.field_177883_W);
                chunkgeneratorsettings$factory.field_177891_X = JsonUtils.getInt(jsonobject, "dioriteMinHeight", chunkgeneratorsettings$factory.field_177891_X);
                chunkgeneratorsettings$factory.field_177890_Y = JsonUtils.getInt(jsonobject, "dioriteMaxHeight", chunkgeneratorsettings$factory.field_177890_Y);
                chunkgeneratorsettings$factory.field_177892_Z = JsonUtils.getInt(jsonobject, "andesiteSize", chunkgeneratorsettings$factory.field_177892_Z);
                chunkgeneratorsettings$factory.field_177936_aa = JsonUtils.getInt(jsonobject, "andesiteCount", chunkgeneratorsettings$factory.field_177936_aa);
                chunkgeneratorsettings$factory.field_177937_ab = JsonUtils.getInt(jsonobject, "andesiteMinHeight", chunkgeneratorsettings$factory.field_177937_ab);
                chunkgeneratorsettings$factory.field_177934_ac = JsonUtils.getInt(jsonobject, "andesiteMaxHeight", chunkgeneratorsettings$factory.field_177934_ac);
                chunkgeneratorsettings$factory.field_177935_ad = JsonUtils.getInt(jsonobject, "coalSize", chunkgeneratorsettings$factory.field_177935_ad);
                chunkgeneratorsettings$factory.field_177941_ae = JsonUtils.getInt(jsonobject, "coalCount", chunkgeneratorsettings$factory.field_177941_ae);
                chunkgeneratorsettings$factory.field_177943_af = JsonUtils.getInt(jsonobject, "coalMinHeight", chunkgeneratorsettings$factory.field_177943_af);
                chunkgeneratorsettings$factory.field_177938_ag = JsonUtils.getInt(jsonobject, "coalMaxHeight", chunkgeneratorsettings$factory.field_177938_ag);
                chunkgeneratorsettings$factory.field_177939_ah = JsonUtils.getInt(jsonobject, "ironSize", chunkgeneratorsettings$factory.field_177939_ah);
                chunkgeneratorsettings$factory.field_177922_ai = JsonUtils.getInt(jsonobject, "ironCount", chunkgeneratorsettings$factory.field_177922_ai);
                chunkgeneratorsettings$factory.field_177924_aj = JsonUtils.getInt(jsonobject, "ironMinHeight", chunkgeneratorsettings$factory.field_177924_aj);
                chunkgeneratorsettings$factory.field_177918_ak = JsonUtils.getInt(jsonobject, "ironMaxHeight", chunkgeneratorsettings$factory.field_177918_ak);
                chunkgeneratorsettings$factory.field_177920_al = JsonUtils.getInt(jsonobject, "goldSize", chunkgeneratorsettings$factory.field_177920_al);
                chunkgeneratorsettings$factory.field_177930_am = JsonUtils.getInt(jsonobject, "goldCount", chunkgeneratorsettings$factory.field_177930_am);
                chunkgeneratorsettings$factory.field_177932_an = JsonUtils.getInt(jsonobject, "goldMinHeight", chunkgeneratorsettings$factory.field_177932_an);
                chunkgeneratorsettings$factory.field_177926_ao = JsonUtils.getInt(jsonobject, "goldMaxHeight", chunkgeneratorsettings$factory.field_177926_ao);
                chunkgeneratorsettings$factory.field_177928_ap = JsonUtils.getInt(jsonobject, "redstoneSize", chunkgeneratorsettings$factory.field_177928_ap);
                chunkgeneratorsettings$factory.field_177908_aq = JsonUtils.getInt(jsonobject, "redstoneCount", chunkgeneratorsettings$factory.field_177908_aq);
                chunkgeneratorsettings$factory.field_177906_ar = JsonUtils.getInt(jsonobject, "redstoneMinHeight", chunkgeneratorsettings$factory.field_177906_ar);
                chunkgeneratorsettings$factory.field_177904_as = JsonUtils.getInt(jsonobject, "redstoneMaxHeight", chunkgeneratorsettings$factory.field_177904_as);
                chunkgeneratorsettings$factory.field_177902_at = JsonUtils.getInt(jsonobject, "diamondSize", chunkgeneratorsettings$factory.field_177902_at);
                chunkgeneratorsettings$factory.field_177916_au = JsonUtils.getInt(jsonobject, "diamondCount", chunkgeneratorsettings$factory.field_177916_au);
                chunkgeneratorsettings$factory.field_177914_av = JsonUtils.getInt(jsonobject, "diamondMinHeight", chunkgeneratorsettings$factory.field_177914_av);
                chunkgeneratorsettings$factory.field_177912_aw = JsonUtils.getInt(jsonobject, "diamondMaxHeight", chunkgeneratorsettings$factory.field_177912_aw);
                chunkgeneratorsettings$factory.field_177910_ax = JsonUtils.getInt(jsonobject, "lapisSize", chunkgeneratorsettings$factory.field_177910_ax);
                chunkgeneratorsettings$factory.field_177897_ay = JsonUtils.getInt(jsonobject, "lapisCount", chunkgeneratorsettings$factory.field_177897_ay);
                chunkgeneratorsettings$factory.field_177895_az = JsonUtils.getInt(jsonobject, "lapisCenterHeight", chunkgeneratorsettings$factory.field_177895_az);
                chunkgeneratorsettings$factory.field_177889_aA = JsonUtils.getInt(jsonobject, "lapisSpread", chunkgeneratorsettings$factory.field_177889_aA);
            }
