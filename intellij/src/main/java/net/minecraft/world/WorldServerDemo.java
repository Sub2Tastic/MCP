...
public class WorldServerDemo extends WorldServer
{
    ...
    public static final WorldSettings field_73071_a = (new WorldSettings(field_73072_L, GameType.SURVIVAL, true, false, WorldType.DEFAULT)).enableBonusChest();
    ...
    public WorldServerDemo(MinecraftServer p_i45924_1_, ISaveHandler p_i45924_2_, WorldInfo p_i45924_3_, int p_i45924_4_, Profiler p_i45924_5_)
    {
        ...
        this.worldInfo.populateFromWorldSettings(field_73071_a);
    }
}
