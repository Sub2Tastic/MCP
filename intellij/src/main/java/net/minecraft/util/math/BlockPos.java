...
public class BlockPos extends Vec3i
{
    ...
    private static final int field_177987_f = 0 + NUM_Z_BITS;
    private static final int field_177988_g = field_177987_f + NUM_Y_BITS;
    ...
    {
        return ((long)this.getX() & X_MASK) << field_177988_g | ((long)this.getY() & Y_MASK) << field_177987_f | ((long)this.getZ() & Z_MASK) << 0;
    }

    public static BlockPos func_177969_a(long p_177969_0_)
    {
        int i = (int)(p_177969_0_ << 64 - field_177988_g - NUM_X_BITS >> 64 - NUM_X_BITS);
        int j = (int)(p_177969_0_ << 64 - field_177987_f - NUM_Y_BITS >> 64 - NUM_Y_BITS);
    ...
    {
        return func_191532_a(Math.min(p_177980_0_.getX(), p_177980_1_.getX()), Math.min(p_177980_0_.getY(), p_177980_1_.getY()), Math.min(p_177980_0_.getZ(), p_177980_1_.getZ()), Math.max(p_177980_0_.getX(), p_177980_1_.getX()), Math.max(p_177980_0_.getY(), p_177980_1_.getY()), Math.max(p_177980_0_.getZ(), p_177980_1_.getZ()));
    }
            ...
            public Iterator<BlockPos.MutableBlockPos> iterator()
            {
                return new AbstractIterator<BlockPos.MutableBlockPos>()
                {
                    ...
                    protected BlockPos.MutableBlockPos computeNext()
                    {
                        ...
                        {
                            this.field_179314_b = new BlockPos.MutableBlockPos(x1, y1, z1);
                            return this.field_179314_b;
                        }
                        else if (this.field_179314_b.x == x2 && this.field_179314_b.y == y2 && this.field_179314_b.z == z2)
                        {
                            return (BlockPos.MutableBlockPos)this.endOfData();
                        }
                        else
                        {
                            if (this.field_179314_b.x < x2)
                            {
                                ++this.field_179314_b.x;
                            }
                            else if (this.field_179314_b.y < y2)
                            {
                                this.field_179314_b.x = x1;
                                ++this.field_179314_b.y;
                            }
                            else if (this.field_179314_b.z < z2)
                            {
                                this.field_179314_b.x = x1;
                                this.field_179314_b.y = y1;
                                ++this.field_179314_b.z;
                            }
    ...
    public static final class PooledMutableBlockPos extends BlockPos.MutableBlockPos
    {
        ...
        {
            return retain(p_185342_0_.getX(), p_185342_0_.getY(), p_185342_0_.getZ());
        }
