...
public class Vec3d
{
    ...
    {
        double d0 = p_72429_1_.x - this.x;
        double d1 = p_72429_1_.y - this.y;
        double d2 = p_72429_1_.z - this.z;
        ...
        {
            double d3 = (p_72429_2_ - this.x) / d0;
    ...
    {
        double d0 = p_72435_1_.x - this.x;
        double d1 = p_72435_1_.y - this.y;
        double d2 = p_72435_1_.z - this.z;
        ...
        {
            double d3 = (p_72435_2_ - this.y) / d1;
            return d3 >= 0.0D && d3 <= 1.0D ? new Vec3d(this.x + d0 * d3, this.y + d1 * d3, this.z + d2 * d3) : null;
        }
    }
    ...
    {
        double d0 = p_72434_1_.x - this.x;
        double d1 = p_72434_1_.y - this.y;
        double d2 = p_72434_1_.z - this.z;
        ...
        {
            double d3 = (p_72434_2_ - this.z) / d2;
            return d3 >= 0.0D && d3 <= 1.0D ? new Vec3d(this.x + d0 * d3, this.y + d1 * d3, this.z + d2 * d3) : null;
        }
    }
