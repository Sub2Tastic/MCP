...
public class TextComponentTranslation extends TextComponentBase
{
    ...
    synchronized void ensureInitialized()
    {
        ...
        try
        {
            this.initializeFromFormat(I18n.func_74838_a(this.key));
        }
        catch (TextComponentTranslationFormatException textcomponenttranslationformatexception)
        {
            ...
            try
            {
                this.initializeFromFormat(I18n.func_150826_b(this.key));
            }
    ...
    public Iterator<ITextComponent> iterator()
    {
        ...
        return Iterators.<ITextComponent>concat(func_150262_a(this.children), func_150262_a(this.siblings));
    }
