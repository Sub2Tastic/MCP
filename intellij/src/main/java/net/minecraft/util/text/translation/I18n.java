...
public class I18n
{
    private static final LanguageMap field_74839_a = LanguageMap.getInstance();
    private static final LanguageMap field_150828_b = new LanguageMap();

    @Deprecated
    public static String func_74838_a(String p_74838_0_)
    {
        return field_74839_a.translateKey(p_74838_0_);
    }
    ...
    {
        return field_74839_a.getLastUpdateTimeInMilliseconds();
    }
}
