...
public class TextComponentUtils
{
    public static ITextComponent func_179985_a(ICommandSender p_179985_0_, ITextComponent p_179985_1_, Entity p_179985_2_) throws CommandException
    {
        ...
        {
            String s1 = ((TextComponentSelector)p_179985_1_).getSelector();
        ...
        {
            itextcomponent = new TextComponentString(((TextComponentString)p_179985_1_).getText());
        }
        else if (p_179985_1_ instanceof TextComponentKeybind)
        {
            itextcomponent = new TextComponentKeybind(((TextComponentKeybind)p_179985_1_).getKeybind());
        }
        else
        {
            ...
            Object[] aobject = ((TextComponentTranslation)p_179985_1_).getFormatArgs();
            ...
            itextcomponent = new TextComponentTranslation(((TextComponentTranslation)p_179985_1_).getKey(), aobject);
        }

        Style style = p_179985_1_.getStyle();
        ...
        for (ITextComponent itextcomponent1 : p_179985_1_.getSiblings())
        {
            itextcomponent.appendSibling(func_179985_a(p_179985_0_, itextcomponent1, p_179985_2_));
        }
