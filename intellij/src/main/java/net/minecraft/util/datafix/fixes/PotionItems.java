...
public class PotionItems implements IFixableData
{
    ...
    {
        if ("minecraft:potion".equals(p_188217_1_.getString("id")))
        {
            NBTTagCompound nbttagcompound = p_188217_1_.getCompound("tag");
            short short1 = p_188217_1_.getShort("Damage");
            ...
            if (!nbttagcompound.contains("Potion", 8))
            {
                ...
                {
                    p_188217_1_.putString("id", "minecraft:splash_potion");
                }
            }

            if (short1 != 0)
            {
                p_188217_1_.putShort("Damage", (short)0);
            }
        }
