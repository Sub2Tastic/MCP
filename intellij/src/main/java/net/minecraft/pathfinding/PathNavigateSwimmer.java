...
public class PathNavigateSwimmer extends PathNavigate
{
    ...
    {
        return new Vec3d(this.entity.posX, this.entity.posY + (double)this.entity.field_70131_O * 0.5D, this.entity.posZ);
    }

    protected void pathFollow()
    {
        Vec3d vec3d = this.getEntityPosition();
        float f = this.entity.field_70130_N * this.entity.field_70130_N;
        int i = 6;
    ...
    {
        RayTraceResult raytraceresult = this.world.func_147447_a(posVec31, new Vec3d(posVec32.x, posVec32.y + (double)this.entity.field_70131_O * 0.5D, posVec32.z), false, true, false);
        return raytraceresult == null || raytraceresult.field_72313_a == RayTraceResult.Type.MISS;
    }

    public boolean canEntityStandOnPos(BlockPos pos)
    {
        return !this.world.getBlockState(pos).func_185913_b();
    }
}
