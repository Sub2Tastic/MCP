...
public class PathNavigateGround extends PathNavigate
{
    ...
    {
        return this.entity.onGround || this.func_179684_h() && this.isInLiquid() || this.entity.isPassenger();
    }
    ...
    public Path getPathToPos(BlockPos pos)
    {
        if (this.world.getBlockState(pos).getMaterial() == Material.AIR)
        {
            ...
            while (blockpos.getY() < this.world.func_72800_K() && this.world.getBlockState(blockpos).getMaterial() == Material.AIR)
            {
        ...
        else
        {
            ...
            for (blockpos1 = pos.up(); blockpos1.getY() < this.world.func_72800_K() && this.world.getBlockState(blockpos1).getMaterial().isSolid(); blockpos1 = blockpos1.up())
            {
                ;
            }
    ...
    {
        if (this.entity.isInWater() && this.func_179684_h())
        {
            ...
            while (block == Blocks.field_150358_i || block == Blocks.WATER)
            {
                ++i;
    ...
    protected void trimPath()
    {
        ...
        {
            if (this.world.func_175678_i(new BlockPos(MathHelper.floor(this.entity.posX), (int)(this.entity.getBoundingBox().minY + 0.5D), MathHelper.floor(this.entity.posZ))))
            {
                return;
            }
            ...
            for (int i = 0; i < this.currentPath.getCurrentPathLength(); ++i)
            {
                ...
                if (this.world.func_175678_i(new BlockPos(pathpoint.x, pathpoint.y, pathpoint.z)))
                {
    ...
    {
        for (BlockPos blockpos : BlockPos.func_177980_a(new BlockPos(x, y, z), new BlockPos(x + sizeX - 1, y + sizeY - 1, z + sizeZ - 1)))
        {
            ...
            if (d0 * p_179692_8_ + d1 * p_179692_10_ >= 0.0D)
            {
                ...
                if (!block.func_176205_b(this.world, blockpos))
                {
                    return false;
                }
            }
    ...
    {
        this.nodeProcessor.setCanSwim(p_179693_1_);
    }
