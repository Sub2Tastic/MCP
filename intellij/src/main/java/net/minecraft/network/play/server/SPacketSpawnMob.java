...
public class SPacketSpawnMob implements Packet<INetHandlerPlayClient>
{
    ...
    public SPacketSpawnMob(EntityLivingBase entityIn)
    {
        ...
        this.type = EntityList.field_191308_b.getId(entityIn.getClass());
        ...
        double d0 = 3.9D;
        double d1 = entityIn.field_70159_w;
        double d2 = entityIn.field_70181_x;
        ...
        this.field_149043_l = entityIn.getDataManager();
    }
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        this.field_149044_m = EntityDataManager.readEntries(buf);
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        this.field_149043_l.func_187216_a(buf);
    }
