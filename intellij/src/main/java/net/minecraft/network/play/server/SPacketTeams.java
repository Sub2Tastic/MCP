...
public class SPacketTeams implements Packet<INetHandlerPlayClient>
{
    ...
    public SPacketTeams(ScorePlayerTeam teamIn, int actionIn)
    {
        ...
        if (actionIn == 0 || actionIn == 2)
        {
            ...
            this.field_149319_c = teamIn.func_96668_e();
            this.field_149316_d = teamIn.func_96663_f();
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        if (this.action == 0 || this.action == 2)
        {
            ...
            this.field_149319_c = buf.readString(16);
            this.field_149316_d = buf.readString(16);
