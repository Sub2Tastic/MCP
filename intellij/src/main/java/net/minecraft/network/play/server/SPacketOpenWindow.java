...
public class SPacketOpenWindow implements Packet<INetHandlerPlayClient>
{
    ...
    {
        this.field_148909_a = buf.readUnsignedByte();
        this.field_148907_b = buf.readString(32);
        this.field_148908_c = buf.readTextComponent();
        this.field_148905_d = buf.readUnsignedByte();

        if (this.field_148907_b.equals("EntityHorse"))
        {
            this.field_148904_f = buf.readInt();
        }
    }
    ...
    {
        buf.writeByte(this.field_148909_a);
        buf.writeString(this.field_148907_b);
        buf.writeTextComponent(this.field_148908_c);
        buf.writeByte(this.field_148905_d);

        if (this.field_148907_b.equals("EntityHorse"))
        {
            buf.writeInt(this.field_148904_f);
        }
    }
