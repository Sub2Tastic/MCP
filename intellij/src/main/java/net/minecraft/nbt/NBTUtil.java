...
public final class NBTUtil
{
    ...
    public static NBTTagCompound writeGameProfile(NBTTagCompound tagCompound, GameProfile profile)
    {
        ...
        if (!profile.getProperties().isEmpty())
        {
            ...
            tagCompound.func_74782_a("Properties", nbttagcompound);
        }
    ...
    public static IBlockState readBlockState(NBTTagCompound tag)
    {
        ...
        {
            Block block = Block.field_149771_c.getOrDefault(new ResourceLocation(tag.getString("Name")));
    ...
    {
        tag.putString("Name", ((ResourceLocation)Block.field_149771_c.getKey(p_190009_1_.getBlock())).toString());
        ...
        if (!p_190009_1_.func_177228_b().isEmpty())
        {
            ...
            tag.func_74782_a("Properties", nbttagcompound);
        }
