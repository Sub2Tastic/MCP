...
public class EntityAIWatchClosest extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                this.closestEntity = this.entity.world.getClosestPlayer(this.entity.posX, this.entity.posY, this.entity.posZ, (double)this.maxDistance, Predicates.and(EntitySelectors.NOT_SPECTATING, EntitySelectors.func_191324_b(this.entity)));
            }
            else
            {
                this.closestEntity = this.entity.world.func_72857_a(this.watchedClass, this.entity.getBoundingBox().grow((double)this.maxDistance, 3.0D, (double)this.maxDistance), this.entity);
            }
