...
public class EntityAIFleeSun extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else if (!this.world.func_175678_i(new BlockPos(this.creature.posX, this.creature.getBoundingBox().minY, this.creature.posZ)))
        {
            return false;
        }
    ...
    private Vec3d findPossibleShelter()
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            if (!this.world.func_175678_i(blockpos1) && this.creature.getBlockPathWeight(blockpos1) < 0.0F)
            {
