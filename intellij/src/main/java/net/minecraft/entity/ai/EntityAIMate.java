...
public class EntityAIMate extends EntityAIBase
{
    ...
    {
        List<EntityAnimal> list = this.world.<EntityAnimal>func_72872_a(this.mateClass, this.animal.getBoundingBox().grow(8.0D));
    ...
    private void spawnBaby()
    {
        ...
        if (entityageable != null)
        {
            ...
            for (int i = 0; i < 7; ++i)
            {
                ...
                double d3 = random.nextDouble() * (double)this.animal.field_70130_N * 2.0D - (double)this.animal.field_70130_N;
                double d4 = 0.5D + random.nextDouble() * (double)this.animal.field_70131_O;
                double d5 = random.nextDouble() * (double)this.animal.field_70130_N * 2.0D - (double)this.animal.field_70130_N;
                this.world.func_175688_a(EnumParticleTypes.HEART, this.animal.posX + d3, this.animal.posY + d4, this.animal.posZ + d5, d0, d1, d2);
            }
