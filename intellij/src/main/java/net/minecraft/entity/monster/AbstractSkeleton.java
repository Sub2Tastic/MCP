...
{
    private static final DataParameter<Boolean> field_184728_b = EntityDataManager.<Boolean>createKey(AbstractSkeleton.class, DataSerializers.BOOLEAN);
    ...
    {
        super.registerData();
        this.dataManager.register(field_184728_b, Boolean.valueOf(false));
    }
    ...
    public void livingTick()
    {
        if (this.world.isDaytime() && !this.world.isRemote)
        {
            ...
            if (f > 0.5F && this.rand.nextFloat() * 30.0F < (f - 0.4F) * 2.0F && this.world.func_175678_i(blockpos))
            {
                boolean flag = true;
    ...
    {
        return ((Boolean)this.dataManager.get(field_184728_b)).booleanValue();
    }

    public void func_184724_a(boolean p_184724_1_)
    {
        this.dataManager.set(field_184728_b, Boolean.valueOf(p_184724_1_));
    }
}
