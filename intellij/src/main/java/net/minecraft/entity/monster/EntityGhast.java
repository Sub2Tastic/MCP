...
public class EntityGhast extends EntityFlying implements IMob
{
    ...
    {
        return this.rand.nextInt(20) == 0 && super.func_70601_bi() && this.world.getDifficulty() != EnumDifficulty.PEACEFUL;
    }
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.putInt("ExplosionPower", this.explosionStrength);
    }
        ...
        public void tick()
        {
            ...
            if (entitylivingbase.getDistanceSq(this.parentEntity) < 4096.0D && this.parentEntity.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.attackTimer == 20)
                {
                    ...
                    double d3 = entitylivingbase.getBoundingBox().minY + (double)(entitylivingbase.field_70131_O / 2.0F) - (0.5D + this.parentEntity.posY + (double)(this.parentEntity.field_70131_O / 2.0F));
                    ...
                    entitylargefireball.posY = this.parentEntity.posY + (double)(this.parentEntity.field_70131_O / 2.0F) + 0.5D;
    ...
    static class AILookAround extends EntityAIBase
    {
        ...
        public void tick()
        {
            ...
            {
                this.parentEntity.rotationYaw = -((float)MathHelper.atan2(this.parentEntity.field_70159_w, this.parentEntity.field_70179_y)) * (180F / (float)Math.PI);
    ...
    static class GhastMoveHelper extends EntityMoveHelper
    {
        ...
        public void tick()
        {
            if (this.action == EntityMoveHelper.Action.MOVE_TO)
            {
                ...
                if (this.courseChangeCooldown-- <= 0)
                {
                    ...
                    {
                        this.parentEntity.field_70159_w += d0 / d3 * 0.1D;
                        this.parentEntity.field_70181_x += d1 / d3 * 0.1D;
                        this.parentEntity.field_70179_y += d2 / d3 * 0.1D;
                    }
                    else
                    {
        ...
        private boolean func_179926_b(double p_179926_1_, double p_179926_3_, double p_179926_5_, double p_179926_7_)
        {
            ...
            for (int i = 1; (double)i < p_179926_7_; ++i)
            {
                ...
                if (!this.parentEntity.world.func_184144_a(this.parentEntity, axisalignedbb).isEmpty())
                {
                    return false;
                }
            }
