...
public class EntityWitch extends EntityMob implements IRangedAttackMob
{
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(3, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
    ...
    public void livingTick()
    {
        if (!this.world.isRemote)
        {
            ...
            else
            {
                ...
                if (this.rand.nextFloat() < 0.15F && this.func_70055_a(Material.WATER) && !this.isPotionActive(MobEffects.WATER_BREATHING))
                {
    ...
    public void handleStatusUpdate(byte id)
    {
        if (id == 15)
        {
            ...
            {
                this.world.func_175688_a(EnumParticleTypes.SPELL_WITCH, this.posX + this.rand.nextGaussian() * 0.12999999523162842D, this.getBoundingBox().maxY + 0.5D + this.rand.nextGaussian() * 0.12999999523162842D, this.posZ + this.rand.nextGaussian() * 0.12999999523162842D, 0.0D, 0.0D, 0.0D);
            }
        }
        else
        {
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor)
    {
        if (!this.isDrinkingPotion())
        {
            ...
            double d1 = target.posX + target.field_70159_w - this.posX;
            double d2 = d0 - this.posY;
            double d3 = target.posZ + target.field_70179_y - this.posZ;
            ...
            this.world.addEntity0(entitypotion);
        }
    }
