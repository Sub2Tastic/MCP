...
public abstract class EntitySpellcasterIllager extends AbstractIllager
{
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.putInt("SpellTicks", this.spellTicks);
    }
    ...
    public void tick()
    {
        ...
        if (this.world.isRemote && this.isSpellcasting())
        {
            ...
            this.world.func_175688_a(EnumParticleTypes.SPELL_MOB, this.posX + (double)f1 * 0.6D, this.posY + 1.8D, this.posZ + (double)f2 * 0.6D, d0, d1, d2);
            this.world.func_175688_a(EnumParticleTypes.SPELL_MOB, this.posX - (double)f1 * 0.6D, this.posY + 1.8D, this.posZ - (double)f2 * 0.6D, d0, d1, d2);
        }
    }
