...
public class EntityItemFrame extends EntityHanging
{
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        {
            p_70014_1_.func_74782_a("Item", this.getDisplayedItem().write(new NBTTagCompound()));
            p_70014_1_.putByte("ItemRotation", (byte)this.getRotation());
            p_70014_1_.putFloat("ItemDropChance", this.itemDropChance);
        }
