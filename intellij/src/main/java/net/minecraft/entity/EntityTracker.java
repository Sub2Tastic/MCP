...
public class EntityTracker
{
    ...
    public EntityTracker(WorldServer p_i1516_1_)
    {
        ...
        this.field_72792_d = p_i1516_1_.getServer().getPlayerList().func_72372_a();
    }
    ...
    public void func_72785_a(Entity p_72785_1_, int p_72785_2_, final int p_72785_3_, boolean p_72785_4_)
    {
        try
        {
            if (this.field_72794_c.func_76037_b(p_72785_1_.getEntityId()))
            {
            ...
            this.field_72794_c.func_76038_a(p_72785_1_.getEntityId(), entitytrackerentry);
        ...
        catch (Throwable throwable)
        {
            ...
            crashreportcategory.addDetail("Tracking range", p_72785_2_ + " blocks");
            ...
            ((EntityTrackerEntry)this.field_72794_c.func_76041_a(p_72785_1_.getEntityId())).func_187260_b().fillCrashReport(crashreport.makeCategory("Entity That Is Already Tracked"));
    ...
    public void func_72790_b(Entity p_72790_1_)
    {
        ...
        EntityTrackerEntry entitytrackerentry1 = this.field_72794_c.func_76049_d(p_72790_1_.getEntityId());
    ...
    {
        EntityTrackerEntry entitytrackerentry = this.field_72794_c.func_76041_a(p_151247_1_.getEntityId());
    ...
    {
        EntityTrackerEntry entitytrackerentry = this.field_72794_c.func_76041_a(p_151248_1_.getEntityId());
    ...
    public void func_85172_a(EntityPlayerMP p_85172_1_, Chunk p_85172_2_)
    {
        ...
        for (EntityTrackerEntry entitytrackerentry : this.field_72793_b)
        {
            ...
            if (entity != p_85172_1_ && entity.chunkCoordX == p_85172_2_.field_76635_g && entity.chunkCoordZ == p_85172_2_.field_76647_h)
            {
