...
public class EntityList
{
    ...
    {
        return field_191308_b.getKey(p_191306_0_);
    }

    @Nullable
    public static String func_75621_b(Entity p_75621_0_)
    {
        int i = field_191308_b.getId(p_75621_0_.getClass());
    ...
    {
        int i = field_191308_b.getId(field_191308_b.getOrDefault(p_191302_0_));
        return i == -1 ? null : (String)field_191311_g.get(i);
    }
    ...
    {
        return (Class)field_191308_b.getOrDefault(new ResourceLocation(p_192839_0_));
    }
    ...
    {
        return func_191304_a(field_191308_b.getOrDefault(p_188429_0_), p_188429_1_);
    }

    @Nullable
    public static Entity func_75615_a(NBTTagCompound p_75615_0_, World p_75615_1_)
    {
        ResourceLocation resourcelocation = new ResourceLocation(p_75615_0_.getString("id"));
