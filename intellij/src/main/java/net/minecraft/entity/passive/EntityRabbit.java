...
public class EntityRabbit extends EntityAnimal
{
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(3, new EntityAITempt(this, 1.0D, Item.getItemFromBlock(Blocks.field_150327_N), false));
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.putInt("RabbitType", this.getRabbitType());
        p_70014_1_.putInt("MoreCarrotTicks", this.carrotTicks);
    }
    ...
    {
        return itemIn == Items.CARROT || itemIn == Items.GOLDEN_CARROT || itemIn == Item.getItemFromBlock(Blocks.field_150327_N);
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, @Nullable IEntityLivingData p_180482_2_)
    {
        ...
        {
            i = ((EntityRabbit.RabbitTypeData)p_180482_2_).typeData;
            flag = true;
        }
        else
        {
    ...
    {
        Biome biome = this.world.func_180494_b(new BlockPos(this));
    ...
    protected void func_175528_cn()
    {
        ...
        this.world.func_175688_a(EnumParticleTypes.BLOCK_DUST, this.posX + (double)(this.rand.nextFloat() * this.field_70130_N * 2.0F) - (double)this.field_70130_N, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.field_70131_O), this.posZ + (double)(this.rand.nextFloat() * this.field_70130_N * 2.0F) - (double)this.field_70130_N, 0.0D, 0.0D, 0.0D, Block.func_176210_f(iblockstate));
        this.carrotTicks = 40;
    }
    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
    {
        ...
        public boolean shouldExecute()
        {
            if (this.runDelay <= 0)
            {
                if (!this.rabbit.world.getGameRules().func_82766_b("mobGriefing"))
                {
                    return false;
                }
        ...
        public void tick()
        {
            ...
            if (this.getIsAboveDestination())
            {
                ...
                if (this.canRaid && block instanceof BlockCarrot)
                {
                    ...
                    {
                        world.setBlockState(blockpos, iblockstate.func_177226_a(BlockCarrot.AGE, Integer.valueOf(integer.intValue() - 1)), 2);
                        world.func_175718_b(2001, blockpos, Block.func_176210_f(iblockstate));
                    }

                    this.rabbit.func_175528_cn();
                }
