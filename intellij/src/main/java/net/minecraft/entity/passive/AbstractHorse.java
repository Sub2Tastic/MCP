...
public abstract class AbstractHorse extends EntityAnimal implements IInventoryChangedListener, IJumpingMount
{
    ...
    protected AbstractHorse func_110250_a(Entity p_110250_1_, double p_110250_2_)
    {
        ...
        for (Entity entity1 : this.world.getEntitiesInAABBexcluding(p_110250_1_, p_110250_1_.getBoundingBox().expand(p_110250_2_, p_110250_2_, p_110250_2_), IS_HORSE_BREEDING))
        {
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.putBoolean("EatingHaystack", this.isEatingHaystack());
        p_70014_1_.putBoolean("Bred", this.isBreeding());
        p_70014_1_.putInt("Temper", this.getTemper());
        p_70014_1_.putBoolean("Tame", this.isTame());

        if (this.getOwnerUniqueId() != null)
        {
            p_70014_1_.putString("OwnerUUID", this.getOwnerUniqueId().toString());
        }

        if (!this.horseChest.getStackInSlot(0).isEmpty())
        {
            p_70014_1_.func_74782_a("SaddleItem", this.horseChest.getStackInSlot(0).write(new NBTTagCompound()));
        }
    }
    ...
    protected void spawnHorseParticles(boolean p_110216_1_)
    {
        ...
        for (int i = 0; i < 7; ++i)
        {
            ...
            this.world.func_175688_a(enumparticletypes, this.posX + (double)(this.rand.nextFloat() * this.field_70130_N * 2.0F) - (double)this.field_70130_N, this.posY + 0.5D + (double)(this.rand.nextFloat() * this.field_70131_O), this.posZ + (double)(this.rand.nextFloat() * this.field_70130_N * 2.0F) - (double)this.field_70130_N, d0, d1, d2);
        }
    }
