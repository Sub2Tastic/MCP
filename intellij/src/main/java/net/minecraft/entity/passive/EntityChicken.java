...
public class EntityChicken extends EntityAnimal
{
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.putBoolean("IsChickenJockey", this.chickenJockey);
        p_70014_1_.putInt("EggLayTime", this.timeUntilNextEgg);
    }
    ...
    public void updatePassenger(Entity passenger)
    {
        ...
        float f2 = 0.1F;
        float f3 = 0.0F;
        passenger.setPosition(this.posX + (double)(0.1F * f), this.posY + (double)(this.field_70131_O * 0.5F) + passenger.getYOffset() + 0.0D, this.posZ - (double)(0.1F * f1));
