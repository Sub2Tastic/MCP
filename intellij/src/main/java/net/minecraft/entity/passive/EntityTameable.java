...
public abstract class EntityTameable extends EntityAnimal implements IEntityOwnable
{
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        {
            p_70014_1_.putString("OwnerUUID", "");
        }
        else
        {
            p_70014_1_.putString("OwnerUUID", this.getOwnerId().toString());
        }

        p_70014_1_.putBoolean("Sitting", this.isSitting());
    }
    ...
    {
        if (!this.world.isRemote && this.world.getGameRules().func_82766_b("showDeathMessages") && this.getOwner() instanceof EntityPlayerMP)
        {
