            ...
            if (this.attackTarget.getDistanceSq(this.dragon) < 4096.0D)
            {
                if (this.dragon.canEntityBeSeen(this.attackTarget))
                {
                    ...
                    if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F)
                    {
                        ...
                        double d7 = this.dragon.dragonPartHead.posY + (double)(this.dragon.dragonPartHead.field_70131_O / 2.0F) + 0.5D;
                        double d8 = this.dragon.dragonPartHead.posZ - vec3d2.z * 1.0D;
                        double d9 = this.attackTarget.posX - d6;
                        double d10 = this.attackTarget.posY + (double)(this.attackTarget.field_70131_O / 2.0F) - (d7 + (double)(this.dragon.dragonPartHead.field_70131_O / 2.0F));
                        double d11 = this.attackTarget.posZ - d8;
                        this.dragon.world.func_180498_a((EntityPlayer)null, 1017, new BlockPos(this.dragon), 0);
