...
public class PhaseSittingFlaming extends PhaseSittingBase
{
    ...
    public void clientTick()
    {
        ...
        if (this.flameTicks % 2 == 0 && this.flameTicks < 10)
        {
            ...
            for (int i = 0; i < 8; ++i)
            {
                ...
                for (int j = 0; j < 6; ++j)
                {
                    this.dragon.world.func_175688_a(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.x * 0.07999999821186066D * (double)j, -vec3d.y * 0.6000000238418579D, -vec3d.z * 0.07999999821186066D * (double)j);
                }
    ...
    public void serverTick()
    {
        ...
        else if (this.flameTicks == 10)
        {
            ...
            double d2 = this.dragon.dragonPartHead.posY + (double)(this.dragon.dragonPartHead.field_70131_O / 2.0F);
