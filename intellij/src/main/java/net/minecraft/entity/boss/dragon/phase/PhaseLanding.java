...
public class PhaseLanding extends PhaseBase
{
    ...
    public void clientTick()
    {
        ...
        double d1 = this.dragon.dragonPartHead.posY + (double)(this.dragon.dragonPartHead.field_70131_O / 2.0F);
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            this.dragon.world.func_175688_a(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.x * 0.07999999821186066D + this.dragon.field_70159_w, -vec3d.y * 0.30000001192092896D + this.dragon.field_70181_x, -vec3d.z * 0.07999999821186066D + this.dragon.field_70179_y);
    ...
    public void serverTick()
    {
        ...
        {
            this.targetLocation = new Vec3d(this.dragon.world.func_175672_r(WorldGenEndPodium.END_PODIUM_LOCATION));
        }
