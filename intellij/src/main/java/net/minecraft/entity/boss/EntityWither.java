...
public class EntityWither extends EntityMob implements IRangedAttackMob
{
    ...
    public void func_70014_b(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.putInt("Invul", this.getInvulTime());
    }
    ...
    public void livingTick()
    {
        ...
        if (!this.world.isRemote && this.getWatchedTargetId(0) > 0)
        {
            ...
            if (entity != null)
            {
                if (this.posY < entity.posY || !this.func_82205_o() && this.posY < entity.posY + 5.0D)
                {
        ...
        {
            this.rotationYaw = (float)MathHelper.atan2(this.field_70179_y, this.field_70159_w) * (180F / (float)Math.PI) - 90.0F;
        }
        ...
        for (int l = 0; l < 3; ++l)
        {
            ...
            this.world.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, d10 + this.rand.nextGaussian() * 0.30000001192092896D, d2 + this.rand.nextGaussian() * 0.30000001192092896D, d4 + this.rand.nextGaussian() * 0.30000001192092896D, 0.0D, 0.0D, 0.0D);

            if (flag && this.world.rand.nextInt(4) == 0)
            {
                this.world.func_175688_a(EnumParticleTypes.SPELL_MOB, d10 + this.rand.nextGaussian() * 0.30000001192092896D, d2 + this.rand.nextGaussian() * 0.30000001192092896D, d4 + this.rand.nextGaussian() * 0.30000001192092896D, 0.699999988079071D, 0.699999988079071D, 0.5D);
            }
        }
        ...
        if (this.getInvulTime() > 0)
        {
            ...
            {
                this.world.func_175688_a(EnumParticleTypes.SPELL_MOB, this.posX + this.rand.nextGaussian(), this.posY + (double)(this.rand.nextFloat() * 3.3F), this.posZ + this.rand.nextGaussian(), 0.699999988079071D, 0.699999988079071D, 0.8999999761581421D);
            }
        }
    }
    ...
    protected void updateAITasks()
    {
        if (this.getInvulTime() > 0)
        {
            ...
            if (j1 <= 0)
            {
                this.world.func_72885_a(this, this.posX, this.posY + (double)this.getEyeHeight(), this.posZ, 7.0F, false, this.world.getGameRules().func_82766_b("mobGriefing"));
        ...
        else
        {
            ...
            if (this.blockBreakCounter > 0)
            {
                ...
                if (this.blockBreakCounter == 0 && this.world.getGameRules().func_82766_b("mobGriefing"))
                {
                    ...
                    if (flag)
                    {
                        this.world.func_180498_a((EntityPlayer)null, 1022, new BlockPos(this), 0);
                    }
                }
            }
    ...
    {
        this.world.func_180498_a((EntityPlayer)null, 1024, new BlockPos(this), 0);
    ...
    {
        EntityItem entityitem = this.func_145779_a(Items.NETHER_STAR, 1);
