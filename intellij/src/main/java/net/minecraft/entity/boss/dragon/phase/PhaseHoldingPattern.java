...
public class PhaseHoldingPattern extends PhaseBase
{
    ...
    private void findNewTarget()
    {
        ...
        {
            BlockPos blockpos = this.dragon.world.func_175672_r(new BlockPos(WorldGenEndPodium.END_PODIUM_LOCATION));
            ...
            double d0 = 64.0D;
            EntityPlayer entityplayer = this.dragon.world.func_184139_a(blockpos, d0, d0);
