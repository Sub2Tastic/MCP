...
public class PhaseLandingApproach extends PhaseBase
{
    ...
    private void findNewTarget()
    {
        if (this.currentPath == null || this.currentPath.isFinished())
        {
            ...
            BlockPos blockpos = this.dragon.world.func_175672_r(WorldGenEndPodium.END_PODIUM_LOCATION);
            EntityPlayer entityplayer = this.dragon.world.func_184139_a(blockpos, 128.0D, 128.0D);
            int j;
