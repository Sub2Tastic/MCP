...
public class PhaseSittingScanning extends PhaseSittingBase
{
    ...
    {
        ++this.scanningTime;
        EntityLivingBase entitylivingbase = this.dragon.world.func_184142_a(this.dragon, 20.0D, 10.0D);
        ...
        if (entitylivingbase != null)
        {
            ...
            else
            {
                ...
                if (f1 < 0.0F || f1 > 10.0F)
                {
                    ...
                    this.dragon.field_70704_bt = (float)((double)this.dragon.field_70704_bt + d2 * (double)(0.7F / f2 / f3));
                    this.dragon.rotationYaw += this.dragon.field_70704_bt;
                }
            }
        }
        else if (this.scanningTime >= 100)
        {
            entitylivingbase = this.dragon.world.func_184142_a(this.dragon, 150.0D, 150.0D);
