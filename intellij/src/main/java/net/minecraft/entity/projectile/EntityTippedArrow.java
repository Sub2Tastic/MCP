...
public class EntityTippedArrow extends EntityArrow
{
    ...
    private void spawnPotionParticles(int particleCount)
    {
        ...
        if (i != -1 && particleCount > 0)
        {
            ...
            {
                this.world.func_175688_a(EnumParticleTypes.SPELL_MOB, this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.field_70130_N, this.posY + this.rand.nextDouble() * (double)this.field_70131_O, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.field_70130_N, d0, d1, d2);
            }
        }
    }
    ...
    protected void arrowHit(EntityLivingBase living)
    {
        ...
        {
            living.func_70690_d(new PotionEffect(potioneffect.getPotion(), Math.max(potioneffect.getDuration() / 8, 1), potioneffect.getAmplifier(), potioneffect.isAmbient(), potioneffect.doesShowParticles()));
        }
