...
public class EntityTrackerEntry
{
    ...
    public EntityTrackerEntry(Entity p_i46837_1_, int p_i46837_2_, int p_i46837_3_, int p_i46837_4_, boolean p_i46837_5_)
    {
        ...
        this.field_73128_d = EntityTracker.func_187253_a(p_i46837_1_.posX);
        this.field_73129_e = EntityTracker.func_187253_a(p_i46837_1_.posY);
        this.field_73126_f = EntityTracker.func_187253_a(p_i46837_1_.posZ);
        this.field_73127_g = MathHelper.floor(p_i46837_1_.rotationYaw * 256.0F / 360.0F);
        this.field_73139_h = MathHelper.floor(p_i46837_1_.rotationPitch * 256.0F / 360.0F);
        this.field_73140_i = MathHelper.floor(p_i46837_1_.getRotationYawHead() * 256.0F / 360.0F);
        this.field_180234_y = p_i46837_1_.onGround;
    }
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        {
            return ((EntityTrackerEntry)p_equals_1_).field_73132_a.getEntityId() == this.field_73132_a.getEntityId();
        }
        else
        {
            return false;
    ...
    public int hashCode()
    {
        return this.field_73132_a.getEntityId();
    }
    ...
    public void func_73122_a(List<EntityPlayer> p_73122_1_)
    {
        ...
        if (!this.field_73144_s || this.field_73132_a.getDistanceSq(this.field_73147_p, this.field_73146_q, this.field_73145_r) > 16.0D)
        {
            this.field_73147_p = this.field_73132_a.posX;
            this.field_73146_q = this.field_73132_a.posY;
            this.field_73145_r = this.field_73132_a.posZ;
            this.field_73144_s = true;
            this.field_73133_n = true;
            this.func_73125_b(p_73122_1_);
        }

        List<Entity> list = this.field_73132_a.getPassengers();
        ...
        if (this.field_73132_a instanceof EntityItemFrame && this.field_73136_m % 10 == 0)
        {
            ...
            if (itemstack.getItem() instanceof ItemMap)
            {
                ...
                for (EntityPlayer entityplayer : p_73122_1_)
                {
                    ...
                    Packet<?> packet = Items.FILLED_MAP.getUpdatePacket(itemstack, this.field_73132_a.world, entityplayermp);
        ...
        if (this.field_73136_m % this.field_73131_c == 0 || this.field_73132_a.isAirBorne || this.field_73132_a.getDataManager().isDirty())
        {
            if (this.field_73132_a.isPassenger())
            {
                int j1 = MathHelper.floor(this.field_73132_a.rotationYaw * 256.0F / 360.0F);
                int l1 = MathHelper.floor(this.field_73132_a.rotationPitch * 256.0F / 360.0F);
                boolean flag3 = Math.abs(j1 - this.field_73127_g) >= 1 || Math.abs(l1 - this.field_73139_h) >= 1;

                if (flag3)
                {
                    this.func_151259_a(new SPacketEntity.S16PacketEntityLook(this.field_73132_a.getEntityId(), (byte)j1, (byte)l1, this.field_73132_a.onGround));
                    this.field_73127_g = j1;
                    this.field_73139_h = l1;
                }

                this.field_73128_d = EntityTracker.func_187253_a(this.field_73132_a.posX);
                this.field_73129_e = EntityTracker.func_187253_a(this.field_73132_a.posY);
                this.field_73126_f = EntityTracker.func_187253_a(this.field_73132_a.posZ);
                this.func_111190_b();
            ...
            {
                ++this.field_73142_u;
                long i1 = EntityTracker.func_187253_a(this.field_73132_a.posX);
                long i2 = EntityTracker.func_187253_a(this.field_73132_a.posY);
                long j2 = EntityTracker.func_187253_a(this.field_73132_a.posZ);
                int k2 = MathHelper.floor(this.field_73132_a.rotationYaw * 256.0F / 360.0F);
                int i = MathHelper.floor(this.field_73132_a.rotationPitch * 256.0F / 360.0F);
                ...
                {
                    if (j >= -32768L && j < 32768L && k >= -32768L && k < 32768L && l >= -32768L && l < 32768L && this.field_73142_u <= 400 && !this.field_73141_v && this.field_180234_y == this.field_73132_a.onGround)
                    {
                        if ((!flag || !flag1) && !(this.field_73132_a instanceof EntityArrow))
                        {
                            if (flag)
                            {
                                packet1 = new SPacketEntity.S15PacketEntityRelMove(this.field_73132_a.getEntityId(), j, k, l, this.field_73132_a.onGround);
                            }
                            else if (flag1)
                            {
                                packet1 = new SPacketEntity.S16PacketEntityLook(this.field_73132_a.getEntityId(), (byte)k2, (byte)i, this.field_73132_a.onGround);
                            }
                        }
                        else
                        {
                            packet1 = new SPacketEntity.S17PacketEntityLookMove(this.field_73132_a.getEntityId(), j, k, l, (byte)k2, (byte)i, this.field_73132_a.onGround);
                        }
                    }
                    else
                    {
                        this.field_180234_y = this.field_73132_a.onGround;
                ...
                if (this.field_73132_a instanceof EntityLivingBase && ((EntityLivingBase)this.field_73132_a).isElytraFlying())
                {
                    flag2 = true;
                }
                ...
                if (flag2 && this.field_73136_m > 0)
                {
                    ...
                    if (d4 > 4.0E-4D || d4 > 0.0D && this.field_73132_a.field_70159_w == 0.0D && this.field_73132_a.field_70181_x == 0.0D && this.field_73132_a.field_70179_y == 0.0D)
                    {
                        ...
                        this.func_151259_a(new SPacketEntityVelocity(this.field_73132_a.getEntityId(), this.field_73137_j, this.field_73138_k, this.field_73135_l));
                    }
                }
            ...
            int k1 = MathHelper.floor(this.field_73132_a.getRotationYawHead() * 256.0F / 360.0F);
            ...
            this.field_73132_a.isAirBorne = false;
        }

        ++this.field_73136_m;

        if (this.field_73132_a.velocityChanged)
        {
            this.func_151261_b(new SPacketEntityVelocity(this.field_73132_a));
            this.field_73132_a.velocityChanged = false;
        }
    }

    private void func_111190_b()
    {
        EntityDataManager entitydatamanager = this.field_73132_a.getDataManager();

        if (entitydatamanager.isDirty())
        {
            this.func_151261_b(new SPacketEntityMetadata(this.field_73132_a.getEntityId(), entitydatamanager, false));
        }

        if (this.field_73132_a instanceof EntityLivingBase)
        {
            AttributeMap attributemap = (AttributeMap)((EntityLivingBase)this.field_73132_a).getAttributes();
            Set<IAttributeInstance> set = attributemap.getDirtyInstances();

            if (!set.isEmpty())
            {
                this.func_151261_b(new SPacketEntityProperties(this.field_73132_a.getEntityId(), set));
            }
    ...
    public void func_151261_b(Packet<?> p_151261_1_)
    {
        ...
        {
            ((EntityPlayerMP)this.field_73132_a).connection.sendPacket(p_151261_1_);
        }
    }
    ...
    public void func_73119_a()
    {
        for (EntityPlayerMP entityplayermp : this.field_73134_o)
        {
            this.field_73132_a.removeTrackingPlayer(entityplayermp);
            entityplayermp.removeEntity(this.field_73132_a);
        }
    }
    ...
    public void func_73118_a(EntityPlayerMP p_73118_1_)
    {
        ...
        {
            this.field_73132_a.removeTrackingPlayer(p_73118_1_);
            p_73118_1_.removeEntity(this.field_73132_a);
    ...
    public void func_73117_b(EntityPlayerMP p_73117_1_)
    {
        if (p_73117_1_ != this.field_73132_a)
        {
            ...
            {
                if (!this.field_73134_o.contains(p_73117_1_) && (this.func_73121_d(p_73117_1_) || this.field_73132_a.forceSpawn))
                {
                    this.field_73134_o.add(p_73117_1_);
                    Packet<?> packet = this.func_151260_c();
                    p_73117_1_.connection.sendPacket(packet);

                    if (!this.field_73132_a.getDataManager().isEmpty())
                    {
                        p_73117_1_.connection.sendPacket(new SPacketEntityMetadata(this.field_73132_a.getEntityId(), this.field_73132_a.getDataManager(), true));
                    }
                    ...
                    if (this.field_73132_a instanceof EntityLivingBase)
                    {
                        ...
                        {
                            p_73117_1_.connection.sendPacket(new SPacketEntityProperties(this.field_73132_a.getEntityId(), collection));
                        }

                        if (((EntityLivingBase)this.field_73132_a).isElytraFlying())
                        {
                            flag = true;
                        }
                    }
                    ...
                    {
                        p_73117_1_.connection.sendPacket(new SPacketEntityVelocity(this.field_73132_a.getEntityId(), this.field_73132_a.field_70159_w, this.field_73132_a.field_70181_x, this.field_73132_a.field_70179_y));
                    }
                    ...
                    if (this.field_73132_a instanceof EntityLivingBase)
                    {
                        ...
                        {
                            ItemStack itemstack = ((EntityLivingBase)this.field_73132_a).getItemStackFromSlot(entityequipmentslot);

                            if (!itemstack.isEmpty())
                            {
                                p_73117_1_.connection.sendPacket(new SPacketEntityEquipment(this.field_73132_a.getEntityId(), entityequipmentslot, itemstack));
                            }
                        }
                    }
                    ...
                    if (this.field_73132_a instanceof EntityPlayer)
                    {
                        ...
                        {
                            p_73117_1_.connection.sendPacket(new SPacketUseBed(entityplayer, new BlockPos(this.field_73132_a)));
                        }
                    }
                    ...
                    if (this.field_73132_a instanceof EntityLivingBase)
                    {
                        ...
                        {
                            p_73117_1_.connection.sendPacket(new SPacketEntityEffect(this.field_73132_a.getEntityId(), potioneffect));
                        }
                    }

                    if (!this.field_73132_a.getPassengers().isEmpty())
                    {
                        p_73117_1_.connection.sendPacket(new SPacketSetPassengers(this.field_73132_a));
                    }

                    if (this.field_73132_a.isPassenger())
                    {
                        p_73117_1_.connection.sendPacket(new SPacketSetPassengers(this.field_73132_a.getRidingEntity()));
                    }

                    this.field_73132_a.addTrackingPlayer(p_73117_1_);
                    p_73117_1_.addEntity(this.field_73132_a);
                }
            }
            else if (this.field_73134_o.contains(p_73117_1_))
            {
                this.field_73134_o.remove(p_73117_1_);
                this.field_73132_a.removeTrackingPlayer(p_73117_1_);
                p_73117_1_.removeEntity(this.field_73132_a);
            }
        }
    }
    ...
    {
        double d0 = p_180233_1_.posX - (double)this.field_73128_d / 4096.0D;
        double d1 = p_180233_1_.posZ - (double)this.field_73126_f / 4096.0D;
        int i = Math.min(this.field_73130_b, this.field_187262_f);
        return d0 >= (double)(-i) && d0 <= (double)i && d1 >= (double)(-i) && d1 <= (double)i && this.field_73132_a.isSpectatedByPlayer(p_180233_1_);
    }

    private boolean func_73121_d(EntityPlayerMP p_73121_1_)
    {
        return p_73121_1_.getServerWorld().func_184164_w().func_72694_a(p_73121_1_, this.field_73132_a.chunkCoordX, this.field_73132_a.chunkCoordZ);
    }
    ...
    private Packet<?> func_151260_c()
    {
        ...
        {
            this.field_73140_i = MathHelper.floor(this.field_73132_a.getRotationYawHead() * 256.0F / 360.0F);
        ...
        else if (this.field_73132_a instanceof EntityMinecart)
        {
            ...
            return new SPacketSpawnObject(this.field_73132_a, 10, entityminecart.getMinecartType().func_184956_a());
        }
        ...
        {
            Entity entity2 = ((EntityFishHook)this.field_73132_a).getAngler();
            return new SPacketSpawnObject(this.field_73132_a, 90, entity2 == null ? this.field_73132_a.getEntityId() : entity2.getEntityId());
        }
        else if (this.field_73132_a instanceof EntitySpectralArrow)
        {
            Entity entity1 = ((EntitySpectralArrow)this.field_73132_a).shootingEntity;
            return new SPacketSpawnObject(this.field_73132_a, 91, 1 + (entity1 == null ? this.field_73132_a.getEntityId() : entity1.getEntityId()));
        }
        else if (this.field_73132_a instanceof EntityTippedArrow)
        {
            Entity entity = ((EntityArrow)this.field_73132_a).shootingEntity;
            return new SPacketSpawnObject(this.field_73132_a, 60, 1 + (entity == null ? this.field_73132_a.getEntityId() : entity.getEntityId()));
        }
        ...
        else if (this.field_73132_a instanceof EntityFireball)
        {
            ...
            {
                spacketspawnobject = new SPacketSpawnObject(this.field_73132_a, i, ((EntityFireball)this.field_73132_a).shootingEntity.getEntityId());
            }
            else
            {
            ...
            spacketspawnobject.func_149003_d((int)(entityfireball.accelerationX * 8000.0D));
            spacketspawnobject.func_149000_e((int)(entityfireball.accelerationY * 8000.0D));
            spacketspawnobject.func_149007_f((int)(entityfireball.accelerationZ * 8000.0D));
        ...
        {
            EntityItemFrame entityitemframe = (EntityItemFrame)this.field_73132_a;
            return new SPacketSpawnObject(this.field_73132_a, 71, entityitemframe.facingDirection.getHorizontalIndex(), entityitemframe.getHangingPosition());
        }
        else if (this.field_73132_a instanceof EntityLeashKnot)
        {
            EntityLeashKnot entityleashknot = (EntityLeashKnot)this.field_73132_a;
            return new SPacketSpawnObject(this.field_73132_a, 77, 0, entityleashknot.getHangingPosition());
        }
    ...
    public void func_73123_c(EntityPlayerMP p_73123_1_)
    {
        if (this.field_73134_o.contains(p_73123_1_))
        {
            ...
            this.field_73132_a.removeTrackingPlayer(p_73123_1_);
            p_73123_1_.removeEntity(this.field_73132_a);
        }
    }
