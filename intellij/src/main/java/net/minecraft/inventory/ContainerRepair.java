...
public class ContainerRepair extends Container
{
    ...
    {
        this(p_i45806_1_, p_i45806_2_, BlockPos.ZERO, p_i45806_3_);
    }
    ...
    public ContainerRepair(InventoryPlayer p_i45807_1_, final World p_i45807_2_, final BlockPos p_i45807_3_, EntityPlayer p_i45807_4_)
    {
        ...
        this.addSlot(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack)
            {
                ...
                if (!thePlayer.abilities.isCreativeMode && !p_i45807_2_.isRemote && iblockstate.getBlock() == Blocks.ANVIL && thePlayer.getRNG().nextFloat() < 0.12F)
                {
                    int l = ((Integer)iblockstate.get(BlockAnvil.field_176505_b)).intValue();
                    ++l;
                    ...
                    {
                        p_i45807_2_.setBlockState(p_i45807_3_, iblockstate.func_177226_a(BlockAnvil.field_176505_b, Integer.valueOf(l)), 2);
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            {
                boolean flag = itemstack2.getItem() == Items.ENCHANTED_BOOK && !ItemEnchantedBook.getEnchantments(itemstack2).func_82582_d();
    ...
    public void onContainerClosed(EntityPlayer playerIn)
    {
        ...
        {
            this.clearContainer(playerIn, this.field_82860_h, this.inputSlots);
        }
    }
    ...
    {
        if (this.field_82860_h.getBlockState(this.field_178156_j).getBlock() != Blocks.ANVIL)
        {
            return false;
        }
        else
        {
            return playerIn.getDistanceSq((double)this.field_178156_j.getX() + 0.5D, (double)this.field_178156_j.getY() + 0.5D, (double)this.field_178156_j.getZ() + 0.5D) <= 64.0D;
        }
    }
