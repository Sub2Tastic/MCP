...
public abstract class Container
{
            ...
            else
            {
                ...
                if (slot6 != null)
                {
                    ...
                    else if (slot6.canTakeStack(player))
                    {
                        ...
                        {
                            if (itemstack8.getItem() == itemstack11.getItem() && itemstack8.func_77960_j() == itemstack11.func_77960_j() && ItemStack.areItemStackTagsEqual(itemstack8, itemstack11))
                            {
                        ...
                        else if (itemstack8.getItem() == itemstack11.getItem() && itemstack11.getMaxStackSize() > 1 && (!itemstack8.func_77981_g() || itemstack8.func_77960_j() == itemstack11.func_77960_j()) && ItemStack.areItemStackTagsEqual(itemstack8, itemstack11) && !itemstack8.isEmpty())
                        {
    ...
    protected boolean mergeItemStack(ItemStack stack, int startIndex, int endIndex, boolean reverseDirection)
    {
        ...
        if (stack.isStackable())
        {
            while (!stack.isEmpty())
            {
                ...
                if (!itemstack.isEmpty() && itemstack.getItem() == stack.getItem() && (!stack.func_77981_g() || stack.func_77960_j() == itemstack.func_77960_j()) && ItemStack.areItemStackTagsEqual(stack, itemstack))
                {
    ...
    protected void func_192389_a(World p_192389_1_, EntityPlayer p_192389_2_, InventoryCrafting p_192389_3_, InventoryCraftResult p_192389_4_)
    {
        if (!p_192389_1_.isRemote)
        {
            ...
            if (irecipe != null && (irecipe.isDynamic() || !p_192389_1_.getGameRules().func_82766_b("doLimitedCrafting") || entityplayermp.getRecipeBook().isUnlocked(irecipe)))
            {
