...
public abstract class CreativeTabs
{
    ...
    public static final CreativeTabs BUILDING_BLOCKS = new CreativeTabs(0, "buildingBlocks")
    {
        ...
        {
            return new ItemStack(Item.getItemFromBlock(Blocks.field_150336_V));
        }
    };
    public static final CreativeTabs DECORATIONS = new CreativeTabs(1, "decorations")
    {
        public ItemStack createIcon()
        {
            return new ItemStack(Item.getItemFromBlock(Blocks.field_150398_cm), 1, BlockDoublePlant.EnumPlantType.PAEONIA.func_176936_a());
        }
    };
    ...
    public static final CreativeTabs TRANSPORTATION = new CreativeTabs(3, "transportation")
    {
        public ItemStack createIcon()
        {
            return new ItemStack(Item.getItemFromBlock(Blocks.field_150318_D));
        }
    };
